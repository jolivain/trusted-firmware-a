						...
						unsigned int node_id)
{
	...
	/*
	 * RN-F, RN-I, RN-D , HN-F, HN-I, SN node registers in the MN region
 ...
 ******************************************************************************/
void set_node_reg(node_types_t node_type, unsigned int node_id,
 ...
 * where, region id is mapped to a node_id of node_type.
 ******************************************************************************/
unsigned long read_node_reg(node_types_t node_type, unsigned int node_id,
						unsigned int reg_offset)
{
	unsigned long val;
	unsigned int region_id = get_region_id_for_node(node_type, node_id);
