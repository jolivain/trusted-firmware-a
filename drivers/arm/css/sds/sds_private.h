...
#define SDS_HEADER_VERSION_MASK                    \
	((1 << (SDS_HEADER_MINOR_VERSION_WIDTH +   \
		SDS_HEADER_MAJOR_VERSION_WIDTH)) - \
	 1)
...
#define GET_SDS_HEADER_VERSION(_header)               \
	(((((struct_header_t *)(_header))->reg[0]) >> \
	  SDS_HEADER_MINOR_VERSION_SHIFT) &           \
	 SDS_HEADER_VERSION_MASK)
#define GET_SDS_HEADER_STRUCT_SIZE(_header)           \
	(((((struct_header_t *)(_header))->reg[1]) >> \
...
#define IS_SDS_REGION_VALID(region)               \
	(((((region_desc_t *)(region))->reg[0]) & \
	  SDS_REGION_SIGNATURE_MASK) == SDS_REGION_SIGNATURE)
