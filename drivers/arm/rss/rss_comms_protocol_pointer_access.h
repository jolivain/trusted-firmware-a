...
psa_status_t rss_protocol_pointer_access_serialize_msg(
...
psa_status_t rss_protocol_pointer_access_deserialize_reply(
	psa_outvec *out_vec, uint8_t out_len, psa_status_t *return_val,
	const struct rss_pointer_access_reply_t *reply, size_t reply_size);
