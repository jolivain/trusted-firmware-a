...
#define SPI_BLOCK_MIN_VALUE(spi_id_min) \
	(((spi_id_min)-GIC600_SPI_ID_MIN) / GIC600_SPI_ID_MIN)
#define SPI_BLOCKS_VALUE(spi_id_min, spi_id_max) \
	(((spi_id_max) - (spi_id_min) + 1) / GIC600_SPI_ID_MIN)
#define ESPI_BLOCK_MIN_VALUE(spi_id_min) \
	(((spi_id_min)-GIC700_ESPI_ID_MIN + 1) / GIC700_SPI_ID_MIN)
...
#define BLOCKS_OF_32(spi_id_min, spi_id_max) \
	SPI_BLOCKS_TILL_MAX(spi_id_max) ^ SPI_BLOCKS_TILL_MIN(spi_id_min)
