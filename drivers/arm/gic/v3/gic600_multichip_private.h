...
#define NUM_OF_32_BLOCKS(spi_id_min, spi_id_max) \
			((1 << ((((spi_id_max) + 1) - (spi_id_min)) >> 5)) - 1)
#define BLOCKS_OF_32_SHIFT(spi_id_min) (((spi_id_min) - 32) >> 5)
#define BLOCKS_OF_32(spi_id_min, spi_id_max) \
			NUM_OF_32_BLOCKS(spi_id_min, spi_id_max) << \
			BLOCKS_OF_32_SHIFT(spi_id_min)
