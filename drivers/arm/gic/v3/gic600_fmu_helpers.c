...
{
	GIC_FMU_WRITE_64(base, GICFMU_ERRSTATUS, n, val);
}
...
void gic_fmu_write_pingnow(uintptr_t base, uint32_t val)
{
	...
	GIC_FMU_WRITE_32(base, GICFMU_PINGNOW, val);
...
void gic_fmu_write_smen(uintptr_t base, uint32_t val)
{
	...
	GIC_FMU_WRITE_32(base, GICFMU_SMEN, val);
...
void gic_fmu_write_sminjerr(uintptr_t base, uint32_t val)
{
	...
	GIC_FMU_WRITE_32(base, GICFMU_SMINJERR, val);
