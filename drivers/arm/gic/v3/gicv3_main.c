...
void __init gicv3_driver_init(const gicv3_driver_data_t *plat_driver_data)
{
	...
	flush_dcache_range((uintptr_t)gicv3_driver_data,
		sizeof(*gicv3_driver_data));
	/*
	 * Flush the rdistif_base_addrs[PLATFORM_CORE_COUNT] contents linked
	 * to the GICv3 driver.
	 */
	
	flush_dcache_range((uintptr_t)(gicv3_driver_data->rdistif_base_addrs),
		PLATFORM_CORE_COUNT*sizeof(uintptr_t));
#endif
