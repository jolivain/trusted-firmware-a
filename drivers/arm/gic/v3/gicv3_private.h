...
#define	GICD_OFFSET_8(REG, id)			\
	(((id) <= MAX_SPI_ID) ?			\
	GICD_##REG + (uintptr_t)(id) :		\
	GICD_##REG##E + (uintptr_t)(id) - MIN_ESPI_ID)

#define	GICD_OFFSET(REG, id)					\
	(((id) <= MAX_SPI_ID) ?					\
	GICD_##REG + (((uintptr_t)(id) >> REG##_SHIFT) << 2) :	\
	GICD_##REG##E + ((((uintptr_t)(id) - MIN_ESPI_ID) >> REG##_SHIFT) << 2))

#define	GICD_OFFSET_64(REG, id)					\
	(((id) <= MAX_SPI_ID) ?					\
	GICD_##REG + (((uintptr_t)(id) >> REG##_SHIFT) << 3) :	\
	GICD_##REG##E + (((uintptr_t)(id) - MIN_ESPI_ID) << 3))
...
#define	GICR_OFFSET_8(REG, id)				\
	(((id) <= MAX_PPI_ID) ?				\
	GICR_##REG + (uintptr_t)(id) :			\
	GICR_##REG + (uintptr_t)(id) - (MIN_EPPI_ID - MIN_SPI_ID))

#define GICR_OFFSET(REG, id)						\
	(((id) <= MAX_PPI_ID) ?						\
	GICR_##REG + (((uintptr_t)(id) >> REG##_SHIFT) << 2) :		\
	GICR_##REG + ((((uintptr_t)(id) - (MIN_EPPI_ID - MIN_SPI_ID))	\
				       >> REG##_SHIFT) << 2))
#else	/* GICv3 */
#define	GICR_OFFSET_8(REG, id)	\
