 ...
 ******************************************************************************/
static void gic600_multichip_validata_data(
...
void gic600_multichip_init(struct gic600_multichip_data *multichip_data)
{
	...
	gic600_multichip_validata_data(multichip_data);
