...
/*
 * This routine to be removed once console code is moved out of assembly
 */
void *rcar_log_memset(void *dst, int val, size_t count)
{
	char *ptr = dst;
...
int32_t rcar_log_init(void)
{
	...
	if (init_flag == 1) {
		(void)rcar_log_memset((void *)t_log->log_data, 0,
