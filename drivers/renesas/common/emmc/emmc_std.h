...
#define EMMC_TRANSPEED_FREQ_UNIT_SHIFT          0U
...
#define HS_TIMING_ADD		(185U<<16)	/* H'b9 */
#define HS_TIMING_1		(1U<<8)
#define HS_TIMING_HS200		(2U<<8)
#define HS_TIMING_HS400		(3U<<8)

#define BUS_WIDTH_ADD		(183U<<16)	/* H'b7 */
#define BUS_WIDTH_1		(0U<<8)
#define BUS_WIDTH_4		(1U<<8)
#define BUS_WIDTH_8		(2U<<8)
#define BUS_WIDTH_4DDR		(5U<<8)
#define BUS_WIDTH_8DDR		(6U<<8)
