...
#define EMMC_SWITCH_HS_TIMING \
	(EXTCSD_ACCESS_BYTE | HS_TIMING_ADD | HS_TIMING_1) /* H'03b90100 */
#define EMMC_SWITCH_HS_TIMING_OFF \
	(EXTCSD_ACCESS_BYTE | HS_TIMING_ADD) /* H'03b90000 */

#define EMMC_SWITCH_BUS_WIDTH_1 \
	(EXTCSD_ACCESS_BYTE | BUS_WIDTH_ADD | BUS_WIDTH_1) /* H'03b70000 */
#define EMMC_SWITCH_BUS_WIDTH_4 \
	(EXTCSD_ACCESS_BYTE | BUS_WIDTH_ADD | BUS_WIDTH_4) /* H'03b70100 */
#define EMMC_SWITCH_BUS_WIDTH_8 \
	(EXTCSD_ACCESS_BYTE | BUS_WIDTH_ADD | BUS_WIDTH_8) /* H'03b70200 */
#define EMMC_SWITCH_BUS_WIDTH_4DDR \
	(EXTCSD_ACCESS_BYTE | BUS_WIDTH_ADD | BUS_WIDTH_4DDR) /* H'03b70500 */
#define EMMC_SWITCH_BUS_WIDTH_8DDR \
	(EXTCSD_ACCESS_BYTE | BUS_WIDTH_ADD | BUS_WIDTH_8DDR) /* H'03b70600 */
