...
#define SD_INFO2_CLEAR \
	0x00000800UL /* BIT11 write value should always be 1. HWM_0003 */
...
/* CC_EXT_MODE */
#define CC_EXT_MODE_DMASDRW_ENABLE \
	0x00000002UL /* SD_BUF Read/Write DMA Transfer */
