...
typedef enum {
	/* class 0 and class 1 */
	/* CMD0 */
	CMD0_GO_IDLE_STATE = 0U | (uint32_t)HAL_MEMCARD_RESPONSE_NONE |
			     (uint32_t)HAL_MEMCARD_COMMAND_TYPE_BC |
			     (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
			     (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD1 */
	CMD1_SEND_OP_COND = 1U | (uint32_t)HAL_MEMCARD_RESPONSE_R3 |
			    (uint32_t)HAL_MEMCARD_COMMAND_TYPE_BCR |
			    (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_MMC |
			    (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD2 */
	CMD2_ALL_SEND_CID_MMC = 2U | (uint32_t)HAL_MEMCARD_RESPONSE_R2 |
				(uint32_t)HAL_MEMCARD_COMMAND_TYPE_BCR |
				(uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_MMC |
				(uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	CMD2_ALL_SEND_CID_SD = 2U | (uint32_t)HAL_MEMCARD_RESPONSE_R2 |
			       (uint32_t)HAL_MEMCARD_COMMAND_TYPE_BCR |
			       (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_SD |
			       (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD3 */
	CMD3_SET_RELATIVE_ADDR = 3U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
				 (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
				 (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_MMC |
				 (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	CMD3_SEND_RELATIVE_ADDR = 3U | (uint32_t)HAL_MEMCARD_RESPONSE_R6 |
				  (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
				  (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_SD |
				  (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD4 */
	CMD4_SET_DSR = 4U | (uint32_t)HAL_MEMCARD_RESPONSE_NONE |
		       (uint32_t)HAL_MEMCARD_COMMAND_TYPE_BC |
		       (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
		       (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD5 */
	CMD5_SLEEP_AWAKE = 5U | (uint32_t)HAL_MEMCARD_RESPONSE_R1b |
			   (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
			   (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_MMC |
			   (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD6 */
	CMD6_SWITCH = 6U | (uint32_t)HAL_MEMCARD_RESPONSE_R1b |
		      (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
		      (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_MMC |
		      (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	CMD6_SWITCH_FUNC = 6U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			   (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
			   (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_SD |
			   (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	ACMD6_SET_BUS_WIDTH = 6U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			      (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
			      (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_SD |
			      (uint32_t)HAL_MEMCARD_COMMAND_APP,
	/* CMD7 */
	CMD7_SELECT_CARD = 7U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			   (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
			   (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
			   (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD7(from Disconnected State to Programming State) */
	CMD7_SELECT_CARD_PROG = 7U | (uint32_t)HAL_MEMCARD_RESPONSE_R1b |
				(uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
				(uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
				(uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	CMD7_DESELECT_CARD = 7U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			     (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
			     (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
			     (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD8 */
	CMD8_SEND_EXT_CSD = 8U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
	...
	CMD8_SEND_IF_COND = 8U | (uint32_t)HAL_MEMCARD_RESPONSE_R7 |
			    ...
			    (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD9 */
	CMD9_SEND_CSD = 9U | (uint32_t)HAL_MEMCARD_RESPONSE_R2 |
			(uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
			(uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
			(uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD10 */
	CMD10_SEND_CID = 10U | (uint32_t)HAL_MEMCARD_RESPONSE_R2 |
			 (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
			 (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
			 (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD11 */
	...
	CMD12_STOP_TRANSMISSION_WRITE =
		...
		(uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD13 */
	CMD13_SEND_STATUS = 13U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			    (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
			    (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
			    (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	ACMD13_SD_STATUS = 13U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			   (uint32_t)HAL_MEMCARD_COMMAND_TYPE_ADTC_READ |
			   (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_SD |
			   (uint32_t)HAL_MEMCARD_COMMAND_APP,
	/* CMD14 */
	CMD14_BUSTEST_R = 14U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			  (uint32_t)HAL_MEMCARD_COMMAND_TYPE_ADTC_READ |
			  (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_MMC |
			  (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD15 */
	...
	/* class 2 */
	/* CMD16 */
	CMD16_SET_BLOCKLEN = 16U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			     (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
			     (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
			     (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD17 */
	...
	CMD18_READ_MULTIPLE_BLOCK =
		...
		(uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD19 */
	CMD19_BUS_TEST_W = 19U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
	...
	/* CMD22 */
	CMD22 = 22U,
	ACMD22_SEND_NUM_WR_BLOCKS = 22U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
				    (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
				    (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_SD |
				    (uint32_t)HAL_MEMCARD_COMMAND_APP,
	...
	/* class 4 */
	/* CMD23 */
	CMD23_SET_BLOCK_COUNT = 23U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
				(uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
				(uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_MMC |
				(uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	ACMD23_SET_WR_BLK_ERASE_COUNT =
		...
		(uint32_t)HAL_MEMCARD_COMMAND_APP,
	/* CMD24 */
	CMD24_WRITE_BLOCK = 24U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			    (uint32_t)HAL_MEMCARD_COMMAND_TYPE_ADTC_WRITE |
			    (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
			    (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD25 */
	CMD25_WRITE_MULTIPLE_BLOCK =
		...
		(uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD26 */
	CMD26_PROGRAM_CID = 26U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			    (uint32_t)HAL_MEMCARD_COMMAND_TYPE_ADTC_WRITE |
			    (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_MMC |
			    (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD27 */
	CMD27_PROGRAM_CSD = 27U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			    (uint32_t)HAL_MEMCARD_COMMAND_TYPE_ADTC_WRITE |
			    (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
			    (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	...
	/* class 6 */
	/* CMD28 */
	CMD28_SET_WRITE_PROT = 28U | (uint32_t)HAL_MEMCARD_RESPONSE_R1b |
			       (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
			       (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
			       (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD29 */
	CMD29_CLR_WRITE_PROT = 29U | (uint32_t)HAL_MEMCARD_RESPONSE_R1b |
			       (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
			       (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
			       (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD30 */
	CMD30_SEND_WRITE_PROT = 30U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
				(uint32_t)HAL_MEMCARD_COMMAND_TYPE_ADTC_READ |
				(uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
				(uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD31 */
	...
	/* class 5 */
	/* CMD32 */
	CMD32_ERASE_WR_BLK_START = 32U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
				   (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
				   (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_SD |
				   (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD33 */
	CMD33_ERASE_WR_BLK_END = 33U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
				 (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
				 (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_SD |
				 (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD34 */
	CMD34 = 34U,
	/* CMD35 */
	CMD35_ERASE_GROUP_START = 35U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
				  (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
				  (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_MMC |
				  (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD36 */
	CMD36_ERASE_GROUP_END = 36U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
				(uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
				(uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_MMC |
				(uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD37 */
	CMD37 = 37U,
	/* CMD38 */
	CMD38_ERASE = 38U | (uint32_t)HAL_MEMCARD_RESPONSE_R1b |
		      (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
		      (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
		      (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	...
	/* class 9 */
	/* CMD39 */
	CMD39_FASTIO = 39U | (uint32_t)HAL_MEMCARD_RESPONSE_R4 |
		       (uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
		       (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_MMC |
		       (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD40 */
	CMD40_GO_IRQSTATE = 40U | (uint32_t)HAL_MEMCARD_RESPONSE_R5 |
			    (uint32_t)HAL_MEMCARD_COMMAND_TYPE_BCR |
			    (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_MMC |
			    (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD41 */
	CMD41 = 41,
	ACMD41_SD_SEND_OP_COND = 41U | (uint32_t)HAL_MEMCARD_RESPONSE_R3 |
				 (uint32_t)HAL_MEMCARD_COMMAND_TYPE_BCR |
				 (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_SD |
				 (uint32_t)HAL_MEMCARD_COMMAND_APP,
	...
	/* class 7 */
	/* CMD42 */
	CMD42_LOCK_UNLOCK = 42U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			    (uint32_t)HAL_MEMCARD_COMMAND_TYPE_ADTC_WRITE |
			    (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
			    (uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	...
	CMD50 = 50U, /* CMD50 */
	CMD51 = 51U, /* CMD51 */
	ACMD51_SEND_SCR = 51U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			  (uint32_t)HAL_MEMCARD_COMMAND_TYPE_ADTC_READ |
			  (uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_SD |
			  (uint32_t)HAL_MEMCARD_COMMAND_APP,
	CMD52 = 52U, /* CMD52 */
	...
	/* class 8 */
	/* CMD55 */
	CMD55_APP_CMD = 55U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			(uint32_t)HAL_MEMCARD_COMMAND_TYPE_AC |
			(uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
			(uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	/* CMD56 */
	CMD56_GEN_CMD = 56U | (uint32_t)HAL_MEMCARD_RESPONSE_R1 |
			(uint32_t)HAL_MEMCARD_COMMAND_TYPE_ADTC_WRITE |
			(uint32_t)HAL_MEMCARD_COMMAND_CARD_TYPE_COMMON |
			(uint32_t)HAL_MEMCARD_COMMAND_NORMAL,
	CMD57 = 57U, /* CMD57 */
