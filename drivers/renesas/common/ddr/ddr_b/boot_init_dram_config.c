...
/* boardcnf[21] RENESAS KRIEK 16Gbit/1rank/2ch board with M3-W/SoC */
	...
	{
/* boardcnf[22] HopeRun HiHope RZ/G2M 16Gbit/1rank/2ch board with G2M SoC */
	 .phyvalid = 0x03U,
	 .dbi_en = 0x01U,
	 .cacs_dly = 0x02c0U,
	 .cacs_dly_adj = 0x0U,
...
/* boardcnf[23] HopeRun HiHope RZ/G2M 8Gbit/2rank/2ch board with G2M SoC */
	{
	 0x03U,
	 0x01U,
	 0x02c0U,
...
/* boardcnf[24] HopeRun HiHope RZ/G2H board 16Gbit/1rank/2ch */
	{
		0x05U,
		0x01U,
		0x0300U,
