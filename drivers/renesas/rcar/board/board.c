...
#define SXS_ID                                                         \
	{                                                              \
		0x10U, 0x11U, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU \
	}
#define SX_ID                                                          \
	{                                                              \
		0x10U, 0x11U, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU \
...
#define SKP_ID                                                         \
	{                                                              \
		0x10U, 0x10U, 0x20U, 0x21U, 0xFFU, 0xFFU, 0xFFU, 0xFFU \
	}
#define SK_ID                                                          \
	{                                                              \
		0x10U, 0x30U, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU, 0xFFU \
	}
#define EB4_ID                                                         \
	{                                                              \
...
const char *g_board_tbl[] = { [BOARD_STARTER_KIT_PRE] = "Starter Kit Premier",
