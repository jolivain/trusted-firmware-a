...
void pfc_init_h3_v1(void)
{
	...
	pfc_reg_write(
		...
		MOD_SEL0_MSIOF3_A | MOD_SEL0_MSIOF2_A | MOD_SEL0_MSIOF1_A |
			MOD_SEL0_LBSC_A | MOD_SEL0_IEBUS_A | MOD_SEL0_I2C6_A |
			MOD_SEL0_I2C2_A | MOD_SEL0_I2C1_A | MOD_SEL0_HSCIF4_A |
			MOD_SEL0_HSCIF3_A | MOD_SEL0_HSCIF2_A |
			MOD_SEL0_HSCIF1_A | MOD_SEL0_FM_A |
			MOD_SEL0_ETHERAVB_A | MOD_SEL0_DRIF3_A |
			MOD_SEL0_DRIF2_A | MOD_SEL0_DRIF1_A | MOD_SEL0_DRIF0_A |
	...
	pfc_reg_write(PFC_MOD_SEL2, MOD_SEL2_I2C_5_A | MOD_SEL2_I2C_3_A |
	...
	pfc_reg_write(PFC_IPSR9, IPSR_28_FUNC(0) | IPSR_24_FUNC(0) |
					 ...
					 IPSR_12_FUNC(0) | IPSR_8_FUNC(0) |
					 IPSR_4_FUNC(0) | IPSR_0_FUNC(0));
	pfc_reg_write(PFC_IPSR10, IPSR_28_FUNC(0) | IPSR_24_FUNC(4) |
					  IPSR_20_FUNC(0) | IPSR_16_FUNC(0) |
					  IPSR_12_FUNC(0) | IPSR_8_FUNC(0) |
					  IPSR_4_FUNC(1) | IPSR_0_FUNC(1));
	pfc_reg_write(PFC_IPSR11, IPSR_28_FUNC(0) | IPSR_24_FUNC(0) |
					  IPSR_20_FUNC(0) | IPSR_16_FUNC(0) |
					  IPSR_12_FUNC(0) | IPSR_8_FUNC(4) |
					  IPSR_4_FUNC(0) | IPSR_0_FUNC(0));
	pfc_reg_write(PFC_IPSR12, IPSR_28_FUNC(8) | IPSR_24_FUNC(0) |
					  IPSR_20_FUNC(0) | IPSR_16_FUNC(0) |
					  IPSR_12_FUNC(0) | IPSR_8_FUNC(3) |
					  IPSR_4_FUNC(0) | IPSR_0_FUNC(0));
	pfc_reg_write(PFC_IPSR13, IPSR_28_FUNC(0) | IPSR_24_FUNC(0) |
					  IPSR_20_FUNC(0) | IPSR_16_FUNC(0) |
					  IPSR_12_FUNC(0) | IPSR_8_FUNC(0) |
	...
	pfc_reg_write(PFC_IPSR17, IPSR_4_FUNC(0) | IPSR_0_FUNC(0));
	...
	pfc_reg_write(PFC_GPSR0, GPSR0_D15 | GPSR0_D14 | GPSR0_D13 | GPSR0_D12 |
					 ...
					 GPSR0_D8);
	pfc_reg_write(PFC_GPSR1, GPSR1_EX_WAIT0_A | GPSR1_A19 | GPSR1_A18 |
					 GPSR1_A17 | GPSR1_A16 | GPSR1_A15 |
					 GPSR1_A14 | GPSR1_A13 | GPSR1_A12 |
					 GPSR1_A7 | GPSR1_A6 | GPSR1_A5 |
					 GPSR1_A4 | GPSR1_A3 | GPSR1_A2 |
					 GPSR1_A1 | GPSR1_A0);
	...
	reg = ((reg & DRVCTRL13_MASK) | DRVCTRL13_TDO(3) | DRVCTRL13_ASEBRK(3) |
	       DRVCTRL13_SD0_CLK(2) | DRVCTRL13_SD0_CMD(2) |
	       DRVCTRL13_SD0_DAT0(2) | DRVCTRL13_SD0_DAT1(2) |
	       DRVCTRL13_SD0_DAT2(2) | DRVCTRL13_SD0_DAT3(2));
	...
	reg = ((reg & DRVCTRL15_MASK) | DRVCTRL15_SD2_DAT0(5) |
	       ...
	       DRVCTRL15_SD3_CLK(2) | DRVCTRL15_SD3_CMD(2) |
	...
	reg = ((reg & DRVCTRL16_MASK) | DRVCTRL16_SD3_DAT1(2) |
	       DRVCTRL16_SD3_DAT2(2) | DRVCTRL16_SD3_DAT3(2) |
