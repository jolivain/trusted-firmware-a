...
void pfc_init_g2m(void)
{
	...
	pfc_reg_write(PFC_MOD_SEL2,
		      MOD_SEL2_I2C_5_B | MOD_SEL2_I2C_3_B | MOD_SEL2_I2C_0_B |
	...
	pfc_reg_write(PFC_IPSR9, IPSR_28_FUNC(0) | IPSR_24_FUNC(0) |
					 ...
					 IPSR_12_FUNC(0) | IPSR_8_FUNC(0) |
					 IPSR_4_FUNC(0) | IPSR_0_FUNC(0));
	pfc_reg_write(PFC_IPSR10, IPSR_28_FUNC(0) | IPSR_24_FUNC(0) |
					  IPSR_20_FUNC(0) | IPSR_16_FUNC(0) |
					  IPSR_12_FUNC(0) | IPSR_8_FUNC(0) |
					  IPSR_4_FUNC(0) | IPSR_0_FUNC(0));
	...
	pfc_reg_write(PFC_GPSR0, GPSR0_D15 | GPSR0_D14 | GPSR0_D13 | GPSR0_D12 |
					 ...
					 GPSR0_D8 | GPSR0_D7 | GPSR0_D6 |
					 GPSR0_D5 | GPSR0_D4 | GPSR0_D3 |
					 GPSR0_D2 | GPSR0_D0);
	pfc_reg_write(PFC_GPSR1,
		      GPSR1_CLKOUT | GPSR1_EX_WAIT0_A | GPSR1_WE1 | GPSR1_RD |
			      GPSR1_RD_WR | GPSR1_CS0 | GPSR1_A19 | GPSR1_A18 |
			      GPSR1_A17 | GPSR1_A16 | GPSR1_A15 | GPSR1_A14 |
			      GPSR1_A13 | GPSR1_A12 | GPSR1_A7 | GPSR1_A6 |
			      GPSR1_A5 | GPSR1_A4 | GPSR1_A3 | GPSR1_A2 |
			      GPSR1_A1 | GPSR1_A0);
	pfc_reg_write(PFC_GPSR2,
		      GPSR2_AVB_AVTP_CAPTURE_A | GPSR2_AVB_AVTP_MATCH_A |
			      ...
			      GPSR2_IRQ4 | GPSR2_IRQ3 | GPSR2_IRQ2 |
			      GPSR2_IRQ1 | GPSR2_IRQ0);
	pfc_reg_write(PFC_GPSR3,
		      GPSR3_SD0_CD | GPSR3_SD1_DAT3 | GPSR3_SD1_DAT2 |
			      GPSR3_SD1_DAT1 | GPSR3_SD1_DAT0 | GPSR3_SD0_DAT3 |
			      GPSR3_SD0_DAT2 | GPSR3_SD0_DAT1 | GPSR3_SD0_DAT0 |
			      GPSR3_SD0_CMD | GPSR3_SD0_CLK);
	pfc_reg_write(PFC_GPSR4,
		      GPSR4_SD3_DS | GPSR4_SD3_DAT7 | GPSR4_SD3_DAT6 |
			      GPSR4_SD3_DAT5 | GPSR4_SD3_DAT4 | GPSR4_SD3_DAT3 |
			      GPSR4_SD3_DAT2 | GPSR4_SD3_DAT1 | GPSR4_SD3_DAT0 |
			      GPSR4_SD3_CMD | GPSR4_SD3_CLK | GPSR4_SD2_DAT3 |
			      GPSR4_SD2_DAT2 | GPSR4_SD2_DAT1 | GPSR4_SD2_DAT0 |
			      GPSR4_SD2_CMD | GPSR4_SD2_CLK);
	pfc_reg_write(PFC_GPSR5, GPSR5_MSIOF0_RXD | GPSR5_MSIOF0_TXD |
					 GPSR5_MSIOF0_SYNC | GPSR5_MSIOF0_SCK |
					 GPSR5_RX2_A | GPSR5_TX2_A |
					 GPSR5_RTS1 | GPSR5_CTS1 | GPSR5_TX1_A |
					 GPSR5_RX1_A | GPSR5_RTS0 | GPSR5_SCK0);
	pfc_reg_write(PFC_GPSR6, GPSR6_AUDIO_CLKB_B | GPSR6_AUDIO_CLKA_A |
					 GPSR6_SSI_WS6 | GPSR6_SSI_SCK6 |
					 GPSR6_SSI_SDATA4 | GPSR6_SSI_WS4 |
					 GPSR6_SSI_SCK4 | GPSR6_SSI_SDATA1_A |
					 GPSR6_SSI_SDATA0 | GPSR6_SSI_WS0129 |
					 GPSR6_SSI_SCK0129);
	pfc_reg_write(PFC_GPSR7, GPSR7_AVS2 | GPSR7_AVS1);

	/* initialize POC control register */
	pfc_reg_write(PFC_POCCTRL0, POC_SD0_DAT3_33V | POC_SD0_DAT2_33V |
					    POC_SD0_DAT1_33V |
					    POC_SD0_DAT0_33V | POC_SD0_CMD_33V |
					    POC_SD0_CLK_33V);
