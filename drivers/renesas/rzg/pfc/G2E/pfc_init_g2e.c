...
void pfc_init_g2e(void)
{
	...
	pfc_reg_write(
		...
		MOD_SEL1_SIMCARD_A | MOD_SEL1_SSI2_A | MOD_SEL1_TIMER_TMU_A |
			...
			MOD_SEL1_DRIF3_A | MOD_SEL1_HSCIF3_C |
			MOD_SEL1_HSCIF4_B | MOD_SEL1_I2C6_A | MOD_SEL1_I2C7_A |
	...
	pfc_reg_write(PFC_IPSR11,
		      IPSR_28_FUNC(0) | IPSR_24_FUNC(8) | /* USB0_ID */
	...
	pfc_reg_write(PFC_GPSR0, GPSR0_SCL4 | GPSR0_D15 | GPSR0_D14 |
					 GPSR0_D13 | GPSR0_D12 | GPSR0_D11 |
					 GPSR0_D10 | GPSR0_D9 | GPSR0_D8 |
					 GPSR0_D7 | GPSR0_D6 | GPSR0_D5 |
					 GPSR0_D4 | GPSR0_D3 | GPSR0_D2 |
					 GPSR0_D1 | GPSR0_D0);
	...
	pfc_reg_write(PFC_GPSR2,
		      GPSR2_BIT27_REVERSED | GPSR2_BIT26_REVERSED |
			      ...
			      GPSR2_QSPI1_IO3 | GPSR2_QSPI1_IO2 |
			      GPSR2_QSPI1_MISO_IO1 | GPSR2_QSPI1_MOSI_IO0 |
	...
	pfc_reg_write(PFC_GPSR4, GPSR4_SD3_DAT3 | GPSR4_SD3_DAT2 |
					 GPSR4_SD3_DAT1 | GPSR4_SD3_DAT0 |
					 GPSR4_SD3_CMD | GPSR4_SD3_CLK);

	pfc_reg_write(PFC_GPSR5, GPSR5_MLB_SIG | GPSR5_MLB_CLK |
					 GPSR5_SSI_SDATA9 | GPSR5_MSIOF0_SS2 |
					 GPSR5_MSIOF0_SS1 | GPSR5_MSIOF0_SYNC |
					 GPSR5_MSIOF0_TXD | GPSR5_MSIOF0_RXD |
					 GPSR5_MSIOF0_SCK | GPSR5_RX2_A |
					 GPSR5_TX2_A | GPSR5_RTS0_A |
					 GPSR5_SCK0_A);

	pfc_reg_write(PFC_GPSR6, GPSR6_USB30_PWEN | GPSR6_SSI_SDATA6 |
					 GPSR6_SSI_WS6 | GPSR6_SSI_SCK6 |
					 GPSR6_SSI_SDATA5 | GPSR6_SSI_SCK5 |
					 GPSR6_SSI_SDATA4 | GPSR6_USB30_OVC |
					 GPSR6_AUDIO_CLKA | GPSR6_SSI_SDATA3 |
					 GPSR6_SSI_WS349 | GPSR6_SSI_SCK349 |
