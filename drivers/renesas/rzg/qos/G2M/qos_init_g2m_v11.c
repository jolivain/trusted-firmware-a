...
#error "Don't set DRAM Split 4ch(G2M)"
	...
	mmio_write_32(QOSWT_WTSET0, (QOSWT_WTSET0_PERIOD0_G2M_11 << 16) |
					    (QOSWT_WTSET0_SSLOT0 << 8) |
					    QOSWT_WTSET0_SLOTSLOT0);
	mmio_write_32(QOSWT_WTSET1, (QOSWT_WTSET1_PERIOD1_G2M_11 << 16) |
					    (QOSWT_WTSET1_SSLOT1 << 8) |
