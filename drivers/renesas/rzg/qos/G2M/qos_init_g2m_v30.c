...
void qos_init_g2m_v30(void)
{
  ...
  #error "Don't set DRAM Split 4ch(G2M)"
	...
	io_write_32(QOSCTRL_SL_INIT,
		    SL_INIT_REFFSSLOT | SL_INIT_SLOTSSLOT | SL_INIT_SSLOTCLK_G2M_30);
	...
	io_write_32(QOSWT_WTSET0, ((QOSWT_WTSET0_PERIOD0_G2M_30 << 16) |
				   (QOSWT_WTSET0_SSLOT0 << 8) | QOSWT_WTSET0_SLOTSLOT0));
	io_write_32(QOSWT_WTSET1, ((QOSWT_WTSET1_PERIOD1_G2M_30 << 16) |
