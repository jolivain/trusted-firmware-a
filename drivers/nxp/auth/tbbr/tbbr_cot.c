...
static auth_param_type_desc_t non_trusted_world_pk =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_PUB_KEY, NON_TRUSTED_WORLD_PK_OID);
...
#ifdef CONFIG_DDR_FIP_IMAGE
static auth_param_type_desc_t ddr_fw_content_pk =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_PUB_KEY, DDR_FW_CONTENT_CERT_PK_OID);

static auth_param_type_desc_t ddr_imem_udimm_1d_fw_hash =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_HASH, DDR_IMEM_UDIMM_1D_HASH_OID);
static auth_param_type_desc_t ddr_imem_udimm_2d_fw_hash =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_HASH, DDR_IMEM_UDIMM_2D_HASH_OID);
static auth_param_type_desc_t ddr_dmem_udimm_1d_fw_hash =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_HASH, DDR_DMEM_UDIMM_1D_HASH_OID);
static auth_param_type_desc_t ddr_dmem_udimm_2d_fw_hash =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_HASH, DDR_DMEM_UDIMM_2D_HASH_OID);

static auth_param_type_desc_t ddr_imem_rdimm_1d_fw_hash =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_HASH, DDR_IMEM_RDIMM_1D_HASH_OID);
static auth_param_type_desc_t ddr_imem_rdimm_2d_fw_hash =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_HASH, DDR_IMEM_RDIMM_2D_HASH_OID);
static auth_param_type_desc_t ddr_dmem_rdimm_1d_fw_hash =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_HASH, DDR_DMEM_RDIMM_1D_HASH_OID);
static auth_param_type_desc_t ddr_dmem_rdimm_2d_fw_hash =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_HASH, DDR_DMEM_RDIMM_2D_HASH_OID);
#endif
...
static const auth_img_desc_t trusted_key_cert = {
	...
	.authenticated_data =
		(const auth_param_desc_t[COT_MAX_VERIFIED_PARAMS]){
			...
			[1] = { .type_desc = &non_trusted_world_pk,
				.data = { .ptr = (void *)
...
static const auth_img_desc_t non_trusted_fw_key_cert = {
	...
	.img_auth_methods =
		(const auth_method_desc_t[AUTH_METHOD_NUM]){
			[0] = { .type = AUTH_METHOD_SIG,
				.param.sig = { .pk = &non_trusted_world_pk,
					       .sig = &sig,
					       .alg = &sig_alg,
					       .data = &raw_data } },
			[1] = { .type = AUTH_METHOD_NV_CTR,
...
static const auth_img_desc_t ddr_fw_key_cert = {
	...
	.authenticated_data =
		(const auth_param_desc_t[COT_MAX_VERIFIED_PARAMS]){
			[0] = { .type_desc = &ddr_fw_content_pk,
				.data = { .ptr = (void *)ddr_fw_content_pk_buf,
					  .len = (unsigned int)PK_DER_LEN } } }
};
static const auth_img_desc_t ddr_udimm_fw_content_cert = {
	...
	.img_auth_methods =
		(const auth_method_desc_t[AUTH_METHOD_NUM]){
			[0] = { .type = AUTH_METHOD_SIG,
				.param.sig = { .pk = &ddr_fw_content_pk,
					       .sig = &sig,
					       .alg = &sig_alg,
					       .data = &raw_data } },
			[1] = { .type = AUTH_METHOD_NV_CTR,
	...
	.authenticated_data =
		(const auth_param_desc_t[COT_MAX_VERIFIED_PARAMS]){
			[0] = { .type_desc = &ddr_imem_udimm_1d_fw_hash,
				.data = { .ptr = (void *)
						  ddr_imem_udimm_1d_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } },
			[1] = { .type_desc = &ddr_imem_udimm_2d_fw_hash,
				.data = { .ptr = (void *)
						  ddr_imem_udimm_2d_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } },
			[2] = { .type_desc = &ddr_dmem_udimm_1d_fw_hash,
				.data = { .ptr = (void *)
						  ddr_dmem_udimm_1d_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } },
			[3] = { .type_desc = &ddr_dmem_udimm_2d_fw_hash,
				.data = { .ptr = (void *)
						  ddr_dmem_udimm_2d_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } },
		}
};
...
static const auth_img_desc_t ddr_rdimm_fw_content_cert = {
	...
	.authenticated_data =
		(const auth_param_desc_t[COT_MAX_VERIFIED_PARAMS]){
			[0] = { .type_desc = &ddr_imem_rdimm_1d_fw_hash,
				.data = { .ptr = (void *)
						  ddr_imem_rdimm_1d_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } },
			[1] = { .type_desc = &ddr_imem_rdimm_2d_fw_hash,
				.data = { .ptr = (void *)
						  ddr_imem_rdimm_2d_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } },
			[2] = { .type_desc = &ddr_dmem_rdimm_1d_fw_hash,
				.data = { .ptr = (void *)
						  ddr_dmem_rdimm_1d_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } },
			[3] = { .type_desc = &ddr_dmem_rdimm_2d_fw_hash,
				.data = { .ptr = (void *)
						  ddr_dmem_rdimm_2d_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } },
		}
};
