...
#define fspiREAD_SEQ_ID			0U
#define fspiWREN_SEQ_ID			1U
#define fspiWRITE_SEQ_ID		2U
#define fspiSE_SEQ_ID			3U
#define fspiRDSR_SEQ_ID			4U
#define fspiBE_SEQ_ID			5U
#define fspiFASTREAD_SEQ_ID		6U
#define fspiSE_4K_SEQ_ID		7U
