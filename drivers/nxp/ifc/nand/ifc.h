...
#define NXP_IFC_RUN_TIME_ADDR	0x1000

/* CPSR - Chip Select Property Register Offset */
#define EXT_CSPR(n)		(0x000C + (n * 0xC))
#define CSPR(n)			(0x0010 + (n * 0xC))
#define CSOR(n)			(0x0130 + (n * 0xC))
#define EXT_CSOR(n)		(0x0134 + (n * 0xC))
#define IFC_AMASK_CS0		0x00A0
