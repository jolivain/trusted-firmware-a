...
#define DIG_LOOPBACK_EN_ADDR(unit) (COMPHY_DIG_LOOPBACK_EN * PHY_SHFT(unit))
...
#define GS2_TX_SSC_AMP_MASK \
	(((1 << GS2_TX_SSC_AMP_LEN) - 1) << GS2_TX_SSC_AMP_OFF)
...
#define GS2_RSVD_6_0_MASK (((1 << GS2_RSVD_6_0_LEN) - 1) << GS2_RSVD_6_0_OFF)
...
#define CFG_PM_RXDLOZ_WAIT_MASK \
	(((1 << CFG_PM_RXDLOZ_WAIT_LEN) - 1) << CFG_PM_RXDLOZ_WAIT_OFF)
