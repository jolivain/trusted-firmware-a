...
static auth_param_type_desc_t rmm_hash =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_HASH, RMM_HASH_OID);
...
static auth_param_type_desc_t swd_rot_pk =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_PUB_KEY, SWD_ROT_PK_OID);
static auth_param_type_desc_t core_swd_pk =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_PUB_KEY, CORE_SWD_PK_OID);
static auth_param_type_desc_t plat_pk =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_PUB_KEY, PLAT_PK_OID);
		...
		(const auth_param_desc_t[COT_MAX_VERIFIED_PARAMS]){
			...
			[1] = { .type_desc = &tb_fw_config_hash,
				.data = { .ptr = (void *)tb_fw_config_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } },
			[2] = { .type_desc = &fw_config_hash,
				.data = { .ptr = (void *)fw_config_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } },
			[3] = { .type_desc = &hw_config_hash,
				.data = { .ptr = (void *)hw_config_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } },
			[4] = { .type_desc = &soc_fw_hash,
				.data = { .ptr = (void *)soc_fw_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } },
			[5] = { .type_desc = &soc_fw_config_hash,
				.data = { .ptr = (void *)soc_fw_config_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } },
			[6] = { .type_desc = &rmm_hash,
				.data = { .ptr = (void *)rmm_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } } }
};
		...
		(const auth_param_desc_t[COT_MAX_VERIFIED_PARAMS]){
			[0] = { .type_desc = &tos_fw_hash,
				.data = { .ptr = (void *)tos_fw_hash_buf,
					  .len = (unsigned int)HASH_DER_LEN } },
			[1] = { .type_desc = &tos_fw_config_hash,
