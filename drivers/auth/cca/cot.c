...
static unsigned char oem_pk_buf[PK_DER_LEN];
#endif
...
static auth_param_type_desc_t oem_pk = AUTH_PARAM_TYPE_DESC(
		AUTH_PARAM_PUB_KEY, OEM_PK_OID);
...
static const auth_img_desc_t spmc_content_cert = {
...
/* OEM Key Certificate */
static const auth_img_desc_t oem_key_cert = {
	.img_id = OEM_KEY_CERT_ID,
	.img_type = IMG_CERT,
	.parent = NULL, /* OEM ROOT CERT */
	.img_auth_methods = (const auth_method_desc_t[AUTH_METHOD_NUM]) {
		[0] = {
			.type = AUTH_METHOD_SIG,
			.param.sig = {
...
static const auth_img_desc_t * const cot_desc[] = {
	...
	[TRUSTED_OS_FW_CONTENT_CERT_ID]		=	&spmc_content_cert,
	[BL32_IMAGE_ID]				=	&bl32_image,
	[TOS_FW_CONFIG_ID]			=	&tos_fw_config,
	[OEM_KEY_CERT_ID]			=	&oem_key_cert,
