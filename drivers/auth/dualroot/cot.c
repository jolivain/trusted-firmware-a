...
#if defined(SPD_spmd)
static unsigned char sp_pkg1_hash_buf[HASH_DER_LEN];
static unsigned char sp_pkg2_hash_buf[HASH_DER_LEN];
static unsigned char sp_pkg3_hash_buf[HASH_DER_LEN];
static unsigned char sp_pkg4_hash_buf[HASH_DER_LEN];
static unsigned char sp_pkg5_hash_buf[HASH_DER_LEN];
static unsigned char sp_pkg6_hash_buf[HASH_DER_LEN];
static unsigned char sp_pkg7_hash_buf[HASH_DER_LEN];
static unsigned char sp_pkg8_hash_buf[HASH_DER_LEN];
#endif
