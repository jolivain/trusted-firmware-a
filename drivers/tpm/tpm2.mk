...
ifeq (${TPM_INTERFACE}, FIFO_I2C)
	TPM2_SOURCES	+= ${TPM2_SRC_DIR}tpm2_fifo.c \
					${TPM2_SRC_DIR}tpm2_fifo_i2c.c
else ifeq (${TPM_INTERFACE}, FIFO_SPI)
	TPM2_SOURCES	+= ${TPM2_SRC_DIR}tpm2_fifo.c \
					${TPM2_SRC_DIR}tpm2_fifo_spi.c
else ifeq (${TPM_INTERFACE}, FIFO_MMIO)
	TPM2_SOURCES	+= ${TPM2_SRC_DIR}tpm2_fifo.c \
					${TPM2_SRC_DIR}tpm2_fifo_spi.c
else ifeq (${TPM_INTERFACE}, CRB)
	TPM2_SOURCES	+= ${TPM2_SRC_DIR}tpm2_crb.c
else
