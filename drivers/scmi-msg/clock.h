...
#define SCMI_CLOCK_RATE_SET_ASYNC_MASK BIT(SCMI_CLOCK_RATE_SET_ASYNC_POS)
#define SCMI_CLOCK_RATE_SET_NO_DELAYED_RESPONSE_MASK \
	BIT(SCMI_CLOCK_RATE_SET_NO_DELAYED_RESPONSE_POS)
#define SCMI_CLOCK_RATE_SET_ROUND_UP_MASK BIT(SCMI_CLOCK_RATE_SET_ROUND_UP_POS)
...
#define SCMI_CLOCK_CONFIG_SET_ENABLE_MASK BIT(SCMI_CLOCK_CONFIG_SET_ENABLE_POS)
