...
.. note::
 ...
 should be dealt with by the appropriate agent in the platform/system. Since
 Measured Boot does not use local attestation, there would be no further assets
 to protect. For example, some keys could be unsealed and |TF-A| would need to
 protect them.
