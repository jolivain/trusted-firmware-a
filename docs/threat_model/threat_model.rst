...
Note that the boot firmware does not stay resident in memory, it is dismissed
once execution has reached the runtime EL3 firmware (BL31). Thus, past that
point in time, these threats can no longer be exploited.
