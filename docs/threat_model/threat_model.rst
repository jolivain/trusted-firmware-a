...
For each threat, we thrive to indicate whether the mitigations are currently
...
explicitly turned on via some build flag.

These are highlighted in the ``Mitigations in place`` box.
...
+------------------------+----------------------------------------------------+
| Mitigations in place   | | 1) Yes, provided that the ``TRUSTED_BOARD_BOOT`` |
|                        |   build option is set to 1.                        |
|                        |                                                    |
|                        | | 2) Yes.                                          |
+------------------------+----------------------------------------------------+
...
+------------------------+----------------------------------------------------+
| Mitigations in place   | | Yes / Platform specific.                         |
|                        |                                                    |
...
|                        | it.                                                   |
+------------------------+-------------------------------------------------------+
| Mitigations in place   | | Platform specific.                                  |
|                        |                                                       |
...
|                        |   values, privilege level, stack dumps...         |
|                        |                                                   |
...
+------------------------+---------------------------------------------------+
| Mitigations in place   | | Yes / Platform Specific.                        |
|                        |   Requires the right build options to be used.    |
|                        |                                                   |
