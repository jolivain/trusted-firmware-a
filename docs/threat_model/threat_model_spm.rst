...
|                        | notifications bitmaps in the SPMC, throught the    |
|                        | FFA_NOTIFICATION_BITMAP_CREATE.**                  |
|                        | This might be an attempt to exaust SPMC's memory,  |
...
|                        | state such that a partition isn't able to receveive|
|                        | notifications.                                     |
+------------------------+----------------------------------------------------+
| ``Diagram Elements``   | DF1, DF2, DF3                                      |
+------------------------+----------------------------------------------------+
...
|                        | notifications targetting a another receiver, the   |
|                        | FF-A call FFA_NOTIFICATION_BIND.**                 |
|                        | This might be an attempt to tamper with the SPMC   |
|                        | state such that an unintended malicious, and       |
|                        | possibly malicious, communication channel is       |
|                        | established.                                       |
+------------------------+----------------------------------------------------+
| ``Diagram Elements``   | DF1, DF2, DF3                                      |
+------------------------+----------------------------------------------------+
...
| ``Total Risk Rating``  | Medium(6)        | Medium(6)       |               |
+------------------------+------------------+-----------------+---------------+
| ``Mitigations``        | This TF-A SPMC mitigates this by restricting       |
...
|                        | SPMC trusts the Hypervisor to have validated the   |
|                        | NWd VM's receiver ID.                              |
+------------------------+----------------------------------------------------+
...
|                        | given receiver. The sender is an SP, the provided  |
|                        | sender ID must match the ID of the currently       |
|                        | running. The SPMC trusts the Hypervisor to do this |
|                        | same validation.                                   |
+------------------------+----------------------------------------------------+
...
+========================+====================================================+
| ``Threat``             | **A malicious partition endpoint might attempt to  |
|                        | get notifications that are not targetted to it.**  |
+------------------------+----------------------------------------------------+
| ``Diagram Elements``   | DF1, DF2, DF3                                      |
+------------------------+----------------------------------------------------+
| ``Affected TF-A        | SPMC                                               |
...
|                        | If in NWd, the SPMC relies on the hypervisor to    |
|                        | have validated this same condition.                |
+------------------------+----------------------------------------------------+
...
|                        | This call is meant to be used by the primary FF-A  |
|                        | partition.                                         |
+------------------------+----------------------------------------------------+
| ``Diagram Elements``   | DF1, DF2, DF3                                      |
+------------------------+----------------------------------------------------+
...
|                        | to calls made by SPs to FFA_NOTIFICATION_INFO_GET. |
|                        | If call issued in the NWd, the SPMC trusts that    |
|                        | the hypervisor made the adequate validation to the |
|                        | caller's ID, prior to forwarding the call to the   |
|                        | SWd.                                               |
+------------------------+----------------------------------------------------+
...
|                        | needs to be retrieved by the receiver, until it can|
|                        | be sent again.                                     |
