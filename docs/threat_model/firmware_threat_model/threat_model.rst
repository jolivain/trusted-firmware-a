...
| ID                     | 16                                                |
+========================+===================================================+
| Threat                 | | **An attacker analyse the timing behaviour of   |
|                        |   implemented methods in the system to infer   |
...
|                        |                                                   |
|                        | |  Introduce random delays or dummy operations to |
|                        |    make the timing behavior less predictable. This|
|                        |    can disrupt the correlation between the        |
|                        |    execution time and sensitive data.             |
|                        |                                                   |
+------------------------+---------------------------------------------------+
