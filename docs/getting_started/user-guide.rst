...
-  ``SANITIZE_UB``: This option enables the Undefined Behaviour sanitizer. It
   ...
   Note that because of the space penalty of the Undefined Behaviour sanitizer,
   this option will increase the size of the binary. Because of this, the
   sanitizer should only be enabled at BL31 and probably only in debug builds.
