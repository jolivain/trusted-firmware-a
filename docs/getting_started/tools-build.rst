...
testing purposes, a good BL33 is the `TF-A Tests`_ ``tftf.bin`` binary. Refer to
their `documentation`_ on how to build it.
...
.. _documentation: https://trustedfirmware-a-tests.readthedocs.io/en/latest/
