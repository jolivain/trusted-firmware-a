...
|TF-A| can be built with any of the *cross-compiler* toolchains listed in the
table above that target Armv7-A or Armv8-A. You will need the targets
``arm-none-eabi`` and ``aarch64-none-elf`` for AArch32 and AArch64 builds
respectively.
