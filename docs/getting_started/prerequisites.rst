...
Version Manager`_ to install a version of your choosing (we recommend 10, but
...
You will need to re-source your shell resource configuration after installing
(e.g. ``source ~/.bashrc``).
...
TF-A is hosted by a `Gerrit Code Review <https://www.gerritcodereview.com/>`
server. Gerrit requires that all commits include a ``Change-Id`` footer, and
this footer is typically automatically generated by a Git hook installed by you,
the developer.
...
documentation, available at: https://git-scm.com/docs/githooks
