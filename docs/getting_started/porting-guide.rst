...
::
    ...
    Argument : uint32_t active_fw_bank_idx
    Return   : void

This function is mandatory when PSA_FWU_SUPPORT is enabled.
This function provides a means to retrieve image specification (offset in
non-volatile storage and length) of active/updated images using the passed
active firmware bank index, and update I/O policies of active/updated images
using retrieved image specification information.
...
This function is mandatory when PSA_FWU_SUPPORT is enabled. This function is
