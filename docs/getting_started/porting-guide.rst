...
-  On the Arm FVP port, this function is used to initialise the Event Log
   backend driver, and also to write header information in the Event Log buffer.
-  This function results in panic on error.
...
-  This function is used to teardown the measured boot backend driver(s),
...
-  On the Arm FVP port, this function is used to pass the Event Log buffer
   ...
   via nt_fw and tos_fw config respectively.
-  This function results in panic on error.
