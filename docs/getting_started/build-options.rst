...
-  ``ENABLE_SVE_FOR_NS``: Boolean option to enable Scalable Vector Extension
   ...
   defaule and controlled with ENABLE_SVE_FOR_SW.
...
-  ``ENABLE_SVE_FOR_SW``: Boolean option to enable Scalable Vector Extension
   (SVE) for the Secure world. SVE is an optional architectural feature
   for AArch64. Note that this option requires ENABLE_SVE_FOR_NS to be enabled.
   The default is 0 and it is automatically disabled when the target
   architecture is AArch32.
