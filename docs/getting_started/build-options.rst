...
-  ``SPMC_AT_EL3`` : This boolean option is used jointly with the SPM
   ...
   component runs at the EL3 execution state. The default value is ``0`` (
   disabled). This configuration supports pre-Armv8.4 platforms (aka not
   implementing the Armv8.4-SecEL2 extension). This is an experimental feature.
...
-  ``SPMD_SPM_AT_SEL2`` : This boolean option is used jointly with the SPM
   ...
   support pre-Armv8.4 platforms (aka not implementing the Armv8.4-SecEL2
   extension).
