...
-  ``BL2_ENABLE_CONFIG_LOAD``: Boolean option to enable the loading of fw_config
   device trees from the Firmware Image Package (FIP). When enabled, BL2 will load
   the specified device trees from the FIP. This option is dependent on RESET_TO_BL2.
