...
- ``ERRATA_NON_ARM_INTERCONNECT``: Boolean option to enable support for the errata mitigation for
  platforms with a non-arm interconnect using errata ABI. By default its disabled (``0``).
