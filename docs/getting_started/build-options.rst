...
-  ``ENABLE_FEAT_AMUv1``: Boolean option to enable access to the HAFGRTR_EL2
   ...
   on v8.4 and onwards and must be set to 1 alongside ``ENABLE_FEAT_ECV``, to
...
-  ``ENABLE_FEAT_ECV``: Boolean option to enable support for the Enhanced Counter
   ...
   Its a mandatory architectural feature available on v8.6 and must be explicitly
   set to ``1`` for v8.6  onwards. Defaults to ``0``.
