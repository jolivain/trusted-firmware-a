...
- **Architecture**
  ...
  - **Activity Monitors Extension (FEAT_AMU)**
    ...
    - remove `amu_fconf.c` ([2062a39](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/2062a3936f209c31ace73705754a3442305a577d))
...
- **Libraries**
  ...
  - **CPU Support**
    ...
    - correct typo ([322e60a](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/322e60a6c7ad95a874e5eaf2de5db4f6e1912ba9))
...
- **Drivers**
  ...
  - **Renesas**
    ...
    - **R-Car3**
      ...
      - ddr: add function to judge a DDR rank ([726050b](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/726050b8e2d2ee2234e103e2df55f9c7f262c851))
...
- **Build System**
  ...
  - incrementing minor version to reflect v2.5 release ([ff2da9e](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/ff2da9e331c7bbc91aed5582d61fe47f94c94179))
