...
- **Bootloader Images**
  ...
  - **BL31**
    ...
    - fix validate_el3_interrupt_rm preprocessor usage ([6e08cff](https://review.trustedfirmware.org/plugins/gitiles/TF-A/trusted-firmware-a/+/6e08cffcd22b3e756503addbf8dddfa9f5740045))
