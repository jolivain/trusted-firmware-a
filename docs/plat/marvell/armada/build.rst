...
- CM3_SYSTEM_RESET
        ...
        For Armada37x0 only, use the Cortex-M3 secure coprocessor for system reset.
        ...
        System reset via Cortex-M3 secure coprocessor is disabled by default and can be enabled with
        option ``CM3_SYSTEM_RESET=1``. If this option is enabled but the firmware
