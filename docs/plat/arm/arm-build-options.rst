...
- ``CSS_SGI_PLATFORM_VARIANT``: Selects the variant of a SGI/RD platform. A
    ...
    core count, cluster count and other peripherals. This build option is used
    to select the appropriate platform configuration for the variant selected.
    The range of valid values is platform specific.
