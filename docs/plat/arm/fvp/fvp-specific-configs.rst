...
.. note::
    ...
    |
    | ARM_PRELOADED_DTB_BASE = 0x87F80000
    | (DTB is placed 127MiB after kernel to support larger kernels)
    |
    | PRELOADED_INITRD_BASE = 0x88080000
...
.. code:: shell
    ...
    --data cluster0.cpu0="<path-to>/<device-tree-blob>"@87F80000 \
    --data cluster0.cpu0="<path-to>/<kernel-binary>"@0x80080000 \
    --data cluster0.cpu0="<path-to>/<ramdisk.img>"@0x88080000
...
.. code:: shell
    ...
    RESET_TO_BL31=1                   \
    ARM_LINUX_KERNEL_AS_BL33=1        \
    PRELOADED_INITRD_BASE=0x88080040  \
