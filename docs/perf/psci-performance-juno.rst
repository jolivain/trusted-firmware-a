...
.. table:: ``CPU_SUSPEND`` latencies (µs) to deepest power level in
    ...
    +---------+------+-----------+--------+-------------+
    |    0    |  0   |   242.66  | 245.10 |     5.40    |
    +---------+------+-----------+--------+-------------+
    |    0    |  1   |   522.08  | 26.24  |    138.32   |
    +---------+------+-----------+--------+-------------+
    |    1    |  0   |   104.36  | 27.10  |     5.32    |
    +---------+------+-----------+--------+-------------+
    |    1    |  1   |   382.56  | 23.34  |     4.42    |
    +---------+------+-----------+--------+-------------+
    |    1    |  2   |   807.74  | 271.54 |     4.64    |
    +---------+------+-----------+--------+-------------+
    |    1    |  3   |   981.36  | 221.80 |    79.48    |
    +---------+------+-----------+--------+-------------+
...
.. table:: ``CPU_SUSPEND`` latencies (µs) to deepest power level in
    ...
    | Cluster | Core | Powerdown | Wakeup | Cache Flush |
    +---------+------+-----------+--------+-------------+
    |    0    |  0   |   236.84  | 27.10  |    138.36   |
    +---------+------+-----------+--------+-------------+
    |    0    |  1   |   236.96  | 27.10  |    138.32   |
    +---------+------+-----------+--------+-------------+
    |    1    |  0   |   280.06  | 26.94  |    77.50    |
    +---------+------+-----------+--------+-------------+
    |    1    |  1   |   100.76  | 23.42  |     4.36    |
    +---------+------+-----------+--------+-------------+
    |    1    |  2   |   100.02  | 23.42  |     4.44    |
    +---------+------+-----------+--------+-------------+
    |    1    |  3   |   100.08  | 23.20  |     4.40    |
    +---------+------+-----------+--------+-------------+
...
.. table:: ``CPU_SUSPEND`` latencies (µs) to power level 0 in
    ...
    +---------+------+-----------+--------+-------------+
    |    1    |  0   |   105.90  | 20.30  |     7.58    |
    +---------+------+-----------+--------+-------------+
    |    1    |  1   |   383.58  | 20.40  |     7.42    |
    +---------+------+-----------+--------+-------------+
    |    1    |  2   |   523.52  | 20.10  |     7.74    |
    +---------+------+-----------+--------+-------------+
    |    1    |  3   |   244.50  | 20.16  |     7.56    |
    +---------+------+-----------+--------+-------------+
...
.. table:: ``CPU_SUSPEND`` latencies (µs) to power level 0 in serial
    ...
    +---------+------+-----------+--------+-------------+
    |    0    |  1   |   100.20  | 18.82  |     5.66    |
    +---------+------+-----------+--------+-------------+
    |    1    |  0   |   278.12  | 20.56  |     4.48    |
    +---------+------+-----------+--------+-------------+
    |    1    |  1   |   96.68   | 20.62  |     4.30    |
    +---------+------+-----------+--------+-------------+
...
.. table:: ``CPU_OFF`` latencies (µs) on all non-lead CPUs
    ...
    | Cluster | Core | Powerdown | Wakeup | Cache Flush |
    +---------+------+-----------+--------+-------------+
    |    0    |  0   |   236.04  | 30.02  |    137.90   |
    +---------+------+-----------+--------+-------------+
    |    0    |  1   |   235.38  | 29.70  |    137.72   |
    +---------+------+-----------+--------+-------------+
    |    1    |  0   |   175.18  | 26.96  |    77.26    |
    +---------+------+-----------+--------+-------------+
    |    1    |  1   |   100.56  | 28.34  |     4.32    |
    +---------+------+-----------+--------+-------------+
    |    1    |  2   |   100.38  | 26.82  |     4.30    |
    +---------+------+-----------+--------+-------------+
