...
Standard (PCS) in their internals. This is done to ensure calling these
functions from outside the file doesn't unexpectedly corrupt registers in the
very early environment and to help the internals to be easier to understand.
...
.. note::
 ...
 scenarion where a CVE and an erratum numbers clash, the CVE number should be
