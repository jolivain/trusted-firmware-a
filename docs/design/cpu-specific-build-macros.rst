...
- ``ERRATA_X3_2743088``: This applies errata 2743088 workaround to Cortex-X3 CPU
  affecting all configurations. This needs to be enabled only for revisions r0p0,
  r1p0 and r1p1. It is fixed in r1p2.
