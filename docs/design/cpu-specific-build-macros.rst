...
For Cortex-A78 C, the following errata build flags are defined :

-  ``ERRATA_A78_C_2132064``: This applies errata 2132064 workaround to
  Cortex-A78 C CPU. This needs to be enabled for revisions r0p1, r0p2, and
  it is still open.
