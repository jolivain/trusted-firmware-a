...
- ``ERRATA_X4_2701112``: This applies erratum 2701112 workaround to Cortex-X4
  ...
  be enabled/disabled on a platform level. The flag is used by the errata ABI
  feature if the feature is enabled and can assist the Kernel in the process of
