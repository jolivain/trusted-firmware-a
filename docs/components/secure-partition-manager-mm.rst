...
-  SPM based on the PSA FF-A specification (`Platform Security Architecture Firmware
   Framework for Arm® v8-A 1.0 Platform Design Document
...
This implementation is legacy and is not meant to evolve significantly further.
