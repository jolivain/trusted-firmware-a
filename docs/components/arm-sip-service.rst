...
int32_t         w0 == SMC_OK on success
                ...
                w0 == SMC_UNK if mount operation failed
=============== ==========================================================
...
int32_t         w0 == SMC_OK on success
                ...
                w0 == SMC_UNK if open operation failed
...
int32_t         w0 == SMC_OK on success
                ...
                w0 == SMC_UNK if close operation failed
=============== ==========================================================
...
int32_t         w0 == SMC_OK on success
                ...
                w0 == SMC_UNK if read operation failed
...
int32_t         w0 == SMC_OK on success
                ...
                w0 == SMC_UNK if seek operation failed
=============== ==========================================================
...
int32_t         w0 == SMC_OK on success
                ...
                w0 == SMC_UNK if bind operation failed
=============== ==========================================================
...
int32_t         w0 == SMC_OK on success
                ...
                w0 == SMC_UNK if stat operation failed
=============== ==========================================================
...
int32_t         w0 == SMC_OK on success
                ...
                w0 == SMC_UNK if already initialized, or internal
                error
=============== ======================================================
...
uint32_t        w1: debugfs interface version, 32 bits value with
                major version number in upper 16 bits and minor version
                in lower 16 bits.
=============== ======================================================
