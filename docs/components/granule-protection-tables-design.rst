...
allocates memory for fine-grained locks adjcent to the L0 tables. In the
...
data structure. The amount of memory need for bitlock structure  is controlled via
