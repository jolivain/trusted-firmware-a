...
results in a world switch to NS. This call is forwarded by EL3 to the NS world
where the RMI call for which this is an answer was originated.
...
Sinnce this call does not return to RMM, there is no failure condition which
...
.. csv-table::
   ...
   fid,x0,[63:0],UInt64,Command FID
   base_pa,x1,[63:0],Address,PA of the start of the granule to be delegated. It must be aligned to the size of the granule (4KB)
...
.. csv-table::
   ...
   fid,x0,[63:0],UInt64,Command FID
   base_pa,x1,[63:0],Address,PA of the start of the granule to be undelegated. It must be aligned to the size of the granule (4KB)
