...
.. note::
 ...
 Feature MTE needs to be disabled in Hafnium build, modify file: project/reference/BUILD.gn
...
**2. Build Cactus and Ivy TF-A tests Secure Partition**

.. code:: shell

 git clone https://git.trustedfirmware.org/TF-A/tf-a-tests.git
 cd tf-a-tests
 make CROSS_COMPILE=aarch64-none-elf- PLAT=fvp DEBUG=1 cactus ivy

This produces **sp_layout.json** binaries in **build/fvp/debug** directory
...
Use the following arguments in addition to ``Running the tests for a 3 world FVP setup`` `[1]`_ to run tests for 4 world setup.
...
.. _[1]: https://trustedfirmware-a.readthedocs.io/en/latest/components/realm-management-extension.html#running-the-tests-for-a-3-world-fvp-setup
