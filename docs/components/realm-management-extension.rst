...
Building and running TF-A with TF-A Tests
********************************************
Use the following instructions to build and run TF-A with `TF-A Tests`_ as the
non-secure payload (BL33). TF-A Tests should boot and run the default tests
including RME tests.
...
secure, realm and non-secure. This section describes how to build and run TF-A
