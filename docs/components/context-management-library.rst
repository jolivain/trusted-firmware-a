...
In a trusted system at any instance, a given CPU would be executing in one of the
...
Note: ``FEAT_RAS`` is an exception here, as it impacts the execution of EL3 and 
