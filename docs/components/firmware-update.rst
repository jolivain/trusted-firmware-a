...
second stage Bootloader after FWU being done by update client and agent.
...
write updated FWU metadata in NV-storage. On subsequent reboot TF-A second stage
...
Second stage Bootloader (BL2) avoids upgrading the platform NV-counter until
