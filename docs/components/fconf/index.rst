...
To ensure a good interpretation of the properties, the documentation must
describe how the properties are described for a specific backend. Refer to the
:ref:`binding-document` section for example.
