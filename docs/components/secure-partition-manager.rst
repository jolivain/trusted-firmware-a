...
receiver scheduler component invokes FFA_NOTIFICATION_INFO_GET to the
information about which FF-A endpoints have pending notifications.
...
This FFA_NOTIFICATION_INFO_GET is used by the receiver scheduler to
...
reset when receiver called FFA_NOTIFICATION_GET to retrieved them.
