...
secure partitions. For this a VM (or Hypervisor or OS kernel), or SP invokes one of:

- the direct request message interface
- the FFA_RUN interface.

Platform topology
~~~~~~~~~~~~~~~~~

The FF-A v1.0 specification `[1]`_  recommends the following SP types:
...
- Pinned MP SPs: an execution context matches a physical PE. MP SPs must
  ...
  The *execution-ctx-count* can take the value of one or the total number of
  PEs.
