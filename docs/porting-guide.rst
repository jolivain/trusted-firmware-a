...
-  **NEED_ARM_ARCH_MAJOR and NEED_ARM_ARCH_MINOR**
  ...
  version will enabled by default and any optional Arch feature supported by
  Architecture and available in TF-A can be enabled from platform specific
