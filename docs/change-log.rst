...
- CPU Support
    - Neoverse N1
        ...
        - Reverted workaround for erratum 1800710
    - Cortex-A76
        - Added workaround for erratum 1791580
        - Added workaround for erratum 1800710
        - Added workaround for erratum 1868343
    - Cortex-A77
...
- BL-specific
    ...
    - BL31: Fix relocation error for PI
...
- FIPTool
    - Fixed command line parsing issues on Windows

- Measured Boot
    - Fixed MISRA-2012 C compliance issues
