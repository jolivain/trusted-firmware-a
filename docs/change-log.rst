...
- Tools
    - CertCreate
        - Added support for platform-owned secure partitions
        - Added support for SiP-owned secure partitions
...
- Build System
    - The top-level Makefile now supports build FipTool on Windows
...
- Tools
    - CertCreate
        - Extend Secure partition support for TBBR CoT
