...
- Architecture support
    - Added support for ``FEAT_SB`` for non-Armv8.5 platforms starting from Armv8.0
    - Added support for ``FEAT_AMUv1p1`` extensions
...
- Bootloader images
    ...
    - Enable TRNG service for BL32(sp_min)
...
- Libraries
    ...
    - CPU Errata
        ...
        - Arm Cortex N1: Added workaround for erratum 1946160
...
- Processes
    ...
    - Added MIT license to TF-A project
...
- Tools
    ...
    - CertCreate
        ...
        - Optimized the code to avoid unnecessary attepmts to create non-requested
          certificates
