...
Generally, TF-A code should be written in C and not in assembly language.
Assembly code is less portable, harder to understand, maintain and audit
security wise. Also, static analysis tools generally don't analyze assembly
code.

There are legitimate uses of assembly language. These include:
