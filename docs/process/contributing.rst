...
-  The patch submission rules are the following. For a patch to be approved
   ...
   author or a reviewer might agree to perform additional manually testing the
   patch in their review and the reviewer incorporates the review of the additional
