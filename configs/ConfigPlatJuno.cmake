...
group_add(NAME hw_plat TYPE INCLUDE KEY
          ${PROJECT_SOURCE_DIR}/plat/arm/board/juno/include)
...
group_add(
    ...
    DTS_TB_FW_CONFIG
    VAL
    ${PROJECT_SOURCE_DIR}/plat/arm/board/juno/fdts/juno_tb_fw_config.dts)
...
# Flag to enable support for TZMP1 on JUNO group_add(NAME hw_plat TYPE CONFIG
# DEFINE KEY JUNO_TZMP1 VAL 0) TODO: why is this checked with #ifdef instead of
# #if?
...
# -------------------------------------------------------------------------------
group_add(NAME hw_plat TYPE INCLUDE KEY
          ${PROJECT_SOURCE_DIR}/include/plat/arm/css/common/aarch64)
...
# Process CSS_NON_SECURE_UART flag This undocumented build option is only to
# enable debug access to the UART from non secure code, which is useful on some
# platforms. Default (obviously) is off.
group_add(
    NAME
    hw_plat
    TYPE
...
# revision <= r0p4 of the Cortex A53 cpu. Enabling this workaround could lead
# the linker to emit "*.stub" sections which are 4kB aligned.
group_add(
    NAME
    hw_plat
    TYPE
...
# of the Cortex A53 CPU, but this firmware workaround only works for revisions
# r0p3 and higher. Earlier revisions are taken care of by the rich OS.
group_add(
    NAME
    hw_plat
    TYPE
...
# r0p0 and r1p0 of the Neoverse N1 cpu.
group_add(
    NAME
    hw_plat
    TYPE
...
# revisions before r3p1 of the Neoverse N1 cpu.
group_add(
    NAME
    hw_plat
    TYPE
...
# revisions r3p0 - r4p0 of the Neoverse N1 cpu.
group_add(
    NAME
    hw_plat
    TYPE
