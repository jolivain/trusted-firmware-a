...
extern int create_guid_hob(struct efi_hob_handoff_info_table *hob_table,
		struct efi_guid *guid, uint16_t data_length, void **data);

extern int create_fv_hob(struct efi_hob_handoff_info_table *hob_table,
