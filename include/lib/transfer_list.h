 ...
 */
#define REGISTER_CONVENTION_VERSION_SHIFT_64	ULL(32)
#define REGISTER_CONVENTION_VERSION_SHIFT_32	ULL(24)
#define REGISTER_CONVENTION_VERSION_MASK	ULL(0xff)
#define REGISTER_CONVENTION_VERSION 	ULL(1)

#define TRANSFER_LIST_HANDOFF_X1_VALUE(__version) 						\
	((TRANSFER_LIST_SIGNATURE &																	\
		((1ULL << REGISTER_CONVENTION_VERSION_SHIFT_64) - 1)) | 	\
	 ((__version) << REGISTER_CONVENTION_VERSION_SHIFT_64))

#define TRANSFER_LIST_HANDOFF_R1_VALUE(__version) 						\
	((TRANSFER_LIST_SIGNATURE & 																\
		((1ULL << REGISTER_CONVENTION_VERSION_SHIFT_32) - 1)) | 	\
	 ((__version) << REGISTER_CONVENTION_VERSION_SHIFT_32))
