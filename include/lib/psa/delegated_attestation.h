 ...
 *    obtain the private part of the delegated attestation key. These are
 *    ECC keys belong to the PSA_ECC_FAMILY_SECP_R1 curves. The public part of
 *    key is computed by the cryptographic library when the key is registered.
