...
#ifndef __RSS_CRYPTO_DEFS_H__
#define __RSS_CRYPTO_DEFS_H__
...
/* Declares macros to build and analyze values of integral types defined in "crypto_types.h". */
#include "psa/crypto_values.h"
/* Definitions for size calculation macros whose definitions are implementation-specific. */
...
/*
 * This type is used to overcome a limitation in the number of maximum
 * IOVECs that can be used especially in psa_aead_encrypt and psa_aead_decrypt.
 */
...
struct rss_crypto_pack_iovec {
	...
	uint32_t op_handle;	/* Frontend context handle associated to a multipart operation */
	uint32_t capacity;	/* Key derivation capacity */
	uint32_t ad_length;	/* Additional Data length for multipart AEAD */
	uint32_t plaintext_length;	/* Plaintext length for multipart AEAD */
	struct rss_crypto_aead_pack_input aead_in;	/* Packs AEAD-related inputs */
	uint16_t function_id;	/* Used to identify the function in the API dispatcher to the service backend. See rss_crypto_func_sid for detail */
