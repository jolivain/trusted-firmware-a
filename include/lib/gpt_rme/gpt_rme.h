...
#define GPT_PAS_ATTR_GPI(_attrs) \
	(((_attrs) >> GPT_PAS_ATTR_GPI_SHIFT) & GPT_PAS_ATTR_GPI_MASK)
...
#define GPT_PAS_ATTR_MAP_TYPE(_attrs) \
	(((_attrs) >> GPT_PAS_ATTR_MAP_TYPE_SHIFT) & GPT_PAS_ATTR_MAP_TYPE_MASK)
...
#define GPT_PAS_ATTR(_type, _gpi)              \
	((((_type)&GPT_PAS_ATTR_MAP_TYPE_MASK) \
	 ...
	 (((_gpi)&GPT_PAS_ATTR_GPI_MASK) << GPT_PAS_ATTR_GPI_SHIFT))
