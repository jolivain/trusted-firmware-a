...
#define CTX_CNTHPS_CTL_EL2			(CTX_MTE_REGS_END + U(0x28))
#define CTX_CNTHPS_CVAL_EL2			(CTX_MTE_REGS_END + U(0x30))
#define CTX_CNTHPS_TVAL_EL2			(CTX_MTE_REGS_END + U(0x38))
#define CTX_CNTHP_CTL_EL2			(CTX_MTE_REGS_END + U(0x40))
#define CTX_CNTHP_CVAL_EL2			(CTX_MTE_REGS_END + U(0x48))
#define CTX_CNTHP_TVAL_EL2			(CTX_MTE_REGS_END + U(0x50))
#define CTX_CNTHVS_CTL_EL2			(CTX_MTE_REGS_END + U(0x58))
#define CTX_CNTHVS_CVAL_EL2			(CTX_MTE_REGS_END + U(0x60))
#define CTX_CNTHVS_TVAL_EL2			(CTX_MTE_REGS_END + U(0x68))
#define CTX_CNTHV_CTL_EL2			(CTX_MTE_REGS_END + U(0x70))
#define CTX_CNTHV_CVAL_EL2			(CTX_MTE_REGS_END + U(0x78))
#define CTX_CNTHV_TVAL_EL2			(CTX_MTE_REGS_END + U(0x80))
#define CTX_CNTPOFF_EL2				(CTX_MTE_REGS_END + U(0x88))
#define CTX_CNTVOFF_EL2				(CTX_MTE_REGS_END + U(0x90))
#define CTX_CONTEXTIDR_EL2			(CTX_MTE_REGS_END + U(0x98))
#define CTX_CPTR_EL2				(CTX_MTE_REGS_END + U(0xA0))
#define CTX_DACR32_EL2				(CTX_MTE_REGS_END + U(0xA8))
#define CTX_DBGVCR32_EL2			(CTX_MTE_REGS_END + U(0xB0))
#define CTX_ELR_EL2				(CTX_MTE_REGS_END + U(0xB8))
#define CTX_ESR_EL2				(CTX_MTE_REGS_END + U(0xC0))
#define CTX_FAR_EL2				(CTX_MTE_REGS_END + U(0xC8))
#define CTX_FPEXC32_EL2				(CTX_MTE_REGS_END + U(0xD0))
#define CTX_HACR_EL2				(CTX_MTE_REGS_END + U(0xD8))
#define CTX_HAFGRTR_EL2				(CTX_MTE_REGS_END + U(0xE0))
#define CTX_HCR_EL2				(CTX_MTE_REGS_END + U(0xE8))
#define CTX_HDFGRTR_EL2				(CTX_MTE_REGS_END + U(0xF0))
#define CTX_HDFGWTR_EL2				(CTX_MTE_REGS_END + U(0xF8))
#define CTX_HFGITR_EL2				(CTX_MTE_REGS_END + U(0x100))
#define CTX_HFGRTR_EL2				(CTX_MTE_REGS_END + U(0x108))
#define CTX_HFGWTR_EL2				(CTX_MTE_REGS_END + U(0x110))
#define CTX_HPFAR_EL2				(CTX_MTE_REGS_END + U(0x118))
#define CTX_HSTR_EL2				(CTX_MTE_REGS_END + U(0x120))
#define CTX_ICC_SRE_EL2				(CTX_MTE_REGS_END + U(0x128))
#define CTX_ICH_EISR_EL2			(CTX_MTE_REGS_END + U(0x130))
#define CTX_ICH_ELRSR_EL2			(CTX_MTE_REGS_END + U(0x138))
#define CTX_ICH_HCR_EL2				(CTX_MTE_REGS_END + U(0x140))
#define CTX_ICH_MISR_EL2			(CTX_MTE_REGS_END + U(0x148))
#define CTX_ICH_VMCR_EL2			(CTX_MTE_REGS_END + U(0x150))
#define CTX_ICH_VTR_EL2				(CTX_MTE_REGS_END + U(0x158))
#define CTX_IFSR32_EL2				(CTX_MTE_REGS_END + U(0x160))
#define CTX_MAIR_EL2				(CTX_MTE_REGS_END + U(0x168))
#define CTX_MDCR_EL2				(CTX_MTE_REGS_END + U(0x170))
#define CTX_MPAM2_EL2				(CTX_MTE_REGS_END + U(0x178))
#define CTX_MPAMHCR_EL2				(CTX_MTE_REGS_END + U(0x180))
#define CTX_MPAMVPM0_EL2			(CTX_MTE_REGS_END + U(0x188))
#define CTX_MPAMVPM1_EL2			(CTX_MTE_REGS_END + U(0x190))
#define CTX_MPAMVPM2_EL2			(CTX_MTE_REGS_END + U(0x198))
#define CTX_MPAMVPM3_EL2			(CTX_MTE_REGS_END + U(0x1A0))
#define CTX_MPAMVPM4_EL2			(CTX_MTE_REGS_END + U(0x1A8))
#define CTX_MPAMVPM5_EL2			(CTX_MTE_REGS_END + U(0x1B0))
#define CTX_MPAMVPM6_EL2			(CTX_MTE_REGS_END + U(0x1B8))
#define CTX_MPAMVPM7_EL2			(CTX_MTE_REGS_END + U(0x1C0))
#define CTX_MPAMVPMV_EL2			(CTX_MTE_REGS_END + U(0x1C8))
#define CTX_PMSCR_EL2				(CTX_MTE_REGS_END + U(0x1D0))
#define CTX_RMR_EL2				(CTX_MTE_REGS_END + U(0x1D8))
#define CTX_RVBAR_EL2				(CTX_MTE_REGS_END + U(0x1E0))
#define CTX_SCTLR_EL2				(CTX_MTE_REGS_END + U(0x1E8))
#define CTX_SCXTNUM_EL2				(CTX_MTE_REGS_END + U(0x1F0))
#define CTX_SDER32_EL2				(CTX_MTE_REGS_END + U(0x1F8))
#define CTX_SPSR_EL2				(CTX_MTE_REGS_END + U(0x200))
#define CTX_SP_EL2				(CTX_MTE_REGS_END + U(0x208))
#define CTX_TCR_EL2				(CTX_MTE_REGS_END + U(0x210))
#define CTX_TFSR_EL2				(CTX_MTE_REGS_END + U(0x218))
#define CTX_TPIDR_EL2				(CTX_MTE_REGS_END + U(0x220))
#define CTX_TRFCR_EL2				(CTX_MTE_REGS_END + U(0x228))
#define CTX_TTBR0_EL2				(CTX_MTE_REGS_END + U(0x230))
#define CTX_TTBR1_EL2				(CTX_MTE_REGS_END + U(0x238))
#define CTX_VBAR_EL2				(CTX_MTE_REGS_END + U(0x240))
#define CTX_VDISR_EL2				(CTX_MTE_REGS_END + U(0x248))
#define CTX_VMPIDR_EL2				(CTX_MTE_REGS_END + U(0x250))
#define CTX_VNCR_EL2				(CTX_MTE_REGS_END + U(0x258))
#define CTX_VPIDR_EL2				(CTX_MTE_REGS_END + U(0x260))
#define CTX_VSESR_EL2				(CTX_MTE_REGS_END + U(0x268))
#define CTX_VSTCR_EL2				(CTX_MTE_REGS_END + U(0x270))
#define CTX_VSTTBR_EL2				(CTX_MTE_REGS_END + U(0x278))
#define CTX_VTCR_EL2				(CTX_MTE_REGS_END + U(0x280))
#define CTX_VTTBR_EL2				(CTX_MTE_REGS_END + U(0x288))
#define CTX_ZCR_EL2				(CTX_MTE_REGS_END + U(0x290))

/* Align to the next 16 byte boundary */
#define CTX_EL2_REGS_END			(CTX_MTE_REGS_END + U(0x2A0))
#else
