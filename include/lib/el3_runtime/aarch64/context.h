...
#define write_el2_ctx_mte(ctx, reg, val)	ULL(0)
#endif /* ENABLE_FEAT_MTE */
...
#define write_el2_ctx_fgt(ctx, reg, val)	ULL(0)
...
#define write_el2_ctx_ecv(ctx, reg, val)	ULL(0)
...
#define write_el2_ctx_vhe(ctx, reg, val)	ULL(0)
...
#define write_el2_ctx_ras(ctx, reg, val)	ULL(0)
...
#define write_el2_ctx_neve(ctx, reg, val)	ULL(0)
...
#define write_el2_ctx_trf(ctx, reg, val)	ULL(0)
...
#define write_el2_ctx_csv2_2(ctx, reg, val)	ULL(0)
...
#define write_el2_ctx_hcx(ctx, reg, val)	ULL(0)
...
#define write_el2_ctx_tcr2(ctx, reg, val)	((((ctx)->tcr2).reg)	\
							= (uint64_t) (val))
#else
#define read_el2_ctx_tcr(ctx, reg)		ULL(0)
#define write_el2_ctx_tcr(ctx, reg, val)	ULL(0)
...
#define write_el2_ctx_sxpoe(ctx, reg, val)	ULL(0)
...
#define write_el2_ctx_sxpie(ctx, reg, val)	ULL(0)
...
#define write_el2_ctx_s2pie(ctx, reg, val)	ULL(0)
...
#define write_el2_ctx_gcs(ctx, reg, val)	ULL(0)
