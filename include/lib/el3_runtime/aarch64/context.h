...
#define CTX_MPAM3_EL3		U(0x40)
/* Constants required in supporting nested exception in EL3 */
#define CTX_SAVED_ELR_EL3	U(0x48)
/*
 ...
 */
#define CTX_NESTED_EA_FLAG	U(0x50)
#if HANDLE_EA_EL3_FIRST_NS
 #define CTX_SAVED_ESR_EL3	U(0x58)
 #define CTX_SAVED_SPSR_EL3	U(0x60)
 #define CTX_SAVED_GPREG_LR	U(0x68)
