...
#define CTX_TTBR0_EL2				(CTX_MTE_REGS_END + U(0x0))
#define CTX_VSTTBR_EL2				(CTX_MTE_REGS_END + U(0x8))
#define CTX_AFSR0_EL2				(CTX_MTE_REGS_END + U(0x10))
#define CTX_AFSR1_EL2				(CTX_MTE_REGS_END + U(0x18))
#define CTX_AMAIR_EL2				(CTX_MTE_REGS_END + U(0x20))
#define CTX_CNTHCTL_EL2				(CTX_MTE_REGS_END + U(0x28))
#define CTX_CNTHPS_CTL_EL2			(CTX_MTE_REGS_END + U(0x30))
#define CTX_CNTHPS_CVAL_EL2			(CTX_MTE_REGS_END + U(0x38))
#define CTX_CNTHPS_TVAL_EL2			(CTX_MTE_REGS_END + U(0x40))
#define CTX_CNTHP_CTL_EL2			(CTX_MTE_REGS_END + U(0x48))
#define CTX_CNTHP_CVAL_EL2			(CTX_MTE_REGS_END + U(0x50))
#define CTX_CNTHP_TVAL_EL2			(CTX_MTE_REGS_END + U(0x58))
#define CTX_CNTHVS_CTL_EL2			(CTX_MTE_REGS_END + U(0x60))
#define CTX_CNTHVS_CVAL_EL2			(CTX_MTE_REGS_END + U(0x68))
#define CTX_CNTHVS_TVAL_EL2			(CTX_MTE_REGS_END + U(0x70))
#define CTX_CNTHV_CTL_EL2			(CTX_MTE_REGS_END + U(0x78))
#define CTX_CNTHV_CVAL_EL2			(CTX_MTE_REGS_END + U(0x80))
#define CTX_CNTHV_TVAL_EL2			(CTX_MTE_REGS_END + U(0x88))
...
#define CTX_DBGVCR32_EL2			(CTX_MTE_REGS_END + U(0xa8))
#define CTX_ELR_EL2				(CTX_MTE_REGS_END + U(0xb0))
#define CTX_ESR_EL2				(CTX_MTE_REGS_END + U(0xb8))
#define CTX_ICC_SRE_EL2				(CTX_MTE_REGS_END + U(0xc0))
#define CTX_HCR_EL2				(CTX_MTE_REGS_END + U(0xc8))
...
#define CTX_ICH_MISR_EL2			(CTX_MTE_REGS_END + U(0xf8))
#define CTX_ICH_VMCR_EL2			(CTX_MTE_REGS_END + U(0x100))
#define CTX_ICH_VTR_EL2				(CTX_MTE_REGS_END + U(0x108))
#define CTX_MAIR_EL2				(CTX_MTE_REGS_END + U(0x110))
#define CTX_MDCR_EL2				(CTX_MTE_REGS_END + U(0x118))
#define CTX_RMR_EL2				(CTX_MTE_REGS_END + U(0x120))
#define CTX_SCTLR_EL2				(CTX_MTE_REGS_END + U(0x128))
#define CTX_SCXTNUM_EL2				(CTX_MTE_REGS_END + U(0x130))
#define CTX_SPSR_EL2				(CTX_MTE_REGS_END + U(0x138))
#define CTX_SP_EL2				(CTX_MTE_REGS_END + U(0x140))
#define CTX_TCR_EL2				(CTX_MTE_REGS_END + U(0x148))
#define CTX_TPIDR_EL2				(CTX_MTE_REGS_END + U(0x150))
#define CTX_TTBR1_EL2				(CTX_MTE_REGS_END + U(0x160))
#define CTX_VBAR_EL2				(CTX_MTE_REGS_END + U(0x168))
#define CTX_VDISR_EL2				(CTX_MTE_REGS_END + U(0x170))
#define CTX_VMPIDR_EL2				(CTX_MTE_REGS_END + U(0x178))
#define CTX_VNCR_EL2				(CTX_MTE_REGS_END + U(0x180))
#define CTX_VPIDR_EL2				(CTX_MTE_REGS_END + U(0x188))
#define CTX_VSESR_EL2				(CTX_MTE_REGS_END + U(0x190))
#define CTX_VSTCR_EL2				(CTX_MTE_REGS_END + U(0x198))
#define CTX_ACTLR_EL2				(CTX_MTE_REGS_END + U(0x1a0))
#define CTX_VTCR_EL2				(CTX_MTE_REGS_END + U(0x1a8))
#define CTX_VTTBR_EL2				(CTX_MTE_REGS_END + U(0x1b0))
#define CTX_ZCR_EL2				(CTX_MTE_REGS_END + U(0x1b8))
