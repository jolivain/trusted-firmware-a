...
/* FEAT_TRF */
#define CTX_TRFCR_EL2		CTX_OFFSET(ENABLE_FEAT_TRF, (CTX_NEVE_REGS_END + U(0x0)))
#define CTX_TRF_REGS_END	CTX_NEVE_REGS_END + CTX_OFFSET(ENABLE_FEAT_TRF, U(0x10)) /* Align to the next 16 byte boundary */
