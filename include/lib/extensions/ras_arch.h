...
#define ERR_STATUS_GET_FIELD(_status, _field)         \
	(((_status) >> ERR_STATUS_##_field##_SHIFT) & \
	 ERR_STATUS_##_field##_MASK)

#define ERR_STATUS_CLR_FIELD(_status, _field) \
	(_status) &=                          \
		~(ERR_STATUS_##_field##_MASK << ERR_STATUS_##_field##_SHIFT)

#define ERR_STATUS_SET_FIELD(_status, _field, _value)       \
	(_status) |= (((_value)&ERR_STATUS_##_field##_MASK) \
		      << ERR_STATUS_##_field##_SHIFT)

#define ERR_STATUS_WRITE_FIELD(_status, _field, _value)        \
	do {                                                   \
...
#define ERR_CTLR_SET_FIELD(_ctlr, _field, _value)       \
	(_ctlr) |= (((_value)&ERR_CTLR_##_field##_MASK) \
		    << ERR_CTLR_##_field##_SHIFT)
