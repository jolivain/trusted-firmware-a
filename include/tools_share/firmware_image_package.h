...
#define UUID_CCA_CONTENT_CERT                                               \
	{                                                                   \
		{ 0x36, 0xd8, 0x3d, 0x85 }, { 0x76, 0x1d }, { 0x4d, 0xaf }, \
			0x96, 0xf1,                                         \
		{                                                           \
			0xcd, 0x99, 0xd6, 0x56, 0x9b, 0x00                  \
		}                                                           \
	}
#define UUID_CORE_SWD_KEY_CERT                                              \
	{                                                                   \
		{ 0x52, 0x22, 0x2d, 0x31 }, { 0x82, 0x0f }, { 0x49, 0x4d }, \
			0x8b, 0xbc,                                         \
		{                                                           \
			0xea, 0x68, 0x25, 0xd3, 0xc3, 0x5a                  \
		}                                                           \
	}
#define UUID_PLAT_KEY_CERT                                                  \
	{                                                                   \
		{ 0xd4, 0x3c, 0xd9, 0x02 }, { 0x5b, 0x9f }, { 0x41, 0x2e }, \
			0x8a, 0xc6,                                         \
		{                                                           \
			0x92, 0xb6, 0xd1, 0x8b, 0xe6, 0x0d                  \
		}                                                           \
	}
...
#define UUID_NON_TRUSTED_WORLD_KEY_CERT                                     \
	{                                                                   \
		{ 0x1c, 0x67, 0x87, 0x3d }, { 0x5f, 0x63 }, { 0xe4, 0x11 }, \
			0x97, 0x8d,                                         \
		{                                                           \
