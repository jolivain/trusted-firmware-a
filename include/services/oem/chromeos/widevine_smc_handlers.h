...
/* Sets the device unique identifier. The maximum size is 32 bytes.
 * |x1| is the length of the data, |x2| is the physical address of the data.
 */
#define CROS_OEM_SMC_DRM_SET_DEVICE_ID_FUNC_ID \
	CROS_OEM_SMC_CALL_ID(CROS_DRM_SET_DEVICE_ID)

/* Sets the widevine root of trust certificate chain. The maximum size is 1024
 * bytes.
 * |x1| is the length of the data, |x2| is the physical address of the data.
 */
...
/* Sets the widevine TA key. The maximum size is 32 bytes.
 * |x1| is the length of the data, |x2| is the physical address of the data.
 */
...
extern struct cros_oem_data cros_oem_widevine_dice;

extern struct cros_oem_data cros_oem_widevine_ta_key;
