...
CASSERT(offsetof(struct dram_bank, base) == 0UL,
			rmm_manifest_base_unaligned);
CASSERT(offsetof(struct dram_bank, size) == 8UL,
...
CASSERT(offsetof(struct dram_info, num_banks) == 0UL,
			rmm_manifest_num_banks_unaligned);
CASSERT(offsetof(struct dram_info, banks) == 8UL,
			rmm_manifest_dram_data_unaligned);
CASSERT(offsetof(struct dram_info, checksum) == 16UL,
