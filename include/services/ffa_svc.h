...
#define FFA_MSG_SEND_ATTRS(blk) \
	(((blk)&FFA_MSG_SEND_ATTRS_BLK_MASK) << FFA_MSG_SEND_ATTRS_BLK_SHIFT)
...
#define FFA_FID(smc_cc, func_num)                                              \
	((SMC_TYPE_FAST << FUNCID_TYPE_SHIFT) |                                \
	 ((smc_cc) << FUNCID_CC_SHIFT) | (OEN_STD_START << FUNCID_OEN_SHIFT) | \
...
#define FFA_MEM_RETRIEVE_REQ_SMC32 FFA_FID(SMC_32, FFA_FNUM_MEM_RETRIEVE_REQ)
...
#define FFA_MEM_RETRIEVE_REQ_SMC64 FFA_FID(SMC_64, FFA_FNUM_MEM_RETRIEVE_REQ)
...
#define FFA_BOOT_INFO_TYPE(type) \
	(((type)&FFA_BOOT_INFO_TYPE_MASK) << FFA_BOOT_INFO_TYPE_SHIFT)
...
#define FFA_BOOT_INFO_TYPE_ID(type) \
	(((type)&FFA_BOOT_INFO_TYPE_ID_MASK) << FFA_BOOT_INFO_TYPE_ID_SHIFT)
...
#define FFA_BOOT_INFO_FLAG_NAME(type) \
	(((type)&FFA_BOOT_INFO_FLAG_NAME_MASK) << FFA_BOOT_INFO_FLAG_NAME_SHIFT)
