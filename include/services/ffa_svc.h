...
#define FFA_BOOT_INFO_TYPE_FDT			U(0x0)
#define FFA_BOOT_INFO_TYPE_HOB			U(0x1)

#define FFA_BOOT_INFO_TYPE_IDEN_MASK		U(0x3F)
#define FFA_BOOT_INFO_TYPE_IDEN_SHIFT		U(0x0)
#define FFA_BOOT_INFO_TYPE_IDEN(type)		\
	(((type) & FFA_BOOT_INFO_TYPE_IDEN_MASK)\
	<< FFA_BOOT_INFO_TYPE_IDEN_SHIFT)
