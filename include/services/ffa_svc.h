...
#define FFA_NOTIFICATION_INFO_GET_SMC32 \
 ...
 * FF-A features IDs.
 */
#define FFA_FEAT_NOTIFICATION_PENDING_INT	U(0x1)
#define FFA_FEAT_SCHED_RECEIVER_INT	U(0x2)
#define FFA_FEAT_MANAGED_EXIT_INT	U(0x3)
