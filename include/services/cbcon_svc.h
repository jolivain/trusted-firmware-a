...
#define CBCON_FNUM_VERSION	U(0x190)
#define CBCON_FNUM_FEATURES	U(0x191)
#define CBCON_FNUM_GET_ADDR	U(0x192)

#define ARM_CBCON_VERSION	CBCON_FID(CBCON_FNUM_VERSION)
#define ARM_CBCON_FEATURES	CBCON_FID(CBCON_FNUM_FEATURES)
#define ARM_CBCON_GET_ADDR	CBCON_FID(CBCON_FNUM_GET_ADDR)

/* CBCON version numbers */
#define CBCON_VERSION_MAJOR	(0x1)
#define CBCON_VERSION_MINOR	(0x0)

/* CBCON Error Numbers */
#define CBCON_E_SUCCESS		(0)
#define CBCON_E_NOT_IMPLEMENTED	(-1)
#define CBCON_E_NOT_SUPPORTED	(-2)

/* Public API to perform the initial CBCON entropy setup */
void cbcon_setup(void);
