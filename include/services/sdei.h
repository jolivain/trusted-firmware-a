...
#define SDEI_EVENT_MAP(_event, _intr, _flags)                              \
	{                                                                  \
		.ev_num = (_event), .intr = (_intr), .map_flags = (_flags) \
	}
...
#define SDEI_EXPLICIT_EVENT(_event, _pri) \
	SDEI_EVENT_MAP((_event), 0,       \
		       (_pri) | SDEI_MAPF_EXPLICIT | SDEI_MAPF_PRIVATE)
