 ...
 */
#define RMM_FNUM_BOOT_COMPLETE		(RMMD_EL3_FNUM_MAX_VALUE - \
					 RMMD_EL3_FNUM_MIN_VALUE)
#define RMM_BOOT_COMPLETE		SMC64_RMMD_EL3_FID(RMM_FNUM_BOOT_COMPLETE)
...
#define RMM_BOOT_INTERFACE_VERSION				\
	(((RMM_BOOT_INTERFACE_VERSION_MAJOR << 16) & 0x7FFFF) |	\
