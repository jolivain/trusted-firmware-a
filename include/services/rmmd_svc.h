...
#define E_RMM_BOOT_MANIFEST_DATA_ERROR			(-6)
#define E_RMM_BOOT_UNKNOWN				(-7)
 ...
 *
 * RMMD_RMI_BOOT_COMPLETE FID is located at the end of the available range.
 */
#define RMI_FNUM_BOOT_COMPLETE		(RMMD_EL3_FNUM_MAX_VALUE - \
					 RMMD_EL3_FNUM_MIN_VALUE)
#define RMMD_RMI_BOOT_COMPLETE		SMC64_RMMD_EL3_FID(RMI_FNUM_BOOT_COMPLETE)
