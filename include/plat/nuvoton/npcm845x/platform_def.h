...
#define ARM_SHARED_RAM_BASE			(BL31_BASE + 0x00020000 - ARM_SHARED_RAM_SIZE) /* UL(0xfffCE000) add calc ARM_TRUSTED_SRAM_BASE */
...
/* The following section is used for HW validation of TrustZone */
#ifdef NPCM845X_DEBUG
/* Non-Secured SRAM */
...
#else
# define PLAT_ARM_MAX_BL2_SIZE	0 /* (UL(0x13000) - FVP_BL2_ROMLIB_OPTIMIZATION) */
