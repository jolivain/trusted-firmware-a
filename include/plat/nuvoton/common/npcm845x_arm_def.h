...
/* Hook to run "SRAM" on "DDR" for testing */
#ifdef NPCM845X_DEBUG
#define ARM_TRUSTED_SRAM_BASE		UL(0xfffb0000)
#define ARM_SHARED_RAM_BASE			UL(0xfffCE000) /* add calc ARM_TRUSTED_SRAM_BASE */
 ...
 * placed here.
 ...
 NPCM845x - Currently the platform doesn't have EL3 implementation on secured DRAM.
 */
...
/* In order to be able to debug, the platform needs to add BL33 and BL32 to MMU as well. */
 ...
 * for each section, otherwise one region containing both sections is defined.
 */
