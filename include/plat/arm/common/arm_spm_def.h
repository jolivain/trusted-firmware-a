...
#define ARM_SP_IMAGE_MMAP                                     \
	MAP_REGION_FLAT(ARM_SP_IMAGE_BASE, ARM_SP_IMAGE_SIZE, \
...
#define ARM_SP_IMAGE_MMAP                                                    \
	MAP_REGION2(ARM_SP_IMAGE_BASE, ARM_SP_IMAGE_BASE, ARM_SP_IMAGE_SIZE, \
...
#define ARM_SP_IMAGE_NS_BUF_MMAP                                             \
...
#define ARM_SP_IMAGE_STACK_TOTAL_SIZE \
	(PLATFORM_CORE_COUNT * PLAT_SP_IMAGE_STACK_PCPU_SIZE)

#define ARM_SP_IMAGE_HEAP_BASE \
	(PLAT_SP_IMAGE_STACK_BASE + ARM_SP_IMAGE_STACK_TOTAL_SIZE)
...
#define ARM_SP_IMAGE_RW_MMAP                                            \
	MAP_REGION2(PLAT_SP_IMAGE_STACK_BASE, PLAT_SP_IMAGE_STACK_BASE, \
		    (ARM_SP_IMAGE_LIMIT - PLAT_SP_IMAGE_STACK_BASE),    \
