...
#define ARM_REALM_SIZE (UL(0x02000000) - ARM_EL3_RMM_SHARED_SIZE)
...
#define ARM_SCP_TZC_DRAM1_BASE             \
	(ARM_DRAM1_BASE + ARM_DRAM1_SIZE - \
	 (ARM_SCP_TZC_DRAM1_SIZE + ARM_L1_GPT_SIZE))
#define ARM_SCP_TZC_DRAM1_SIZE PLAT_ARM_SCP_TZC_DRAM1_SIZE
#define ARM_SCP_TZC_DRAM1_END \
	(ARM_SCP_TZC_DRAM1_BASE + ARM_SCP_TZC_DRAM1_SIZE - 1U)
#if ENABLE_RME
#define ARM_L1_GPT_ADDR_BASE (ARM_DRAM1_BASE + ARM_DRAM1_SIZE - ARM_L1_GPT_SIZE)
#define ARM_L1_GPT_END (ARM_L1_GPT_ADDR_BASE + ARM_L1_GPT_SIZE - 1U)

#define ARM_REALM_BASE (ARM_EL3_RMM_SHARED_BASE - ARM_REALM_SIZE)

#define ARM_REALM_END (ARM_REALM_BASE + ARM_REALM_SIZE - 1U)

#define ARM_EL3_RMM_SHARED_BASE                                                \
	(ARM_DRAM1_BASE + ARM_DRAM1_SIZE -                                     \
	 (ARM_SCP_TZC_DRAM1_SIZE + ARM_L1_GPT_SIZE + ARM_EL3_RMM_SHARED_SIZE + \
	  ARM_EL3_TZC_DRAM1_SIZE))

#define ARM_EL3_RMM_SHARED_END \
	(ARM_EL3_RMM_SHARED_BASE + ARM_EL3_RMM_SHARED_SIZE - 1U)
#endif /* ENABLE_RME */

#define ARM_EL3_TZC_DRAM1_BASE (ARM_SCP_TZC_DRAM1_BASE - ARM_EL3_TZC_DRAM1_SIZE)
#define ARM_EL3_TZC_DRAM1_END \
	(ARM_EL3_TZC_DRAM1_BASE + ARM_EL3_TZC_DRAM1_SIZE - 1U)

#define ARM_AP_TZC_DRAM1_BASE \
	(ARM_DRAM1_BASE + ARM_DRAM1_SIZE - ARM_TZC_DRAM1_SIZE)
#define ARM_AP_TZC_DRAM1_SIZE                               \
	(ARM_TZC_DRAM1_SIZE -                               \
	 (ARM_SCP_TZC_DRAM1_SIZE + ARM_EL3_TZC_DRAM1_SIZE + \
	  ARM_EL3_RMM_SHARED_SIZE + ARM_REALM_SIZE + ARM_L1_GPT_SIZE))
#define ARM_AP_TZC_DRAM1_END \
	(ARM_AP_TZC_DRAM1_BASE + ARM_AP_TZC_DRAM1_SIZE - 1U)
...
#define ARM_OPTEE_PAGEABLE_LOAD_MEM                   \
	MAP_REGION_FLAT(ARM_OPTEE_PAGEABLE_LOAD_BASE, \
			ARM_OPTEE_PAGEABLE_LOAD_SIZE, \
 ...
 * support is enabled).
 */
#define ARM_MAP_OPTEE_CORE_MEM                             \
	MAP_REGION_FLAT(BL32_BASE, BL32_LIMIT - BL32_BASE, \
			MT_MEMORY | MT_RW | MT_SECURE)
#endif /* SPD_opteed */

#define ARM_NS_DRAM1_BASE ARM_DRAM1_BASE
#define ARM_NS_DRAM1_SIZE (ARM_DRAM1_SIZE - ARM_TZC_DRAM1_SIZE)

#define ARM_NS_DRAM1_END (ARM_NS_DRAM1_BASE + ARM_NS_DRAM1_SIZE - 1U)
...
#define ARM_MAP_SHARED_RAM                                        \
	MAP_REGION_FLAT(ARM_SHARED_RAM_BASE, ARM_SHARED_RAM_SIZE, \
			MT_DEVICE | MT_RW | EL3_PAS)

#define ARM_MAP_NS_DRAM1                                      \
	MAP_REGION_FLAT(ARM_NS_DRAM1_BASE, ARM_NS_DRAM1_SIZE, \
			MT_MEMORY | MT_RW | MT_NS)

#define ARM_MAP_DRAM2                                   \
	MAP_REGION_FLAT(ARM_DRAM2_BASE, ARM_DRAM2_SIZE, \
			MT_MEMORY | MT_RW | MT_NS)

#define ARM_MAP_TSP_SEC_MEM                                 \
	MAP_REGION_FLAT(TSP_SEC_MEM_BASE, TSP_SEC_MEM_SIZE, \
			MT_MEMORY | MT_RW | MT_SECURE)

#if ARM_BL31_IN_DRAM
#define ARM_MAP_BL31_SEC_DRAM                              \
	MAP_REGION_FLAT(BL31_BASE, PLAT_ARM_MAX_BL31_SIZE, \
			MT_MEMORY | MT_RW | MT_SECURE)
#endif

#define ARM_MAP_EL3_TZC_DRAM                                            \
	MAP_REGION_FLAT(ARM_EL3_TZC_DRAM1_BASE, ARM_EL3_TZC_DRAM1_SIZE, \
			MT_MEMORY | MT_RW | EL3_PAS)

#define ARM_MAP_TRUSTED_DRAM                        \
	MAP_REGION_FLAT(PLAT_ARM_TRUSTED_DRAM_BASE, \
 ...
 */
#define ARM_MAP_RMM_DRAM                                               \
	MAP_REGION_FLAT(PLAT_ARM_RMM_BASE,                             \
			(PLAT_ARM_RMM_SIZE + ARM_EL3_RMM_SHARED_SIZE), \
			MT_MEMORY | MT_RW | MT_REALM)

#define ARM_MAP_GPT_L1_DRAM                                    \
	MAP_REGION_FLAT(ARM_L1_GPT_ADDR_BASE, ARM_L1_GPT_SIZE, \
			MT_MEMORY | MT_RW | EL3_PAS)

#define ARM_MAP_EL3_RMM_SHARED_MEM                                        \
	MAP_REGION_FLAT(ARM_EL3_RMM_SHARED_BASE, ARM_EL3_RMM_SHARED_SIZE, \
			MT_MEMORY | MT_RW | MT_REALM)
...
#endif
#if USE_ROMLIB
#define ARM_MAP_ROMLIB_CODE                                               \
	MAP_REGION_FLAT(ROMLIB_RO_BASE, ROMLIB_RO_LIMIT - ROMLIB_RO_BASE, \
			MT_CODE | EL3_PAS)

#define ARM_MAP_ROMLIB_DATA                                             \
	MAP_REGION_FLAT(ROMLIB_RW_BASE, ROMLIB_RW_END - ROMLIB_RW_BASE, \
			MT_MEMORY | MT_RW | EL3_PAS)
#endif
 ...
 */
#define ARM_V2M_MAP_MEM_PROTECT                                       \
	MAP_REGION_FLAT(PLAT_ARM_MEM_PROT_ADDR, V2M_FLASH_BLOCK_SIZE, \
			MT_DEVICE | MT_RW | MT_SECURE)
/*
 * Map the region for device tree configuration with read and write permissions
 */
#define ARM_MAP_BL_CONFIG_REGION                                  \
	MAP_REGION_FLAT(ARM_BL_RAM_BASE,                          \
...
#define ARM_MAP_L0_GPT_REGION                                  \
	MAP_REGION_FLAT(ARM_L0_GPT_ADDR_BASE, ARM_L0_GPT_SIZE, \
...
#define ARM_TWDG_LOAD_VAL (ARM_SP805_TWDG_CLK_HZ * ARM_TWDG_TIMEOUT_SEC)
...
#define ARM_FW_CONFIG_LIMIT ((ARM_BL_RAM_BASE + PAGE_SIZE) + (PAGE_SIZE / 2U))
 ...
 */
#define BL1_RW_BASE                          \
	(ARM_BL_RAM_BASE + ARM_BL_RAM_SIZE - \
	 (PLAT_ARM_MAX_BL1_RW_SIZE + PLAT_ARM_MAX_ROMLIB_RW_SIZE))
#define BL1_RW_LIMIT \
	(ARM_BL_RAM_BASE + (ARM_BL_RAM_SIZE - PLAT_ARM_MAX_ROMLIB_RW_SIZE))
 ...
 */
#define BL2_BASE \
	(ARM_TRUSTED_SRAM_BASE + (PLAT_ARM_TRUSTED_SRAM_SIZE >> 1) + 0x3000)
#else
/* Put BL2 towards the middle of the Trusted SRAM */
#define BL2_BASE \
	(ARM_TRUSTED_SRAM_BASE + (PLAT_ARM_TRUSTED_SRAM_SIZE >> 1) + 0x2000)
#endif /* ENABLE_PIE */
...
#define BL31_LIMIT (ARM_AP_TZC_DRAM1_BASE + PLAT_ARM_MAX_BL31_SIZE)
/*
...
#define BL31_BASE ((ARM_BL_RAM_BASE + ARM_BL_RAM_SIZE) - PLAT_ARM_MAX_BL31_SIZE)
...
#define BL32_BASE ((ARM_BL_RAM_BASE + ARM_BL_RAM_SIZE) - PLAT_ARM_MAX_BL32_SIZE)
...
#define BL32_LIMIT (ARM_AP_TZC_DRAM1_BASE + ARM_AP_TZC_DRAM1_SIZE)
#elif defined(SPD_spmd)
#define TSP_SEC_MEM_BASE (ARM_AP_TZC_DRAM1_BASE + ULL(0x200000))
#define TSP_SEC_MEM_SIZE (ARM_AP_TZC_DRAM1_SIZE - ULL(0x200000))
#define BL32_BASE PLAT_ARM_SPMC_BASE
#define BL32_LIMIT (PLAT_ARM_SPMC_BASE + PLAT_ARM_SPMC_SIZE)
#elif ARM_BL31_IN_DRAM
#define TSP_SEC_MEM_BASE (ARM_AP_TZC_DRAM1_BASE + PLAT_ARM_MAX_BL31_SIZE)
#define TSP_SEC_MEM_SIZE (ARM_AP_TZC_DRAM1_SIZE - PLAT_ARM_MAX_BL31_SIZE)
#define BL32_BASE (ARM_AP_TZC_DRAM1_BASE + PLAT_ARM_MAX_BL31_SIZE)
#define BL32_LIMIT (ARM_AP_TZC_DRAM1_BASE + ARM_AP_TZC_DRAM1_SIZE)
...
#define BL32_LIMIT (PLAT_ARM_TRUSTED_DRAM_BASE + (UL(1) << 21))
...
#define ARM_SDEI_PRIVATE_EVENTS                                       \
	SDEI_DEFINE_EVENT_0(ARM_SDEI_SGI),                            \
		SDEI_PRIVATE_EVENT(ARM_SDEI_DP_EVENT_0, SDEI_DYN_IRQ, \
				   SDEI_MAPF_DYNAMIC),                \
		SDEI_PRIVATE_EVENT(ARM_SDEI_DP_EVENT_1, SDEI_DYN_IRQ, \
				   SDEI_MAPF_DYNAMIC),                \
		SDEI_PRIVATE_EVENT(ARM_SDEI_DP_EVENT_2, SDEI_DYN_IRQ, \
				   SDEI_MAPF_DYNAMIC)

#define ARM_SDEI_SHARED_EVENTS                                       \
	SDEI_SHARED_EVENT(ARM_SDEI_DS_EVENT_0, SDEI_DYN_IRQ,         \
			  SDEI_MAPF_DYNAMIC),                        \
		SDEI_SHARED_EVENT(ARM_SDEI_DS_EVENT_1, SDEI_DYN_IRQ, \
				  SDEI_MAPF_DYNAMIC),                \
		SDEI_SHARED_EVENT(ARM_SDEI_DS_EVENT_2, SDEI_DYN_IRQ, \
				  SDEI_MAPF_DYNAMIC)
#endif /* SDEI_IN_FCONF */
