		...
		PLAT_SP_IMAGE_NS_BUF_BASE,                                 \
			(PLAT_SP_IMAGE_NS_BUF_BASE +                       \
			 PLAT_SP_IMAGE_NS_BUF_SIZE) -                      \
				1,                                         \
			TZC_REGION_S_NONE, PLAT_ARM_TZC_NS_DEV_ACCESS      \
	}

#elif ENABLE_RME
#define ARM_TZC_REGIONS_DEF                                                                    \
	{ ARM_AP_TZC_DRAM1_BASE, ARM_AP_TZC_DRAM1_END, TZC_REGION_S_RDWR, 0 },                 \
		{ ARM_EL3_TZC_DRAM1_BASE, ARM_L1_GPT_END, TZC_REGION_S_RDWR,                   \
		  0 },                                                                         \
		{ ARM_NS_DRAM1_BASE, ARM_NS_DRAM1_END,                                         \
		  ARM_TZC_NS_DRAM_S_ACCESS,                                                    \
		  PLAT_ARM_TZC_NS_DEV_ACCESS }, /* Realm and Shared area share the same PAS */ \
...
#define ARM_CASSERT_MMAP                                                      \
	...
	CASSERT((PLAT_ARM_MMAP_ENTRIES + ARM_BL_REGIONS) <= MAX_MMAP_REGIONS, \
...
#define arm_make_pwrstate_lvl2(lvl2_state, lvl1_state, lvl0_state, pwr_lvl, \
			       type)                                        \
