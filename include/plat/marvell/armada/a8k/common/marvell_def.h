...
#define MARVELL_BL_RAM_BASE (MARVELL_SHARED_RAM_BASE + MARVELL_SHARED_RAM_SIZE)
#define MARVELL_BL_RAM_SIZE \
	(MARVELL_TRUSTED_DRAM_SIZE - MARVELL_SHARED_RAM_SIZE)
/* Non-shared DRAM */
#define MARVELL_DRAM_BASE ULL(0x0)
#define MARVELL_DRAM_SIZE ULL(0x80000000)
#define MARVELL_DRAM_END (MARVELL_DRAM_BASE + MARVELL_DRAM_SIZE - 1)
 ...
 * support is enabled).
 */
#define MARVELL_MAP_OPTEE_CORE_MEM                         \
	MAP_REGION_FLAT(BL32_BASE, BL32_LIMIT - BL32_BASE, \
			MT_MEMORY | MT_RW | MT_SECURE)
#endif /* SPD_opteed */

#define MARVELL_MAP_SECURE_RAM                                            \
	MAP_REGION_FLAT(MARVELL_SHARED_RAM_BASE, MARVELL_SHARED_RAM_SIZE, \
			MT_MEMORY | MT_RW | MT_SECURE)

#define MARVELL_MAP_DRAM                                      \
	MAP_REGION_FLAT(MARVELL_DRAM_BASE, MARVELL_DRAM_SIZE, \
...
#define MAX_MMAP_REGIONS (PLAT_MARVELL_MMAP_ENTRIES + MARVELL_BL_REGIONS)
...
#define PLAT_NUM_PWR_DOMAINS (PLAT_MARVELL_CLUSTER_COUNT + PLATFORM_CORE_COUNT)
...
#define BL1_RO_LIMIT \
	(PLAT_MARVELL_TRUSTED_ROM_BASE + PLAT_MARVELL_TRUSTED_ROM_SIZE)
/*
 * Put BL1 RW at the top of the Trusted SRAM.
 */
#define BL1_RW_BASE                                  \
	(MARVELL_BL_RAM_BASE + MARVELL_BL_RAM_SIZE - \
 ...
 */
#define BL31_BASE \
	(MARVELL_BL_RAM_BASE + MARVELL_BL_RAM_SIZE - PLAT_MARVEL_MAX_BL31_SIZE)
