...
#define SET_JR_REG(name, jr, val) (sec_out32(JR_REG(name, (jr)), (val)))

#define SET_JR_REG_LO(name, jr, val) (sec_out32(JR_REG_LO(name, (jr)), (val)))
...
void sec_handle_desc_error(struct sec_job_ring_t *job_ring,
			   uint32_t sec_error_code, uint32_t *notified_descs,
