...
#define ESDHC_IRQSTAT_CMD_ERR \
	(ESDHC_IRQSTAT_CIE | ESDHC_IRQSTAT_CEBE | ESDHC_IRQSTAT_CCE)
#define ESDHC_IRQSTAT_DATA_ERR \
	(ESDHC_IRQSTAT_DEBE | ESDHC_IRQSTAT_DCE | ESDHC_IRQSTAT_DTOE)
