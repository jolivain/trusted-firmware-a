 ...
 * Ref. Table 9 - Definition of (UINT16) TPM_ALG_ID Constants <IN/OUT, S>
...
typedef struct id_event_headers {
 ...
 */
typedef struct tcg_pcr_event2_header {
 ...
 */
typedef struct tcg_efi_startup_locality_event {
	/*
