...
#define STM32_UART_TXFIFO_THRESHOLD_3QUARTERSFULL \
	(USART_CR3_TXFTCFG_0 | USART_CR3_TXFTCFG_1)
#define STM32_UART_TXFIFO_THRESHOLD_7EIGHTHFULL USART_CR3_TXFTCFG_2
#define STM32_UART_TXFIFO_THRESHOLD_EMPTY \
	(USART_CR3_TXFTCFG_2 | USART_CR3_TXFTCFG_0)
...
#define STM32_UART_RXFIFO_THRESHOLD_3QUARTERSFULL \
	(USART_CR3_RXFTCFG_0 | USART_CR3_RXFTCFG_1)
#define STM32_UART_RXFIFO_THRESHOLD_7EIGHTHFULL USART_CR3_RXFTCFG_2
#define STM32_UART_RXFIFO_THRESHOLD_FULL \
	(USART_CR3_RXFTCFG_2 | USART_CR3_RXFTCFG_0)
