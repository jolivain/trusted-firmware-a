...
#define TZC_ATTR_SP_ALL                                        \
	((TZC_SP_S_W | TZC_SP_S_R | TZC_SP_NS_W | TZC_SP_NS_R) \
	 << TZC_ATTR_SP_SHIFT)
#define TZC_ATTR_SP_S_RW ((TZC_SP_S_W | TZC_SP_S_R) << TZC_ATTR_SP_SHIFT)
#define TZC_ATTR_SP_NS_RW ((TZC_SP_NS_W | TZC_SP_NS_R) << TZC_ATTR_SP_SHIFT)
...
#define TZC_ATTR_SUBREG_DIS(s) \
	(((s)&TZC_SUBREGION_DIS_MASK) << TZC_SUBREGION_DIS_SHIFT)
...
static inline void tzc_configure_region(uint8_t region, uintptr_t region_base,
					unsigned int attr)
{
