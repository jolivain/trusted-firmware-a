...
/*
 * Maximum size of buffer used to hold hash or public key
 * ToDo: Size is being decided with number of images and
 * certificates currently available in CoT with some additional
 * buffer. Size of these buffers bound to increase in futures.
 */
#define MAX_AUTH_BUF		(MAX_ALLOC_HASH_BUF + MAX_ALLOC_PK_BUF)

#define MAX_ALLOC_HASH_BUF	(20 * HASH_DER_LEN)
#define MAX_ALLOC_PK_BUF	(12 * PK_DER_LEN)
