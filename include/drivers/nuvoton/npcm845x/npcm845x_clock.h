...
#define PLLCON2_LOKI 31
#define PLLCON2_LOKS 30
#define PLLCON2_FBDV 16
#define PLLCON2_OTDV2 13
#define PLLCON2_PWDEN 12
#define PLLCON2_OTDV1 8
#define PLLCON2_INDV 0

/* CPUCKSEL (CPU/AMBA/MC Clock Source Select Bit) */
/* 0 0: PLL0 clock*/
#define CLKSEL_CPUCKSEL_PLL0 0x00
/* 0 1: PLL1 clock */
#define CLKSEL_CPUCKSEL_PLL1 0x01
/* 1 0: CLKREF input (25 MHz, default) */
#define CLKSEL_CPUCKSEL_CLKREF 0x02
/* 1 1: Bypass clock from pin SYSBPCK */
#define CLKSEL_CPUCKSEL_SYSBPCK 0x03

/* UARTCKSEL (Core and Host UART Clock Source Select Bit). */
/* 0 0: PLL0 clock. */
#define CLKSEL_UARTCKSEL_PLL0 0x00
/* 0 1: PLL1 clock. */
#define CLKSEL_UARTCKSEL_PLL1 0x01
/* 1 0: CLKREF clock (25 MHz, default). */
#define CLKSEL_UARTCKSEL_CLKREF 0x02
/* 1 1: PLL2 clock divided by 2. */
#define CLKSEL_UARTCKSEL_PLL2 0x03

/* SDCKSEL (SDHC Clock Source Select Bit). */
/* 0 0: PLL0 clock. */
#define CLKSEL_SDCKSEL_PLL0 0x00
/* 0 1: PLL1 clock. */
#define CLKSEL_SDCKSEL_PLL1 0x01
/* 1 0: CLKREF clock (25 MHz, default). */
#define CLKSEL_SDCKSEL_CLKREF 0x02
/* 1 1: PLL2 clock divided by 2. */
#define CLKSEL_SDCKSEL_PLL2 0x03

/* TIMCKSEL (Timer Clock Source Select Bit) */
/* 0 0: PLL0 clock. */
#define CLKSEL_TIMCKSEL_PLL0 0x00
/* 0 1: PLL1 clock. */
#define CLKSEL_TIMCKSEL_PLL1 0x01
/* 1 0: CLKREF clock (25 MHz, default). */
#define CLKSEL_TIMCKSEL_CLKREF 0x02
/* 1 1: PLL2 clock divided by 2. */
#define CLKSEL_TIMCKSEL_PLL2 0x03
