...
#ifndef TF_FEAT_DETECT
#define TF_FEAT_DETECT
...
#define feat_panic(a,b)     ( (a) ? (void)0 : tf_panic(b) )

/*****************************************************************************
 * Helper Macros for each individual arch-features from arch version
 * 8.0 till 8.7 supported in TF-A.
 ****************************************************************************/
...
/*TF-A supported Arch-Features : v9.0 */
#define DETECT_FEAT_RME              read_feat_rme()


#endif /*TF_FEAT_DETECT */