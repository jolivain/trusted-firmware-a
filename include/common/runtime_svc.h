 ...
 * for future use
 */
typedef uintptr_t (*rt_svc_handle_t)(uint32_t smc_fid, u_register_t x1,
...
#define DECLARE_RT_SVC(_name, _start, _end, _type, _setup, _smch)  \
	static const rt_svc_desc_t __svc_desc_##_name __section(   \
		".rt_svc_descs") __used = { .start_oen = (_start), \
					    .end_oen = (_end),     \
					    .call_type = (_type),  \
					    .name = #_name,        \
					    .init = (_setup),      \
