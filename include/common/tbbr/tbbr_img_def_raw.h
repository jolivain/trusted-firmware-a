...
#ifndef ARM_TRUSTED_FIRMWARE_COMMON_TBBR_TBBR_IMG_DEF_RAW_H
#define ARM_TRUSTED_FIRMWARE_COMMON_TBBR_TBBR_IMG_DEF_RAW_H
...
#endif /* ARM_TRUSTED_FIRMWARE_COMMON_TBBR_TBBR_IMG_DEF_RAW_H */
