...
/*******************************************************************************
 * Function to identify the presence of FEAT_PMU (Performance Monitors Extension)
 *
...
static inline unsigned int get_pmu_version(void)
{
	return (unsigned int)((read_id_aa64dfr0_el1() >> ID_AA64DFR0_PMU_SHIFT ) &
				ID_AA64DFR0_PMU_MASK);
}
