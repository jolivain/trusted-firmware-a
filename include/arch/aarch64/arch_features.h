...
#define CREATE_FEATURE_PRESENT(name, idreg, idfield, mask)			\
static inline bool is_ ## name ## _present(void)				\
{										\
	return (ISOLATE_FIELD(read_ ## idreg(), idfield, mask));		\
}

#define CREATE_FEATURE_FUNCS(name, idreg, idfield, mask, guard)			\
CREATE_FEATURE_PRESENT(name, idreg, idfield, mask)				\
...
CREATE_FEATURE_FUNCS(feat_rme, id_aa64pfr0_el1, ID_AA64PFR0_FEAT_RME_SHIFT,
		    ID_AA64PFR0_FEAT_RME_MASK, ENABLE_RME)
...
CREATE_FEATURE_FUNCS(feat_csv2_2, id_aa64pfr0_el1, ID_AA64PFR0_CSV2_SHIFT,
		     ID_AA64PFR0_CSV2_MASK, ENABLE_FEAT_CSV2_2)
CREATE_FEATURE_FUNCS(feat_csv2_3, id_aa64pfr0_el1, ID_AA64PFR0_CSV2_SHIFT,
		     ID_AA64PFR0_CSV2_MASK, ENABLE_FEAT_CSV2_3)
