...
static inline bool read_feat_vhe_id_field(void)
{
 ...
 ********************************************************************************/
static inline bool read_feat_sb_id_field(void)
{
 ...
 *********************************************************************************/
static inline bool read_feat_spe_id_field(void)
{
...
{
	if (ENABLE_SPE_FOR_LOWER_ELS == FEAT_STATE_DISABLED) {
		return false;
	}

	if (ENABLE_SPE_FOR_LOWER_ELS == FEAT_STATE_ALWAYS) {
		return true;
	}
 ...
 ************************************************************************/
static inline bool read_feat_trf_id_field(void)
{
