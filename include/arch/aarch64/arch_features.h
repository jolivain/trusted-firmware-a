...
static unsigned int read_feat_fgt_field(void)
{
 ...
 ******************************************************************************/
static unsigned int read_feat_amu_field(void)
{
...
static inline bool is_feat_amu_supported(void)
{
	...
	return read_feat_amu_field() >= ID_AA64PFR0_AMU_V1;
}

static inline bool is_armv8_6_feat_amuv1p1_present(void)
{
	return read_feat_amu_field() >= ID_AA64PFR0_AMU_V1P1;
}
...
static inline unsigned int read_feat_hcx_field(void)
{
