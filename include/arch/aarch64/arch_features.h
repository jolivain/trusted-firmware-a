...
static inline bool is_feat_csv2_2_supported(void)
{
	...
	return (csv2 == CSV2_VERSION_2_SUPPORTED);
}
...
static inline bool is_feat_csv2_3_supported(void)
{
	...
	return (csv2 == CSV2_VERSION_3_SUPPORTED);
}

static inline unsigned int get_csv2_version(void)
{
	if (is_feat_csv2_3_supported()) {
		return CSV2_VERSION_3_SUPPORTED;
	}

	if (is_feat_csv2_2_supported()) {
		return CSV2_VERSION_2_SUPPORTED;
	}

	return read_feat_csv2_id_field();
}
