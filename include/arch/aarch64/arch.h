...
#define TCPAC_BIT		(ULL(1) << 31)
#define TAM_SHIFT		ULL(30)
#define TAM_BIT			(ULL(1) << TAM_SHIFT)
#define TTA_BIT			(ULL(1) << 20)
#define ESM_BIT			(ULL(1) << 12)
#define TFP_BIT			(ULL(1) << 10)
#define CPTR_EZ_BIT		(ULL(1) << 8)
