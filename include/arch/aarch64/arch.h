...
#define SCR_TWEDEn_BIT		(ULL(1) << 29)
#define SCR_ECVEN_BIT		(ULL(1) << 28)
#define SCR_FGTEN_BIT		(ULL(1) << 27)
#define SCR_ATA_BIT		(ULL(1) << 26)
#define SCR_FIEN_BIT		(ULL(1) << 21)
#define SCR_EEL2_BIT		(ULL(1) << 18)
#define SCR_API_BIT		(ULL(1) << 17)
#define SCR_APK_BIT		(ULL(1) << 16)
#define SCR_TERR_BIT		(ULL(1) << 15)
#define SCR_TWE_BIT		(ULL(1) << 13)
#define SCR_TWI_BIT		(ULL(1) << 12)
#define SCR_ST_BIT		(ULL(1) << 11)
#define SCR_RW_BIT		(ULL(1) << 10)
#define SCR_SIF_BIT		(ULL(1) << 9)
#define SCR_HCE_BIT		(ULL(1) << 8)
#define SCR_SMD_BIT		(ULL(1) << 7)
#define SCR_EA_BIT		(ULL(1) << 3)
#define SCR_FIQ_BIT		(ULL(1) << 2)
#define SCR_IRQ_BIT		(ULL(1) << 1)
#define SCR_NS_BIT		(ULL(1) << 0)
#define SCR_VALID_BIT_MASK	ULL(0x2f8f)
