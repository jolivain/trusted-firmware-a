...
DEFINE_RENAME_SYSREG_RW_FUNCS(zcr_el3, ZCR_EL3)
...
DEFINE_RENAME_SYSREG_RW_FUNCS(smpri_el1, SMPRI_EL1)
DEFINE_RENAME_SYSREG_RW_FUNCS(smprimap_el2, SMPRIMAP_EL2)
DEFINE_RENAME_SYSREG_READ_FUNC(smidr_el1, SMIDR_EL1)
DEFINE_RENAME_SYSREG_RW_FUNCS(tpidr2_el0, TPIDR2_EL0)
DEFINE_RENAME_SYSREG_RW_FUNCS(smcr_el1, SMCR_EL1)
