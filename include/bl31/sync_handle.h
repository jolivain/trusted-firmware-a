...
#define ISS_SYSREG_OPCODE_MASK		0x3bfc1fUL
 ...
 * system register trap (EC=0x18). ESR contains the encoding of the opx and
 ...
 *   -1: trap is unhandled, trigger panic
 *    0: trap was handled, return to the trapping instruction (repeating it)
 *    1: trap was handled, return to the next instruction (skipping)
 */
