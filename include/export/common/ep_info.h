...
#ifndef ARM_TRUSTED_FIRMWARE_EXPORT_COMMON_EP_INFO_H
#define ARM_TRUSTED_FIRMWARE_EXPORT_COMMON_EP_INFO_H
...
#endif /* ARM_TRUSTED_FIRMWARE_EXPORT_COMMON_EP_INFO_H */
