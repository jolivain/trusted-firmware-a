...
#ifndef ARM_TRUSTED_FIRMWARE_EXPORT_COMMON_BL_COMMON_H
#define ARM_TRUSTED_FIRMWARE_EXPORT_COMMON_BL_COMMON_H
...
#endif /* ARM_TRUSTED_FIRMWARE_EXPORT_COMMON_BL_COMMON_H */
