...
then if a conflicting override has already been declared then this error message
will be printed instead of the default one.
...
In e following example, ``USE_FOO`` will be set to ``ON`` hidden from the CMake
user interface by the override. Users may no longer configure this value
...
function(arm_config_option_override)
    ...
    arm_assert(
        CONDITION NOT NOTE IN_LIST ARG_KEYWORDS_MISSING_VALUES
        MESSAGE "A value must be provided for the `NOTE` argument.")
