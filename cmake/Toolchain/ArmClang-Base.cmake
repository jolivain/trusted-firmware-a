...
if(CMAKE_VERSION VERSION_LESS "3.18.3")
    ...
    macro(tfa_reset_linker_wrapper_flag)
        set(CMAKE_C_LINKER_WRAPPER_FLAG "")
        set(CMAKE_CXX_LINKER_WRAPPER_FLAG "")
    endmacro()

    variable_watch(CMAKE_C_LINKER_WRAPPER_FLAG tfa_reset_linker_wrapper_flag)
    variable_watch(CMAKE_CXX_LINKER_WRAPPER_FLAG tfa_reset_linker_wrapper_flag)
endif()
