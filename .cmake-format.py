...
with section("lint"):
  ...
  macro_pattern = u'tfa_[0-9a-z_]+'

  # regular expression pattern describing valid names for public directory
  # variables
  public_var_pattern = u'(CMAKE|TFA)_[A-Z][0-9A-Z_]+'
  max_statements = 50
  ...
  # (cache) scope
  global_var_pattern = u'(CMAKE|TFA)_[A-Z][0-9A-Z_]+'
  ...
  # variables
  private_var_pattern = u'tfa_[0-9a-z_]+'
  max_localvars = 15
  max_branches = 12
  ...
  internal_var_pattern = u'(CMAKE|TFA)?_[A-Z][0-9A-Z_]+'
  max_returns = 6
