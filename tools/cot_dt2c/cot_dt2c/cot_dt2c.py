...
def validateCert(certs, cert_set, ctr, pks):
    allcert = []
    valid = True
    hasRoot = False
...
def generateMain(input, output):
    ...
    validateCert(certs, cert_set, ctrs, pks)
    generateCot(allImages, certs, cert_set, ctrs, pks, outputfileName, includefile, licence)
