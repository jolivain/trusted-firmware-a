...
def main(root, platform, build_type, footprint, tree, symbols, depth, x):
    """A tool for visualizing the contents of ELF format TF-A files."""
    ...
    printer = TfaPrettyPrinter(num_as_hex=x)
