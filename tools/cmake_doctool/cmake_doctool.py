...
def parse_args():
    parser = argparse.ArgumentParser(description='Check the Documentation for the Trusted Firmware A CMake Build System')

    parser.add_argument("-v", "--verbose", help="increase output verbosity",
                    action="store_true")
    parser.add_argument("--check-vars", default=True,
                    help="validate that all variables are documented, and all documented variables are still in use. (default)",
                    action="store_true")
    parser.add_argument("-o", help="output to a text file", metavar="OUTFILE",
