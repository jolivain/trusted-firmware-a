...
enum ext_type_e { EXT_TYPE_NVCOUNTER, EXT_TYPE_PKEY, EXT_TYPE_HASH };

/* NV-Counter types */
enum nvctr_type_e { NVCTR_TYPE_TFW, NVCTR_TYPE_NTFW };
...
#define PLAT_REGISTER_EXTENSIONS(_pdef_ext)      \
	...
	const unsigned int num_pdef_extensions = \
		sizeof(_pdef_ext) / sizeof(_pdef_ext[0])
