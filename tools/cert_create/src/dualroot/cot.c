...
static ext_t cot_ext[] = {
	...
	[TRUSTED_WORLD_PK_EXT] = { .oid = TRUSTED_WORLD_PK_OID,
	...
	[SCP_FW_CONTENT_CERT_PK_EXT] = { .oid = SCP_FW_CONTENT_CERT_PK_OID,
	...
	[SCP_FW_HASH_EXT] = { .oid = SCP_FW_HASH_OID,
			      .opt = "scp-fw",
	...
	[SOC_FW_CONTENT_CERT_PK_EXT] = { .oid = SOC_FW_CONTENT_CERT_PK_OID,
	...
	[TRUSTED_OS_FW_CONTENT_CERT_PK_EXT] = { .oid = TRUSTED_OS_FW_CONTENT_CERT_PK_OID,
	...
	[TRUSTED_OS_FW_EXTRA1_HASH_EXT] = { .oid = TRUSTED_OS_FW_EXTRA1_HASH_OID,
					    .opt = "tos-fw-extra1",
					    .help_msg =
	...
	[TRUSTED_OS_FW_EXTRA2_HASH_EXT] = { .oid = TRUSTED_OS_FW_EXTRA2_HASH_OID,
					    .opt = "tos-fw-extra2",
					    .help_msg =
	...
	[SCP_FWU_CFG_HASH_EXT] = { .oid = SCP_FWU_CFG_HASH_OID,
				   .opt = "scp-fwu-cfg",
				   .help_msg =
					   "SCP Firmware Update Config image file",
	...
	[AP_FWU_CFG_HASH_EXT] = { .oid = AP_FWU_CFG_HASH_OID,
				  .opt = "ap-fwu-cfg",
				  .help_msg =
					  "AP Firmware Update Config image file",
				  .sn = "APFWUpdateConfig",
...
static key_t cot_keys[] = {
	...
	[TRUSTED_WORLD_KEY] = { .id = TRUSTED_WORLD_KEY,
				.opt = "trusted-world-key",
				.help_msg =
					"Trusted World key (input/output file)",
				.desc = "Trusted World key" },

	[SCP_FW_CONTENT_CERT_KEY] = { .id = SCP_FW_CONTENT_CERT_KEY,
				      .opt = "scp-fw-key",
				      .help_msg =
					      "SCP Firmware Content Certificate key (input/output file)",
				      .desc = "SCP Firmware Content Certificate key" },

	[SOC_FW_CONTENT_CERT_KEY] = { .id = SOC_FW_CONTENT_CERT_KEY,
				      .opt = "soc-fw-key",
				      .help_msg =
					      "SoC Firmware Content Certificate key (input/output file)",
				      .desc = "SoC Firmware Content Certificate key" },

	[TRUSTED_OS_FW_CONTENT_CERT_KEY] = { .id = TRUSTED_OS_FW_CONTENT_CERT_KEY,
					     .opt = "tos-fw-key",
					     .help_msg =
						     "Trusted OS Firmware Content Certificate key (input/output file)",
