...
# Enabling SVE for SWD requires enabling SVE for NWD due to feature detection
# mechanism.
...
# management of SVE registers. The only exception being Hafnium SPMC at S-EL2.
ifeq (${ENABLE_SVE_FOR_SWD}, 1)
...
# SME cannot be used with CTX_INCLUDE_FPREGS since secure manager does
