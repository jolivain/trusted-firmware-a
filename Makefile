...
#For now, BL2_IN_XIP_MEM is only supported when BL2_WITHOUT_BL1 is 1.
ifeq ($(BL2_WITHOUT_BL1)-$(BL2_IN_XIP_MEM),0-1)
$(error "BL2_IN_XIP_MEM is only supported when BL2_WITHOUT_BL1 is enabled")
endif
