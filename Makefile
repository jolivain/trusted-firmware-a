...
ENC_ARGS += -k ${ENC_KEY}
FIP_DEPS += encrypted_fws
FWU_FIP_DEPS += encrypted_fws
endif
...
.PHONY:	all msg_start clean realclean distclean cscope locate-checkpatch checkcodebase checkpatch fiptool sptool fip fwu_fip certtool enctool dtbs
.SUFFIXES:
...
ifneq (${FW_ENC_STATUS},0)
encrypted_fws: ${ENC_DEPS} ${ENCTOOL}
	${Q}${ENCTOOL} ${ENC_ARGS}
	@${ECHO_BLANK_LINE}
	@echo "Built $@ successfully"
	@echo "Encrypted firmwares can be found in ${BUILD_PLAT}"
	@${ECHO_BLANK_LINE}
endif
...
help:
	...
	@echo "  encrypted_fws  Build the encrypted firmwares (requires"
	@echo "                 'FW_ENC_STATUS= 1(with SSK) or 2(with BSSK)' and"
	@echo "                 ('ENCRYPT_BL31=1' and/or 'ENCRYPT_BL32=1' etc.))"
