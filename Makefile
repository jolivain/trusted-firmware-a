...
# Handling of lower EL EA requires EL3 exception handling framework
ifeq ($(HANDLE_EA_EL3_FIRST_NS),1)
    ifneq ($(EL3_EXCEPTION_HANDLING),1)
        $(error For HANDLE_EA_EL3_FIRST_NS, EL3_EXCEPTION_HANDLING must also be 1)
    endif
endif
