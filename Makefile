...
.PHONY:	all msg_start clean realclean distclean cscope locate-checkpatch checkcodebase checkpatch fiptool sptool fip fwu_fip certtool dtbs memmap build_docs
.SUFFIXES:
...
build_docs:
	...
	${Q}${MAKE} --no-print-directory -C ${DOCS_PATH} clean
...
help:
	...
	@echo "  build_docs     Build html based documentation using Sphinx tool"
	@echo ""
