...
# Ensure ENABLE_RME is not used with SME or SVE
ifeq (${ENABLE_RME},1)
    ifeq (${ENABLE_SME_FOR_NS},1)
    ...
    ifeq (${ENABLE_SVE_FOR_NS},1)
        # Warning instead of error due to CI dependency on this
        $(warning "ENABLE_SVE_FOR_NS cannot be used with ENABLE_RME")
        $(warning "Forced ENABLE_SVE_FOR_NS=0")
        override ENABLE_SVE_FOR_NS	:= 0
    endif
endif
...
ifeq (${CTX_INCLUDE_FPREGS},1)
    ifeq (${ENABLE_SVE_FOR_NS},1)
        $(error "ENABLE_SVE_FOR_NS cannot be used with CTX_INCLUDE_FPREGS")
    endif
    ifeq (${ENABLE_SME_FOR_NS},1)
        # Warning instead of error due to CI dependency on this
        $(warning "ENABLE_SME_FOR_NS cannot be used with CTX_INCLUDE_FPREGS")
        $(warning "Forced ENABLE_SVE_FOR_NS=0")
        override ENABLE_SVE_FOR_NS	:= 0
    endif
endif
