...
# ENABLE_DEBUG_REG_SMC can only be used in debug builds
ifeq (${ENABLE_DEBUG_REG_SMC},1)
        ifeq (${DEBUG},1)
                $(warning DEBUG_REG_SMC feature is enabled - EL3 security compromised!)
        else
                $(error DEBUG_REG_SMC allowed in DEBUG builds ONLY)
        endif
