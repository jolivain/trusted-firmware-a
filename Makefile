...
ifeq (${BL2_AS_TFA_ENTRY_POINT},1)
	BL2_RUNNING_AT_EL3	:=	1
    ifeq (${ENABLE_RME},1)
        $(error BL2_AS_TFA_ENTRY_POINT=1 and ENABLE_RME=1 configuration in not supported at the moment.)
    endif
...
#For now, BL2_IN_XIP_MEM is only supported when BL2_AS_TFA_ENTRY_POINT is 1.
ifeq ($(BL2_AS_TFA_ENTRY_POINT)-$(BL2_IN_XIP_MEM),0-1)
$(error "BL2_IN_XIP_MEM is only supported when BL2_AS_TFA_ENTRY_POINT is enabled")
endif
