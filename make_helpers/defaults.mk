...
# By default, enable access of trace buffer control registers from NS
# lower ELs  i.e. NS-EL2, and NS-EL1 if NS-EL2 implemented but unused
...
# By default, enable access of trace system registers from NS lower
# ELs  i.e. NS-EL2, and NS-EL1 if NS-EL2 implemented but unused if
# system register trace is implemented.
ENABLE_SYS_REG_TRACE_FOR_NS	:= 1

# By default, enable trace filter control registers access to NS
# lower ELs, i.e. NS-EL2, and NS-EL1 if NS-EL2 implemented but unused
