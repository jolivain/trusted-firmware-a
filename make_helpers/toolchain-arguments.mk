...
argument-ld-arm-link =

argument-ld-llvm-clang =
argument-ld-llvm-lld =
...
argument-response-file-arm-link = @$(call tool-parameter,$(1),$(2),$(3),response-file)
...
argument-response-file-gnu-ld = @$(call tool-parameter,$(1),$(2),$(3),response-file)
...
argument-output-file-arm-link = $(addprefix -o ,$(call tool-parameter,$(1),$(2),$(3),output-file))
...
argument-output-file-llvm-lld = $(addprefix -o ,$(call tool-parameter,$(1),$(2),$(3),output-file))
...
argument-output-file-gnu-ld = $(addprefix -o ,$(call tool-parameter,$(1),$(2),$(3),output-file))
...
argument-input-files-arm-link = $(call tool-parameters,$(1),$(2),$(3),input-files)
...
argument-input-files-llvm-lld = $(call tool-parameters,$(1),$(2),$(3),input-files)
...
argument-input-files-gnu-ld = $(call tool-parameters,$(1),$(2),$(3),input-files)
...
argument-map-file-arm-link = $(addprefix --map --list=$(call tool-parameter,$(1),$(2),$(3),map-file))

argument-map-file-llvm-clang = $(addprefix -Xlinker -Map=$(call tool-parameter,$(1),$(2),$(3),map-file))
argument-map-file-llvm-lld = $(addprefix -Map=$(call tool-parameter,$(1),$(2),$(3),map-file))

argument-map-file-gnu-gcc = $(addprefix -Xlinker -Map=$(call tool-parameter,$(1),$(2),$(3),map-file))
argument-map-file-gnu-ld = $(addprefix -Map=$(call tool-parameter,$(1),$(2),$(3),map-file))
...
argument-linker-scripts-arm-link = $(addprefix --scatter=,$(call tool-parameter,$(1),$(2),$(3),scatter-file))

argument-linker-scripts-llvm-clang = $(addprefix -Xlinker --script=,$(call tool-parameters,$(1),$(2),$(3),linker-scripts))
argument-linker-scripts-llvm-lld = $(addprefix --script=,$(call tool-parameters,$(1),$(2),$(3),linker-scripts))

argument-linker-scripts-gnu-gcc = $(addprefix -Xlinker --script=,$(call tool-parameters,$(1),$(2),$(3),linker-scripts))
argument-linker-scripts-gnu-ld = $(addprefix --script=,$(call tool-parameters,$(1),$(2),$(3),linker-scripts))
...
argument-library-search-paths-arm-link = $(addprefix -L,$(call tool-parameters,$(1),$(2),$(3),library-search-paths))

argument-library-search-paths-llvm-clang = $(addprefix -L,$(call tool-parameters,$(1),$(2),$(3),library-search-paths))
argument-library-search-paths-llvm-lld = $(addprefix -L,$(call tool-parameters,$(1),$(2),$(3),library-search-paths))

argument-library-search-paths-gnu-gcc = $(addprefix -L,$(call tool-parameters,$(1),$(2),$(3),library-search-paths))
argument-library-search-paths-gnu-ld = $(addprefix -L,$(call tool-parameters,$(1),$(2),$(3),library-search-paths))
...
argument-libraries-arm-link = $(addprefix -l,$(call tool-parameters,$(1),$(2),$(3),libraries))

argument-libraries-llvm-clang = $(addprefix -l,$(call tool-parameters,$(1),$(2),$(3),libraries))
argument-libraries-llvm-lld = $(addprefix -l,$(call tool-parameters,$(1),$(2),$(3),libraries))

argument-libraries-gnu-gcc = $(addprefix -l,$(call tool-parameters,$(1),$(2),$(3),libraries))
argument-libraries-gnu-ld = $(addprefix -l,$(call tool-parameters,$(1),$(2),$(3),libraries))
...
argument-entrypoint-arm-link = $(addprefix --entry=,$(call tool-parameter,$(1),$(2),$(3),entrypoint))

argument-entrypoint-llvm-clang = $(addprefix -Xlinker --entry=,$(call tool-parameter,$(1),$(2),$(3),entrypoint))
argument-entrypoint-llvm-lld = $(addprefix --entry=,$(call tool-parameter,$(1),$(2),$(3),entrypoint))

argument-entrypoint-gnu-gcc = $(addprefix -Xlinker --entry=,$(call tool-parameter,$(1),$(2),$(3),entrypoint))
argument-entrypoint-gnu-ld = $(addprefix --entry=,$(call tool-parameter,$(1),$(2),$(3),entrypoint))
