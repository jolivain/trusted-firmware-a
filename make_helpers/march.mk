...
define march_option
    $(shell if ($(CC) --target-help -march=foo 2>&1 | grep -o -P $(provided-march)); then echo $(1); fi)
endef

# This function is used to find the best march value supported by the given compiler.
# we try to print targets supported and find armvX.Y-a or armvX-a values and from that list,
...
ifeq (,$(findstring $(provided-march), $(call march_option, $(provided-march))))
