...
$(1) := $(lastword $(filter armv$(ARM_ARCH_MAJOR)% ,$(filter armv%-a armv%-a, $(GCC_MARCH_OUTPUT))))
endef
...
# is not found it should be ok to try with latest known supported march value from the
# compiler.
define latest_match_march
$(1) := $(lastword $(filter armv%-a armv%-a, $(GCC_MARCH_OUTPUT)))
endef
