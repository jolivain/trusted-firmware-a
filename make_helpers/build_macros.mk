...
$(OBJ): $(2) $(filter-out %.d,$(MAKEFILE_LIST)) | lib$(3)_dirs
	$$(ECHO) "  CC      $$<"
	$$(file >$$@.in,$$(TF_CFLAGS) $$(CFLAGS) $(MAKE_DEP))
...
$(OBJ): $(2) $(filter-out %.d,$(MAKEFILE_LIST)) | $(3)_dirs
	$$(ECHO) "  CC      $$<"
	$$(file >$$@.in,$$(LTO_CFLAGS) $$(TF_CFLAGS) $$(CFLAGS) $(BL_CPPFLAGS) $(BL_CFLAGS) \
		$(MAKE_DEP))
	$$(Q)$$(CC) @$$@.in -c $$< -o $$@
...
$(OBJ): $(2) $(filter-out %.d,$(MAKEFILE_LIST)) | $(3)_dirs
	$$(ECHO) "  AS      $$<"
	$$(file >$$@.in,$$(ASFLAGS) $(BL_CPPFLAGS) $(BL_ASFLAGS) $(MAKE_DEP))
	$$(Q)$$(AS) @$$@.in -c $$< -o $$@
...
$(1): $(2) $(filter-out %.d,$(MAKEFILE_LIST)) | $(3)_dirs
	$$(ECHO) "  PP      $$<"
	$$(file >$$@.in,$$(CPPFLAGS) $(BL_CPPFLAGS) $(TF_CFLAGS_$(ARCH)) $(MAKE_DEP) )
	$$(Q)$$(CPP) @$$@.in -P -x assembler-with-cpp -D__LINKER__ -o $$@ $$<
...
ifdef MAKE_BUILD_STRINGS
	...
	$$(file >$$@.in,$$(TF_LDFLAGS) $$(BL_LDFLAGS) $(BUILD_DIR)/build_message.o $(OBJS) \
