...
ifeq ($(CTX_INCLUDE_MTE_REGS),1)
        $(warning CTX_INCLUDE_MTE_REGS option is deprecated)
endif
ifeq ($(ENABLE_FEAT_MTE),1)
        $(warning ENABLE_FEAT_MTE option is deprecated)
endif

# Enable Memory Tagging Extension2. This must be set to 1 if the platform wants
