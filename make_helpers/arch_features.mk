...
# This file lists all the Architectural features and initialises
# them and enables them based on Arch version.

# This file follows the below format:
#	- Disable any mandatory feature
#	- Enable mandatory feature if applicable to an Arch Version.
#	- Disable any optional feature this would be enabled if needed by platform.

#
################################################################################
# Set mandatory Features default to zero.
################################################################################
#
...
#
################################################################################
# Optional Features defaulted to zero can be enabled by platform if needed.
################################################################################
#
