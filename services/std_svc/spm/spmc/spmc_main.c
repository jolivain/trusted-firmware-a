 ...
 * We can assume that destination is either for an entity in the secure or
 * normal world as any messages destinted for a logical SP will have already
 * been taken care of by the SPMC before entering this function.
 ******************************************************************************/
