...
/*
 * Subset of Arm PSA Firmware Framework for Arm v8-A 1.0
 ...
 *
 * Current implementation only supports VMIDs. FF-A spec also support stream
 * endpoint ids.
 */
 ...
 * @comp_mrd_offset:
 *         Offset of &struct ffa_comp_mrd from start of &struct ffa_mtd.
 * @reserved_8_15:
...
CASSERT(sizeof(struct ffa_emad) == 16, assert_ffa_emad_size_mismatch);
...
CASSERT(sizeof(struct ffa_mtd) == 32, assert_ffa_mtd_size_mismatch);
