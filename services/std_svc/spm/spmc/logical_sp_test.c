...
/* Our Logical SP currently only supports direct messaging. */
#define PARTITION_PROPERTIES_DIR_MSG 0x1

static int64_t sp_init(void)
{
	/* TODO: Add IPMDEF initialisation. */
					  ...
					  void *handle, uint64_t flags)
{
	...
	/*
	 * TODO: Handle the request. For testing purposes echo the incoming
	 * message.
	 */
...
DECLARE_LOGICAL_PARTITION(
	...
	LP_UUID,			/* UUID */
	PARTITION_PROPERTIES_DIR_MSG,	/* Partition Properties. */
