			       ...
			       void *handle)
{
	 ...
	 */
	void *ctx = cm_get_context(secure_state_out);
	write_ctx_reg((get_gpregs_ctx(ctx)), CTX_GPREG_X8,
			SMC_GET_GP(handle, CTX_GPREG_X8));
	write_ctx_reg((get_gpregs_ctx(ctx)), CTX_GPREG_X9,
			SMC_GET_GP(handle, CTX_GPREG_X9));
	write_ctx_reg((get_gpregs_ctx(ctx)), CTX_GPREG_X10,
			SMC_GET_GP(handle, CTX_GPREG_X10));
	write_ctx_reg((get_gpregs_ctx(ctx)), CTX_GPREG_X11,
			SMC_GET_GP(handle, CTX_GPREG_X11));
	write_ctx_reg((get_gpregs_ctx(ctx)), CTX_GPREG_X12,
			SMC_GET_GP(handle, CTX_GPREG_X12));
	write_ctx_reg((get_gpregs_ctx(ctx)), CTX_GPREG_X13,
			SMC_GET_GP(handle, CTX_GPREG_X13));
	write_ctx_reg((get_gpregs_ctx(ctx)), CTX_GPREG_X14,
			SMC_GET_GP(handle, CTX_GPREG_X14));
	write_ctx_reg((get_gpregs_ctx(ctx)), CTX_GPREG_X15,
			SMC_GET_GP(handle, CTX_GPREG_X15));
	write_ctx_reg((get_gpregs_ctx(ctx)), CTX_GPREG_X16,
			SMC_GET_GP(handle, CTX_GPREG_X16));
	write_ctx_reg((get_gpregs_ctx(ctx)), CTX_GPREG_X17,
