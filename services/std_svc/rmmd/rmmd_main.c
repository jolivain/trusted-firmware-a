					...
					void *handle)
{
	...
	/*
	 * SMCCCv1.1 says x4 to x17 must be preserved unless being used as return
	 * args. Hence we differentiate the onward and backward path. Support
	 * upto 7 args in the onward path and 3 args in return path.
	 */
