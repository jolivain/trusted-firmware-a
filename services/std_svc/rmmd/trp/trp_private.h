...
#define TRP_RMM_EL3_ABI_VERS                             \
	(((TRP_RMM_EL3_ABI_VERS_MAJOR & 0x7FFF) << 16) | \
...
#define write_trp_arg(args, offset, val) (((args)->regs[offset >> 3]) = val)
...
#define RMI_ABI_VERSION                             \
	(((RMI_ABI_VERSION_MAJOR & 0x7FFF) << 16) | \
	 (RMI_ABI_VERSION_MINOR & 0xFFFF))

#define TRP_RMM_EL3_VERSION_GET_MAJOR(x) RMM_EL3_IFC_VERSION_GET_MAJOR((x))
