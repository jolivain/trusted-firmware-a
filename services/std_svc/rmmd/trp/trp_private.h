...
/* Definitions for Boot Interface ABI VERSION */
#define TRP_BOOT_ABI_VERS_MAJOR	RMM_BOOT_INTERFACE_VERSION_MAJOR
#define TRP_BOOT_ABI_VERS_MINOR	RMM_BOOT_INTERFACE_VERSION_MINOR
#define TRP_BOOT_ABI_VERSION	(((TRP_BOOT_ABI_VERS_MAJOR & 0x7FFF) << 16) | \
				 (TRP_BOOT_ABI_VERS_MINOR & 0xFFFF))
...
#define BOOT_ABI_VERSION_GET_MAJOR(x)	RMM_BOOT_INTERFACE_VERSION_GET_MAJOR((x))
#define BOOT_ABI_VERSION_GET_MINOR(x)	RMM_BOOT_INTERFACE_VERSION_GET_MINOR((x))
