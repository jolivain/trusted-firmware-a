...
/*******************************************************************************
 * Structures used for loading the OP-TEE image via an SMC. The SMC call will
 ...
 * 'entry_point'    - entry point for execution of OP-TEE
 * 'segments'       - array of all the segments which make up the OP-TEE image
 *
