...
void sme_enable_ns(cpu_context_t *context)
{
	...
	/*
	 * Set the max LEN value and FA64 bit for NS context. Since we are only
	 * enabling SME for NS, this register does not need to be saved/restored
	 * on world changes so we set it globally. CPTR_EL3.ESM will ensure that
