...
void trbe_enable(void)
{
	...
	/*
	 * MDCR_EL3.NSTB = 0b11
	 * Allow access of trace buffer control registers from EL1
	 * and EL2 non-secure, tracing is prohibited in Secure and
	 * Realm state (if implemented).
	 */
	val = read_mdcr_el3();
