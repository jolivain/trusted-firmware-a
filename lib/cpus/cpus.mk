...
CPUS_DEPENDS_DSU_HELPERS := cortex_a55
CPUS_DEPENDS_DSU_HELPERS += cortex_a65
CPUS_DEPENDS_DSU_HELPERS += cortex_a65ae
CPUS_DEPENDS_DSU_HELPERS += cortex_a75
CPUS_DEPENDS_DSU_HELPERS += cortex_a76
CPUS_DEPENDS_DSU_HELPERS += cortex_a510
CPUS_DEPENDS_DSU_HELPERS += cortex_a710
CPUS_DEPENDS_DSU_HELPERS += cortex_x2
CPUS_DEPENDS_DSU_HELPERS += neoverse_n1
CPUS_DEPENDS_DSU_HELPERS += neoverse_n2
CPUS_DEPENDS_DSU_HELPERS += neoverse_e1

CPUS_SUPPORTED_DEPENDS_DSU_HELPERS := \
        $(filter $(CPUS_DEPENDS_DSU_HELPERS),$(CPUS_SUPPORTED))

ifneq ($(CPUS_SUPPORTED_DEPENDS_DSU_HELPERS),)
...
ifneq ($(CPUS_ENABLE_CPU_OPERATIONS),0)
        ...
        CPUS_SOURCES += $(patsubst %,lib/cpus/$(ARCH)/%.S,$(call uppercase,$(CPUS_SUPPORTED)))
