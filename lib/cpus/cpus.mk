...
ifneq ($(CPUS_ENABLE),$(CPUS_ENABLE_COMPAT))
        # If you are a platform maintainer whose platform is receiving this
        # warning, remove any `lib/cpus` sources your platform Makefiles and
        # configure `CPUS_ENABLED` with the list of CPUs enabled by your
        # platform.
...
CPUS_ENABLE += $(CPUS_SOURCES_LEGACY)
