...
ifeq ($(CPUS_SUPPORTED_WITHOUT_HW_ASSISTED_COHERENCY),)
        ...
        ifneq ($(HW_ASSISTED_COHERENCY),0)
                $(error hardware coherency support must be disabled (have `HW_ASSISTED_COHERENCY=$(HW_ASSISTED_COHERENCY)`) to support these CPUs: $(CPUS_SUPPORTED_WITHOUT_HW_ASSISTED_COHERENCY))
        endif
endif
