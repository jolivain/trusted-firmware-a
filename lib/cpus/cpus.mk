...
ifneq ($(CPUS_SUPPORTED_WITH_HW_ASSISTED_COHERENCY),)
        ifeq ($(HW_ASSISTED_COHERENCY),0)
                $(error hardware coherency support must be enabled (have `HW_ASSISTED_COHERENCY=$(HW_ASSISTED_COHERENCY)`) to support these CPUs: $(CPUS_SUPPORTED_WITH_HW_ASSISTED_COHERENCY))
        endif
endif

ifneq ($(CPUS_SUPPORTED_WITHOUT_HW_ASSISTED_COHERENCY),)
