 ...
 * value.
 */
#define GPT_BUILD_L1_DESC(_gpi)                                        \
	(((uint64_t)(_gpi) << 4 * 0) | ((uint64_t)(_gpi) << 4 * 1) |   \
	 ((uint64_t)(_gpi) << 4 * 2) | ((uint64_t)(_gpi) << 4 * 3) |   \
	 ((uint64_t)(_gpi) << 4 * 4) | ((uint64_t)(_gpi) << 4 * 5) |   \
	 ((uint64_t)(_gpi) << 4 * 6) | ((uint64_t)(_gpi) << 4 * 7) |   \
	 ((uint64_t)(_gpi) << 4 * 8) | ((uint64_t)(_gpi) << 4 * 9) |   \
	 ((uint64_t)(_gpi) << 4 * 10) | ((uint64_t)(_gpi) << 4 * 11) | \
	 ((uint64_t)(_gpi) << 4 * 12) | ((uint64_t)(_gpi) << 4 * 13) | \
	 ((uint64_t)(_gpi) << 4 * 14) | ((uint64_t)(_gpi) << 4 * 15))
...
#define GPT_L0GPTSZ                                                 \
	((unsigned int)((read_gpccr_el3() >> GPCCR_L0GPTSZ_SHIFT) & \
			GPCCR_L0GPTSZ_MASK))
 ...
 */
#define GPT_L0_IDX_WIDTH(_t) (((_t) > GPT_S_VAL) ? ((_t)-GPT_S_VAL) : (0U))
...
#define GPT_IS_L1_ALIGNED(_p, _pa) \
	(((_pa) & (GPT_PGS_ACTUAL_SIZE(_p) - U(1))) == U(0))
