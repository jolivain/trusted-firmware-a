...
#define GPT_S_VAL			(PLATFORM_L0GPTSZ + 30U)

/* Make sure L0GPTSZ is valid. */
#if (PLATFORM_L0GPTSZ != GPCCR_L0GPTSZ_30BITS) && \
	(PLATFORM_L0GPTSZ != GPCCR_L0GPTSZ_34BITS) && \
	(PLATFORM_L0GPTSZ != GPCCR_L0GPTSZ_36BITS) && \
	(PLATFORM_L0GPTSZ != GPCCR_L0GPTSZ_39BITS)
#error "You must set a valid PLATFORM_L0GPTSZ."
#endif
