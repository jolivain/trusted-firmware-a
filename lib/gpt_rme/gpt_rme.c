...
static uint64_t *shatter_2mb(uintptr_t base, const gpi_info_t *gpi_info,
				uint64_t l1_desc);
static uint64_t *shatter_32mb(uintptr_t base, const gpi_info_t *gpi_info,
				uint64_t l1_desc);
static uint64_t *shatter_512mb(uintptr_t base, const gpi_info_t *gpi_info,
				uint64_t l1_desc);
...
{
	uint64_t l1_desc = (uint64_t)(gpi | (gpi << 4U));

	l1_desc |= (l1_desc << 8U);
	l1_desc |= (l1_desc << 16U);
	return (l1_desc | (l1_desc << 32U));
}
 ...
 *   info		Pointer to 'gpt_config_t' structure
