 ...
 *   0b110  4PB     52
 */
static unsigned int gpt_t_lookup[] = {32U, 36U, 40U, 42U, 44U, 48U, 52U};
 ...
 */
static unsigned int gpt_p_lookup[] = {12U, 16U, 14U};
	...
	unsigned int target_pas)
{
	...
	if (size == GPT_PGS_ACTUAL_SIZE(gpt_config.p)) {
		...
		/* Get the GPI and make sure it is a valid transition. */
