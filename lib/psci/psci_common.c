...
bool psci_is_last_on_cpu(const unsigned int core_count)
{
	...
	/*
	 * Ensuring core_count is a valid non-negative number and is not greater
	 * than the overall core_count of the platform.
	 */
	assert((core_count > 0) && (core_count <= psci_plat_core_count));
