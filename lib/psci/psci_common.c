 ...
 * range specified.
 ******************************************************************************/
void psci_acquire_pwr_domain_locks(unsigned int end_pwrlvl, unsigned int *parent_nodes)
{
	unsigned int parent_idx;
	unsigned int level;
 ...
 ******************************************************************************/
void psci_release_pwr_domain_locks(unsigned int end_pwrlvl, unsigned int *parent_nodes)
{
	unsigned int parent_idx;
	unsigned int level;
