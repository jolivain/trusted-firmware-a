...
bool psci_is_last_on_cpu_safe(void)
{
	...
	while ((i < PSCI_NUM_NON_CPU_PWR_DOMAINS) &&
		...
		/*
		 * Ensuring number of cpu nodes fetched via the root node
		 * matches the  the overall core_count of the platform.
		 */
		assert(psci_non_cpu_pd_nodes[i].ncpus == psci_plat_core_count);
