...
static unsigned int mmap_desc(unsigned attr, unsigned int addr_pa,
					unsigned int level)
{
	unsigned int desc;
						...
						unsigned int level)
{
	...
	do  {
		unsigned int desc = MMU32B_UNSET_DESC;
...
void init_xlat_tables(void)
{
	...
	init_xlation_table_inner(mmap, 0, (unsigned int *)mmu_l1_base, 1);
