 ...
 ******************************************************************************/
static void el3_arch_init_per_world(per_world_context_t *per_world_ctx)
{
	/*
...
{
	el3_arch_init_per_world(&per_world_context[CPU_CONTEXT_NS]);
...
{
#if IMAGE_BL31
	el3_arch_init_per_world(&per_world_context[CPU_CONTEXT_SECURE]);
