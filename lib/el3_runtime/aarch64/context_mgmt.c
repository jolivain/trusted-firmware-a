...
static void setup_secure_context(cpu_context_t *ctx, const struct entry_point_info *ep)
{
	 ...
	 * Henceforth, this check ensures that the registers are intialised once
...
/*******************************************************************************
 * Intialise per_world_context for Non-Secure world.
...
/*******************************************************************************
 * Intialise per_world_context for Secure world.
 * This function enables the architecture extensions, which have same value
