...
static void el2_sysregs_context_save_mpam(el2_sysregs_t *ctx)
{
	...
	/* MPAMHCR_EL2, MPAMVPMV_EL2 and MPAMVPM0_EL2 are always present */
	 ...
	 */
	switch ((mpam_idr >> MPAMIDR_EL1_VPMR_MAX_SHIFT) & MPAMIDR_EL1_VPMR_MAX_WIDTH) {
	case 7: write_ctx_reg(ctx, CTX_MPAMVPM7_EL2, read_mpamvpm7_el2());
		/* fallthrough */
	case 6: write_ctx_reg(ctx, CTX_MPAMVPM6_EL2, read_mpamvpm6_el2());
		/* fallthrough */
	case 5: write_ctx_reg(ctx, CTX_MPAMVPM5_EL2, read_mpamvpm5_el2());
		/* fallthrough */
	case 4: write_ctx_reg(ctx, CTX_MPAMVPM4_EL2, read_mpamvpm4_el2());
		/* fallthrough */
	case 3: write_ctx_reg(ctx, CTX_MPAMVPM3_EL2, read_mpamvpm3_el2());
		/* fallthrough */
	case 2: write_ctx_reg(ctx, CTX_MPAMVPM2_EL2, read_mpamvpm2_el2());
		/* fallthrough */
	case 1: write_ctx_reg(ctx, CTX_MPAMVPM1_EL2, read_mpamvpm1_el2());
		break;
	}
}
...
static void el2_sysregs_context_restore_mpam(el2_sysregs_t *ctx)
{
	...
	if (!(mpam_idr & MPAMIDR_HAS_HCR_BIT)) {
		return;
	}
	...
	switch ((mpam_idr >> MPAMIDR_EL1_VPMR_MAX_SHIFT) & MPAMIDR_EL1_VPMR_MAX_WIDTH) {
	case 7: write_mpamvpmv_el2(read_ctx_reg(ctx, CTX_MPAMVPMV_EL2));
		/* fallthrough */
	case 6: write_mpamvpm6_el2(read_ctx_reg(ctx, CTX_MPAMVPM6_EL2));
		/* fallthrough */
	case 5: write_mpamvpm5_el2(read_ctx_reg(ctx, CTX_MPAMVPM5_EL2));
		/* fallthrough */
	case 4: write_mpamvpm4_el2(read_ctx_reg(ctx, CTX_MPAMVPM4_EL2));
		/* fallthrough */
	case 3: write_mpamvpm3_el2(read_ctx_reg(ctx, CTX_MPAMVPM3_EL2));
		/* fallthrough */
	case 2: write_mpamvpm2_el2(read_ctx_reg(ctx, CTX_MPAMVPM2_EL2));
		/* fallthrough */
	case 1: write_mpamvpm2_el2(read_ctx_reg(ctx, CTX_MPAMVPM2_EL2));
		break;
	}
}
