...
#if CTX_INCLUDE_MPAM_REGS
		mpam_size = sizeof(ctx->mpam_ctx);
		size_other -= mpam_size;
		mpam_total += mpam_size;
		printf("| %8luB ", mpam_size);
#endif
