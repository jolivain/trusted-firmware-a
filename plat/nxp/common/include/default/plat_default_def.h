...
/* Non secure memory */
#define NXP_NS_DRAM_SIZE \
	(PLAT_DEF_DRAM0_SIZE - (NXP_SECURE_DRAM_SIZE + NXP_SP_SHRD_DRAM_SIZE))
#endif
...
#else
#define NXP_SECURE_DRAM_ADDR                      \
	(NXP_NS_DRAM_ADDR + PLAT_DEF_DRAM0_SIZE - \
	 (NXP_SECURE_DRAM_SIZE + NXP_SP_SHRD_DRAM_SIZE))
#endif
#endif

#ifndef NXP_SP_SHRD_DRAM_ADDR
#define NXP_SP_SHRD_DRAM_ADDR \
	(NXP_NS_DRAM_ADDR + PLAT_DEF_DRAM0_SIZE - NXP_SP_SHRD_DRAM_SIZE)
#endif
...
#ifndef BL32_LIMIT
#define BL32_LIMIT \
	(NXP_SECURE_DRAM_ADDR + NXP_SECURE_DRAM_SIZE + NXP_SP_SHRD_DRAM_SIZE)
#endif
