...
#define PLAT_QTI_G1S_IRQ_PROPS(grp) \
	...
	INTR_PROP_DESC(QTISECLIB_INT_ID_NON_SEC_WDOG_BITE, GIC_HIGHEST_SEC_PRIORITY, \
			grp, GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(QTISECLIB_INT_ID_VMIDMT_ERR_CLT_SEC, GIC_HIGHEST_SEC_PRIORITY, \
			grp, GIC_INTR_CFG_EDGE), \
	INTR_PROP_DESC(QTISECLIB_INT_ID_VMIDMT_ERR_CLT_NONSEC, GIC_HIGHEST_SEC_PRIORITY, \
			grp, GIC_INTR_CFG_EDGE), \
	INTR_PROP_DESC(QTISECLIB_INT_ID_VMIDMT_ERR_CFG_SEC, GIC_HIGHEST_SEC_PRIORITY, \
			grp, GIC_INTR_CFG_EDGE), \
	INTR_PROP_DESC(QTISECLIB_INT_ID_VMIDMT_ERR_CFG_NONSEC, GIC_HIGHEST_SEC_PRIORITY, \
			grp, GIC_INTR_CFG_EDGE), \
