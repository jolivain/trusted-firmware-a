...
{
	struct gxm_bl31_param *from_bl2;

	/* Initialize the console to provide early debug support */
	aml_console_init();

	/* Check that params passed from BL2 are not NULL. */
	from_bl2 = (struct gxm_bl31_param *) arg0;
...
static inline bool gxm_scp_ready(void)
{
	return AML_AO_RTI_SCP_IS_READY(mmio_read_32(AML_AO_RTI_SCP_STAT));
}

static inline void gxm_scp_boot(void)
{
 ...
 ******************************************************************************/
static const interrupt_prop_t gxm_interrupt_props[] = {
...
static const gicv2_driver_data_t gxm_gic_data = {
	.gicd_base = AML_GICD_BASE,
	.gicc_base = AML_GICC_BASE,
	.interrupt_props = gxm_interrupt_props,
	.interrupt_props_num = ARRAY_SIZE(gxm_interrupt_props),
};
...
void bl31_platform_setup(void)
{
	...
	gicv2_driver_init(&gxm_gic_data);
	gicv2_distif_init();
