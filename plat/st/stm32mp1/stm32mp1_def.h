...
#define STM32MP_NS_SYSRAM_BASE \
	(STM32MP_SYSRAM_BASE + STM32MP_SYSRAM_SIZE - STM32MP_NS_SYSRAM_SIZE)
...
#define STM32MP_SEC_SYSRAM_SIZE (STM32MP_SYSRAM_SIZE - STM32MP_NS_SYSRAM_SIZE)
...
#ifndef __ASSEMBLER__
enum ddr_type { STM32MP_DDR3, STM32MP_LPDDR2, STM32MP_LPDDR3 };
#endif
...
#if STM32MP13
#define STM32MP_MTD_BUFFER \
	(SRAM1_BASE + SRAM1_SIZE - PLATFORM_MTD_MAX_PAGE_SIZE)
#endif
/*******************************************************************************
...
#endif
#if STM32MP15
#define STM32MP1_FILTER_BIT_ALL \
	(TZC_400_REGION_ATTR_FILTER_BIT(0) | TZC_400_REGION_ATTR_FILTER_BIT(1))
#endif
