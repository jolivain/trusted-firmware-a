...
#define BL2_RO_LIMIT (STM32MP_BL2_RO_BASE + STM32MP_BL2_RO_SIZE)

#define BL2_RW_BASE STM32MP_BL2_RW_BASE
#define BL2_RW_LIMIT (STM32MP_BL2_RW_BASE + STM32MP_BL2_RW_SIZE)
/*******************************************************************************
...
#define BL32_LIMIT (STM32MP_BL32_BASE + STM32MP_BL32_SIZE)
#endif
...
#define DTB_LIMIT (STM32MP_DTB_BASE + STM32MP_DTB_SIZE)
...
#define PLATFORM_G1S_PROPS(grp)                                               \
	INTR_PROP_DESC(ARM_IRQ_SEC_PHY_TIMER, GIC_HIGHEST_SEC_PRIORITY, grp,  \
		...
		INTR_PROP_DESC(STM32MP1_IRQ_AXIERRIRQ,                        \
			       ...
			       GIC_INTR_CFG_LEVEL),                           \
		INTR_PROP_DESC(STM32MP1_IRQ_TZC400, GIC_HIGHEST_SEC_PRIORITY, \
