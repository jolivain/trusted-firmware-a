...
int get_l3_clk(int ref_clk)
{
	int noc_base_clk, l3_clk, noc_clk, data32;
	uint32_t pllc1_reg;
...
{
	int data32, ref_clk, l3_clk, l4_sys_clk;
...
{
	int data32, ref_clk, l3_clk, l4_sp_clk;
...
{
	int data32, ref_clk, l3_clk, mmc_clk;
