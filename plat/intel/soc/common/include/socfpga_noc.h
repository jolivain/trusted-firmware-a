...
#define DISABLE_L4_FIREWALL (SCR_AXI_AP_MASK | SCR_FPGA2SOC_MASK | SCR_MPU_MASK)
#define DISABLE_BRIDGE_FIREWALL 0x0ffe0101

#define SOCFPGA_CCU_NOC(_ctrl, _dev) \
	(SOCFPGA_CCU_NOC_REG_BASE + (SOCFPGA_CCU_NOC_##_ctrl##_##_dev))

#define SOCFPGA_L4_PER_SCR(_reg) \
	(SOCFPGA_L4_PER_SCR_REG_BASE + (SOCFPGA_NOC_FW_L4_PER_SCR_##_reg))

#define SOCFPGA_L4_SYS_SCR(_reg) \
	(SOCFPGA_L4_SYS_SCR_REG_BASE + (SOCFPGA_NOC_FW_L4_SYS_SCR_##_reg))
