...
#define CONFIG_TEST_FLAG(_flag, _type) (((flag)&FLAG_##_type) == FLAG_##_type)
...
#define SYSMGR_ECC_DBE_COLD_RST_MASK \
	(SYSMGR_ECC_OCRAM_MASK | SYSMGR_ECC_DDR0_MASK | SYSMGR_ECC_DDR1_MASK)
...
typedef enum { NO_REQUEST = 0, RECONFIGURATION, BITSTREAM_AUTH } config_type;
