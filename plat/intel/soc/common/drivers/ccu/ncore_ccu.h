...
#define NCORE_CCU_CSR(reg) (NCORE_CCU_REG(NCORE_CSR_OFFSET) + (reg))
#define NCORE_CCU_DIR(reg) (NCORE_CCU_REG(NCORE_DIRU_OFFSET) + (reg))
#define NCORE_CCU_CAI(reg) (NCORE_CCU_REG(NCORE_CAIU_OFFSET) + (reg))

#define DIRECTORY_UNIT(x, reg) (NCORE_CCU_DIR(reg) + NCORE_DIRU_SIZE * (x))
#define COH_AGENT_UNIT(x, reg) (NCORE_CCU_CAI(reg) + NCORE_CAIU_SIZE * (x))

#define COH_CPU0_BYPASS_REG(reg) \
	(NCORE_CCU_REG(NCORE_FW_OCRAM_BLK_BASE) + (reg))
