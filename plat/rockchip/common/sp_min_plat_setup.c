 ...
 */
IMPORT_SYM(unsigned long, __RO_START__,	BL32_RO_BASE);
IMPORT_SYM(unsigned long, __RO_END__,	BL32_RO_LIMIT);
...
void sp_min_plat_arch_setup(void)
{
	...
	plat_configure_mmu_svc_mon(BL32_RO_BASE,
				   BL_COHERENT_RAM_END - BL32_RO_BASE,
				   BL32_RO_BASE,
				   BL32_RO_LIMIT,
