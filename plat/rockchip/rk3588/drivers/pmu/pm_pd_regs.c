...
void qos_save(void)
{
	...
	if (!(pmu_pd_st0 & BIT(PD_RGA31)))
		rockchip_reg_rgn_save(&qos_reg_rgns[QOS_RGA3_1], 1);

	if (!(pmu_pd_st0 & BIT(PD_USB))) {
