...
#define STIMER_S 1
#define SGRF_SOC_CON7_BITS                                  \
	((0xffffu << 16) | (PMUSRAM_S << PMUSRAM_S_SHIFT) | \
...
#define REG_VAL_CLRBITS(val, bits_shift, msk) (val & (~(msk << bits_shift)))
#define REG_SET_BITS(bits, bits_shift, msk) (((bits) & (msk)) << (bits_shift))
#define REG_WMSK_BITS(bits, bits_shift, msk) \
	(REG_W_MSK(bits_shift, msk) | REG_SET_BITS(bits, bits_shift, msk))
