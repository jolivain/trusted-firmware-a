...
uint64_t BL31_RO_BASE			= BL_CODE_BASE;
uint64_t BL31_RO_LIMIT  		= BL_CODE_END;

#if USE_COHERENT_MEM
uint64_t BL31_COHERENT_RAM_BASE		= BL_COHERENT_RAM_BASE;
uint64_t BL31_COHERENT_RAM_LIMIT	= BL_COHERENT_RAM_END;
#endif
