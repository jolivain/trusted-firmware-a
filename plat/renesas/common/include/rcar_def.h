...
#define BOOT_KIND_BASE (RCAR_SHARED_MEM_BASE + RCAR_SHARED_MEM_SIZE - 0x100)
/*
...
#define RCAR_LOG_OTHER_SIZE (RCAR_LOG_HEADER_SIZE + RCAR_LOG_RES_SIZE)
#define RCAR_BL31_LOG_MAX (RCAR_BL31_LOG_SIZE - RCAR_LOG_OTHER_SIZE)
