...
#define CC63_TRNG_ISR_REG_EHR_VALID			BIT(0)
#define CC63_TRNG_ISR_REG_AUTOCORR_ERR			BIT(1)
...
#define CC63_TRNG_DEBUG_CONTROL_REG_VNC_BYPASS		BIT(1)
#define CC63_TRNG_DEBUG_CONTROL_REG_AUTOCORR_BYPASS	BIT(3)
