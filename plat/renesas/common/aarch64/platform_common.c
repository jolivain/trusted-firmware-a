...
#define MAP_FLASH0 \
	MAP_REGION_FLAT(FLASH0_BASE, FLASH0_SIZE, MT_MEMORY | MT_RO | MT_SECURE)

#define MAP_DRAM1_NS \
	MAP_REGION_FLAT(DRAM1_NS_BASE, DRAM1_NS_SIZE, MT_MEMORY | MT_RW | MT_NS)

#define MAP_DEVICE_RCAR                                     \
	MAP_REGION_FLAT(DEVICE_RCAR_BASE, DEVICE_RCAR_SIZE, \
...
#define MAP_SRAM_STACK                                                  \
	MAP_REGION_FLAT(DEVICE_SRAM_STACK_BASE, DEVICE_SRAM_STACK_SIZE, \
			MT_MEMORY | MT_RW | MT_SECURE)
...
#define MAP_ATFW_LOG                                            \
	MAP_REGION_FLAT(RCAR_BL31_LOG_BASE, RCAR_BL31_LOG_SIZE, \
			MT_DEVICE | MT_RW | MT_SECURE)
#if IMAGE_BL2
#define MAP_DRAM0 \
	MAP_REGION_FLAT(DRAM1_BASE, DRAM1_SIZE, MT_MEMORY | MT_RW | MT_SECURE)
...
#define MAP_RAM0                                            \
	MAP_REGION_FLAT(RCAR_SYSRAM_BASE, RCAR_SYSRAM_SIZE, \
			MT_MEMORY | MT_RW | MT_SECURE)

#define MAP_REG1 \
	MAP_REGION_FLAT(REG1_BASE, REG1_SIZE, MT_DEVICE | MT_RW | MT_SECURE)

#define MAP_ROM \
	MAP_REGION_FLAT(ROM0_BASE, ROM0_SIZE, MT_MEMORY | MT_RO | MT_SECURE)

#define MAP_REG2 \
	MAP_REGION_FLAT(REG2_BASE, REG2_SIZE, MT_DEVICE | MT_RW | MT_SECURE)

#define MAP_DRAM1                                         \
	MAP_REGION_FLAT(DRAM_40BIT_BASE, DRAM_40BIT_SIZE, \
			MT_MEMORY | MT_RW | MT_SECURE)
#endif
...
#if IMAGE_BL31
static const mmap_region_t rcar_mmap[] = { MAP_SHARED_RAM,   MAP_ATFW_CRASH,
					   MAP_ATFW_LOG,     MAP_DEVICE_RCAR,
					   MAP_DEVICE_RCAR2, MAP_SRAM,
					   MAP_SRAM_STACK,   { 0 } };
#endif

#if IMAGE_BL32
static const mmap_region_t rcar_mmap[] = { MAP_DEVICE0, MAP_DEVICE1, { 0 } };
#endif
 ...
 */
#if USE_COHERENT_MEM
void rcar_configure_mmu_el3(unsigned long total_base, unsigned long total_size,
