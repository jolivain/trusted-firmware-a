 ...
 ******************************************************************************/
enum APUPWR_CLKCTL_ERR_STATUS {
	APUPWR_CLKCTL_OK = 0x0,

	APUPWR_CLKCTL_ERR_GENERIC = 0x1000,
	APUPWR_CLKCTL_ERR_INVALID_CMD = 0x1001,
	APUPWR_CLKCTL_ERR_DOMAIN_NOT_SUPPORTED = 0x1002,
	APUPWR_CLKCTL_ERR_DVFS_FREQ_NOT_SUPPORTED = 0x1003,
};
...
#define POSDIV_MASK		0x07000000
#define DDS_MASK		0x003FFFFF
#define MON_STS_MASK		0xFFC00000
