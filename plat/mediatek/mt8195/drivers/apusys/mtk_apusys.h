...
#define MTK_SIP_APU_MD32_CG_ON	0x02U
...
#define AO_CSR_DUMMY		(APUSYS_APU_S_S_4_BASE + 0x24)
...
/* csr reserved for md32/mnoc cg setup */
#define AO_MD32_CG_MASK	(BIT(1)|BIT(0))
