#ifndef __MTK_CREDIT_DIDT__H
#define __MTK_CREDIT_DIDT__H

/**
 * @file    mtk_credit_didt.h
 * @brief   Driver header for Credit-based di/dt
 *
 */


// #include <debug.h> [Elly] Replace with abs. path
...
#endif /* end of __MTK_CREDIT_DIDT__H */
