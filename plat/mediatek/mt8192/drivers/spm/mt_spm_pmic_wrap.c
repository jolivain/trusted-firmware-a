...
static struct pmic_wrap_setting pw = {
	...
	.set[PMIC_WRAP_PHASE_ALLINONE] = {
		._[CMD_0]	= {BUCK_VGPU11_ELR0, _BITS_(6:0, VOLT_TO_PMIC_VAL(72500)),},/* 0.725 V */
		._[CMD_1]	= {BUCK_VGPU11_ELR0, _BITS_(6:0, VOLT_TO_PMIC_VAL(65000)),},/* 0.650 V */
		._[CMD_2]	= {BUCK_VGPU11_ELR0, _BITS_(6:0, VOLT_TO_PMIC_VAL(60000)),},/* 0.600 V */
		._[CMD_3]	= {BUCK_VGPU11_ELR0, _BITS_(6:0, VOLT_TO_PMIC_VAL(57500)),},/* 0.575 V */
