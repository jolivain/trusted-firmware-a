...
#define VSX_BASE_UV			80000
#define VOLT_TO_PMIC_VSX_VAL(volt)	\
	(((volt) - VCORE_BASE_UV + 1250 - 1) / 1250)
#define PMIC_VSX_VAL_TO_VOLT(pmic)	\
	(((pmic) * 1250) + VCORE_BASE_UV)
...
static struct pmic_wrap_setting pw = {
	...
	.set[PMIC_WRAP_PHASE_ALLINONE] = {
		._[CMD_0]	= {BUCK_VGPU11_ELR0,
				   _BITS_(6:0, VOLT_TO_PMIC_VAL(72500)),},
		._[CMD_1]	= {BUCK_VGPU11_ELR0,
				   _BITS_(6:0, VOLT_TO_PMIC_VAL(65000)),},
		._[CMD_2]	= {BUCK_VGPU11_ELR0,
				   _BITS_(6:0, VOLT_TO_PMIC_VAL(60000)),},
		._[CMD_3]	= {BUCK_VGPU11_ELR0,
				   _BITS_(6:0, VOLT_TO_PMIC_VAL(57500)),},
		...
		._[CMD_14]	= {TOP_CLK_CON0, 0x0040,},
		._[CMD_15]	= {TOP_CLK_CON0, 0x0000,},
		.nr_idx = NR_IDX_ALL,
	},
};
