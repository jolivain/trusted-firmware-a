...
#ifdef ATF_PLAT_SPM_SRAM_SLP_UNSUPPORT
...
/*
 * If sram won't enter low power mode and then Bus26m shouldn't
 * enter low power mode. Set SPM_SRAM_SLEEP_RC_RES_RESTRICT (1)
 */
