...
bool spm_is_valid_rc_cpu_buck_ldo(int cpu, int state_id);
...
bool spm_is_valid_rc_dram(int cpu, int state_id);
...
bool spm_is_valid_rc_syspll(int cpu, int state_id);
...
bool spm_is_valid_rc_bus26m(int cpu, int state_id);
