...
#define SPM_INTERNAL_STATUS_HW_S1	(1<<0U)
...
extern wake_reason_t __spm_output_wake_reason(int state_id, const struct wake_status *wakesta);
...
extern void __spm_clean_before_wfi(void);
