...
#ifndef __MT_CPU_PM_CPC_H__
#define __MT_CPU_PM_CPC_H__
...
#define CPC_PWR_ON_SEQ_DIS	(1 << 1)
#define CPC_PWR_ON_PRIORITY	(1 << 2)
#define CPC_AUTO_OFF_EN		(1 << 5)
#define CPC_DORMANT_WAIT_EN	(1 << 14)
#define CPC_CTRL_EN		(1 << 16)
#define CPC_OFF_PRE_EN		(1 << 29)

/* CPC_MCUSYS_LAST_CORE_REQ(0xA818) : last core protection */
#define CPUSYS_PROT_SET		(1 << 0)
#define MCUSYS_PROT_SET		(1 << 8)
#define CPUSYS_PROT_CLR		(1 << 8)
#define MCUSYS_PROT_CLR		(1 << 9)
...
#define CPC_PROF_EN		(1 << 0)
#define CPC_DBG_EN		(1 << 1)
#define CPC_FREEZE		(1 << 2)
#define CPC_CALC_EN		(1 << 3)
