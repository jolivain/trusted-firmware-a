...
#define APUSYS_NOC_DAPC_GAP_BOUNDARY    4
#define APUSYS_NOC_DAPC_JUMP_GAP        12

#define APUSYS_APC_SYS0_AO_SLAVE_NUM_IN_1_DOM       16
#define APUSYS_APC_SYS0_AO_DOM_NUM                  16
#define APUSYS_APC_SYS0_AO_SLAVE_NUM                59

#define APUSYS_APC_SYS0_LOCK_BIT_APU_SCTRL_REVISER  11
#define APUSYS_APC_SYS0_LOCK_BIT_APUSYS_AO_5        5
