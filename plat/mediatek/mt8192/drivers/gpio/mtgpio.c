...
void gpio_test()
{
	...
	for(i =0; i < 8; i++) {
		mt_set_gpio_mode(66, i);
		printf("gpio66 BPI_D_BUS3, set_mode[%d]  val=0x%x\n", i, mmio_read_32(GPIO_BASE + 0x380));
	}
	mt_set_gpio_mode(66, 0);
	gpio_set_direction(66, 0);
	gpio_set_value(66, 1);
	printf( "gpio66 BPI_D_BUS3, set_mode val=0x%x\n", mmio_read_32(GPIO_BASE + 0x380));
	printf( "gpio66 BPI_D_BUS3, set_dir val=0x%x\n", mmio_read_32(GPIO_BASE + 0x020));
	printf( "gpio66 BPI_D_BUS3, set_out0 val=0x%x\n", mmio_read_32(GPIO_BASE + 0x120));
	printf( "gpio66 BPI_D_BUS3, get_value0 val=0x%x\n", gpio_get_value(66));
	printf( "gpio66 BPI_D_BUS3, get_din val=0x%x\n", mmio_read_32(GPIO_BASE + 0x220));
	gpio_set_value(66, 0);
	printf( "gpio66 SPI0_MO, set_out1 val=0x%x\n", mmio_read_32(GPIO_BASE + 0x120));
	printf( "gpio66 SPI0_MO, get_value1 val=0x%x\n", gpio_get_value(66));
	printf( "gpio66 BPI_D_BUS3, get_din val=0x%x\n", mmio_read_32(GPIO_BASE + 0x220));
	...
	gpio_set_direction(105, 0);
	gpio_set_value(105, 1);
	printf( "gpio105 SPI0_MO, set_mode val=0x%x\n", mmio_read_32(GPIO_BASE + 0x3d0));
	printf("gpio105 SPI0_MO, set_dir val=0x%x\n", mmio_read_32(GPIO_BASE + 0x030));
	printf("gpio105 SPI0_MO, set_out0 val=0x%x\n", mmio_read_32(GPIO_BASE + 0x130));
	printf("gpio105 SPI0_MO, get_value0 val=0x%x\n", gpio_get_value(105));
	gpio_set_value(105, 0);
	printf( "gpio105 SPI0_MO, set_out1 val=0x%x\n", mmio_read_32(GPIO_BASE + 0x130));
	printf("gpio105 SPI0_MO, get_value1 val=0x%x\n", gpio_get_value(105));

	gpio_set_direction(105, 1);
	gpio_set_pull(105, 1);
