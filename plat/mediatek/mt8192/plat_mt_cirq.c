...
int mt_irq_mask_restore(struct mtk_irq_mask *mask)
{
	...
	if (mask->footer != IRQ_MASK_FOOTER) {
	 ...
	 mmio_write_32((dist_base + GICD_ISENABLER + 0x4), mask->mask1);
	 mmio_write_32((dist_base + GICD_ISENABLER + 0x8), mask->mask2);
	 mmio_write_32((dist_base + GICD_ISENABLER + 0xc), mask->mask3);
	 mmio_write_32((dist_base + GICD_ISENABLER + 0x10), mask->mask4);
	 mmio_write_32((dist_base + GICD_ISENABLER + 0x14), mask->mask5);
	 mmio_write_32((dist_base + GICD_ISENABLER + 0x18), mask->mask6);
	 mmio_write_32((dist_base + GICD_ISENABLER + 0x1c), mask->mask7);
	 mmio_write_32((dist_base + GICD_ISENABLER + 0x20), mask->mask8);
	 mmio_write_32((dist_base + GICD_ISENABLER + 0x24), mask->mask9);
	 mmio_write_32((dist_base + GICD_ISENABLER + 0x28), mask->mask10);
	 mmio_write_32((dist_base + GICD_ISENABLER + 0x2c), mask->mask11);
	 mmio_write_32((dist_base + GICD_ISENABLER + 0x30), mask->mask12);
...
int mt_irq_mask_all(struct mtk_irq_mask *mask)
{
	...
	if (mask != NULL) {
		/* for SPI */
		mask->mask1 = mmio_read_32((dist_base + GICD_ISENABLER + 0x4));
		mask->mask2 = mmio_read_32((dist_base + GICD_ISENABLER + 0x8));
		mask->mask3 = mmio_read_32((dist_base + GICD_ISENABLER + 0xc));
		mask->mask4 = mmio_read_32((dist_base + GICD_ISENABLER + 0x10));
		mask->mask5 = mmio_read_32((dist_base + GICD_ISENABLER + 0x14));
		mask->mask6 = mmio_read_32((dist_base + GICD_ISENABLER + 0x18));
		mask->mask7 = mmio_read_32((dist_base + GICD_ISENABLER + 0x1c));
		mask->mask8 = mmio_read_32((dist_base + GICD_ISENABLER + 0x20));
		mask->mask9 = mmio_read_32((dist_base + GICD_ISENABLER + 0x24));
		mask->mask10 = mmio_read_32((dist_base + GICD_ISENABLER
			+ 0x28));
		mask->mask11 = mmio_read_32((dist_base + GICD_ISENABLER
			+ 0x2c));
		mask->mask12 = mmio_read_32((dist_base + GICD_ISENABLER
			+ 0x30));

		/* for SPI */
		mmio_write_32((dist_base + GICD_ICENABLER + 0x4), 0xFFFFFFFF);
		mmio_write_32((dist_base + GICD_ICENABLER + 0x8), 0xFFFFFFFF);
		mmio_write_32((dist_base + GICD_ICENABLER + 0xC), 0xFFFFFFFF);
		mmio_write_32((dist_base + GICD_ICENABLER + 0x10), 0xFFFFFFFF);
		mmio_write_32((dist_base + GICD_ICENABLER + 0x14), 0xFFFFFFFF);
		mmio_write_32((dist_base + GICD_ICENABLER + 0x18), 0xFFFFFFFF);
		mmio_write_32((dist_base + GICD_ICENABLER + 0x1C), 0xFFFFFFFF);
		mmio_write_32((dist_base + GICD_ICENABLER + 0x20), 0xFFFFFFFF);
		mmio_write_32((dist_base + GICD_ICENABLER + 0x24), 0xFFFFFFFF);
		mmio_write_32((dist_base + GICD_ICENABLER + 0x28), 0xFFFFFFFF);
		mmio_write_32((dist_base + GICD_ICENABLER + 0x2c), 0xFFFFFFFF);
		mmio_write_32((dist_base + GICD_ICENABLER + 0x30), 0xFFFFFFFF);
...
void mt_irq_unmask_for_sleep_ex(uint32_t irq)
{
	...
	mmio_write_32(dist_base + GICD_ISENABLER + ((irq / 32U) * 4U), mask);
}
