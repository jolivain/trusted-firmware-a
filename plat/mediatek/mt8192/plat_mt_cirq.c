 ...
 */
__attribute__((weak)) int mt_cirq_get_mask(uint32_t cirq_num)
{
	uint32_t st;
	int val;
 ...
 *   -1: cirq num is out of range
 */
__attribute__((weak)) int mt_cirq_get_sens(uint32_t cirq_num)
{
	uint32_t st;
	int val;
 ...
 */
static int mt_cirq_get_pending(uint32_t cirq_num)
{
	uint32_t st;
	int val;
