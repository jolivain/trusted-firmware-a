...
static void __dead2 mtk_system_reset_chrome(void)
{
...
static void __dead2 mtk_system_off_chrome(void)
{
	INFO("MTK System Off\n");
...
static struct plat_pm_reset_ctrl lib_reset_ctrl = {
	.system_off = mtk_system_off_chrome,
	.system_reset = mtk_system_reset_chrome,
	.system_reset2 = NULL,
};
