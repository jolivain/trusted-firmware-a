...
#endif
#if CONFIG_MTK_AEE
#include <lib/aee/mtk_aee_debug.h>
#endif

#define MTK_PM_ST_SMP_READY	(1U << 0)
#define MTK_PM_ST_PWR_READY	(1U << 1)
#define MTK_PM_ST_RESET_READY	(1U << 2)
