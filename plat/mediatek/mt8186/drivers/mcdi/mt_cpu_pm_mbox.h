...
/* SSPM Mbox */
/* AP Write */
#define SSPM_MBOX_SPM_CMD      0
#define SSPM_MBOX_SPM_ARGS1    1
#define SSPM_MBOX_SPM_ARGS2    2
#define SSPM_MBOX_SPM_ARGS3    3
#define SSPM_MBOX_SPM_ARGS4    4
#define SSPM_MBOX_SPM_ARGS5    5
#define SSPM_MBOX_SPM_ARGS6    6
#define SSPM_MBOX_SPM_ARGS7    7
#define SSPM_MBOX_AP_READY     17

#define SSPM_MBOX_SPM_CMD_SIZE 8
...
void mtk_set_cpu_pm_plat_suspend(void *priv);
