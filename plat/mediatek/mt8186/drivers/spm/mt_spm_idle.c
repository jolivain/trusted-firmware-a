...
#define __WAKE_SRC_FOR_SUSPEND_COMMON__                                        \
	(R12_PCM_TIMER | R12_KP_IRQ_B | R12_APWDT_EVENT_B |                    \
	 ...
	 R12_CONN_WDT_IRQ_B | R12_SSPM2SPM_WAKEUP_B | R12_SCP2SPM_WAKEUP_B |   \
	 R12_ADSP2SPM_WAKEUP_B | R12_USBX_CDSC_B | R12_USBX_POWERDWN_B |       \
	 R12_SYS_TIMER_EVENT_B | R12_EINT_EVENT_SECURE_B | R12_AFE_IRQ_MCU_B | \
	 R12_SYS_CIRQ_IRQ_B | R12_NNA_WAKEUP | R12_SEJ_EVENT_B |               \
	 R12_REG_CPU_WAKEUP)
