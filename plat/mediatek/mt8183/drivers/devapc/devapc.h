...
enum { MASTER_SCP = 0, MASTER_SPM = 10, MASTER_SSPM = 27 };
...
enum TRANSACTION { NON_SECURE_TRANSACTION = 0, SECURE_TRANSACTION };

enum DAPC_SLAVE_TYPE { DAPC_INFRA_SLAVE = 0, DAPC_MM_SLAVE };
