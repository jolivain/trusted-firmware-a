...
#define DECLARE_SMC_HANDLER(_smc_id, _smc_handler)                         \
	const struct smc_descriptor _smc_id##_descriptor __used __aligned( \
		sizeof(void *)) __section(".mtk_smc_descriptor_pool") = {  \
...
typedef uintptr_t (*smc_handler_t)(u_register_t, u_register_t, u_register_t,
				   u_register_t, void *, struct smccc_res *);
