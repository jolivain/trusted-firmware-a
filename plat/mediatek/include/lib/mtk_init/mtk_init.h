...
/* initcall helpers  */
#define MTK_EARLY_PLAT_INIT(_fn) \
	DECLARE_MTK_INITCALL(_fn, 0)
#define MTK_ARCH_INIT(_fn) \
	DECLARE_MTK_INITCALL(_fn, 1)
#define MTK_PLAT_SETUP_0_INIT(_fn) \
	DECLARE_MTK_INITCALL(_fn, 2)
#define MTK_PLAT_SETUP_1_INIT(_fn) \
	DECLARE_MTK_INITCALL(_fn, 3)
#define MTK_PLAT_RUNTIME_INIT(_fn) \
	DECLARE_MTK_INITCALL(_fn, 4)
#define MTK_PLAT_BL33_DEFER_INIT(_fn) \
	DECLARE_MTK_INITCALL(_fn, 5)
