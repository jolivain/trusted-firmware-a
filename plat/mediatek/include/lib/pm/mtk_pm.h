...
#define MTK_CPUPM_FN_PWR_LOCK_AQUIRE		(1U << 0)
#define MTK_CPUPM_FN_INIT			(1U << 1)
#define MTK_CPUPM_FN_PWR_STATE_VALID		(1U << 2)
#define MTK_CPUPM_FN_PWR_ON_CORE_PREPARE	(1U << 3)
#define MTK_CPUPM_FN_SUSPEND_CORE		(1U << 4)
#define MTK_CPUPM_FN_RESUME_CORE		(1U << 5)
#define MTK_CPUPM_FN_SUSPEND_CLUSTER		(1U << 6)
#define MTK_CPUPM_FN_RESUME_CLUSTER		(1U << 7)
#define MTK_CPUPM_FN_SUSPEND_MCUSYS		(1U << 8)
#define MTK_CPUPM_FN_RESUME_MCUSYS		(1U << 9)
#define MTK_CPUPM_FN_CPUPM_GET_PWR_STATE	(1U << 10)
#define MTK_CPUPM_FN_SMP_INIT			(1U << 11)
#define MTK_CPUPM_FN_SMP_CORE_ON		(1U << 12)
#define MTK_CPUPM_FN_SMP_CORE_OFF		(1U << 13)
...
#define MT_IRQ_REMAIN_CAT_LOG   (1U<<31u)
...
#define MT_CPUPM_PWR_DOMAIN_CORE		(1U << 0)
#define MT_CPUPM_PWR_DOMAIN_PERCORE_DSU		(1U << 1)
#define MT_CPUPM_PWR_DOMAIN_PERCORE_DSU_MEM	(1U << 2)
#define MT_CPUPM_PWR_DOMAIN_CLUSTER		(1U << 3)
#define MT_CPUPM_PWR_DOMAIN_MCUSYS		(1U << 4)
#define MT_CPUPM_PWR_DOMAIN_SUSPEND		(1U << 5)
...
#define IS_MT_PLAT_PWR_STATE(_state, _tar)		((_state & _tar) == _tar)
