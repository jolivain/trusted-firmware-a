...
typedef int32_t (*dapc_cfg_func)(uint32_t slave, enum apusys_apc_domain_id domain_id,
...
int32_t set_apusys_dapc_v1(const struct apc_dom_16 *dapc, uint32_t size, dapc_cfg_func cfg);
