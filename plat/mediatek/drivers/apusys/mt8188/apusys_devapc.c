...
static int32_t set_slave_ao_ctrl_apc(uint32_t slave, enum apusys_apc_domain_id domain_id,
...
static int32_t set_slave_noc_dapc_rcx(uint32_t slave, enum apusys_apc_domain_id domain_id,
				      enum apusys_apc_perm_type perm)
{
	uint32_t apc_register_index;
	uint32_t apc_set_index;
...
static int32_t set_slave_rcx_ctrl_apc(uint32_t slave, enum apusys_apc_domain_id domain_id,
				      enum apusys_apc_perm_type perm)
{
	uint32_t apc_register_index;
	uint32_t apc_set_index;
...
{
	mmio_read_32(APUSYS_DAPC_CON(base));
