...
#define BL32_REGION_SA			(0x43000000ULL)
#define BL32_REGION_EA			(0x475FFFFFULL)
#define SCP_CORE0_REGION_SA		(0x50000000ULL)
#define SCP_CORE0_REGION_EA		(0x507FFFFFULL)
#define SCP_CORE1_REGION_SA		(0x70000000ULL)
#define SCP_CORE1_REGION_EA		(0x79FFFFFFULL)
#define DSP_PROTECT_REGION_SA		(0x60000000ULL)
#define DSP_PROTECT_REGION_EA		(0x610FFFFFULL)
