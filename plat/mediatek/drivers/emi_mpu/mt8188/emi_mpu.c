...
void set_emi_mpu_regions(void)
{
	...
	/* BL32 address */
	region_info.start = BL32_REGION_SA;
	region_info.end = BL32_REGION_EA;
	...
	/* SCP core0 DRAM */
	region_info.start = SCP_CORE0_REGION_SA;
	region_info.end = SCP_CORE0_REGION_EA;
	...
	/* SCP core1 DRAM */
	region_info.start = SCP_CORE1_REGION_SA;
	region_info.end = SCP_CORE1_REGION_EA;
	...
	/* DSP protect address */
	region_info.start = DSP_PROTECT_REGION_SA;
	region_info.end = DSP_PROTECT_REGION_EA;
