...
void set_emi_mpu_regions(void)
{
	...
	/* BL31 address */
	region_info.start = 0x54600000ULL;
	region_info.end = 0x5465FFFFULL;
	region_info.region = BL31_REGION_ID;
	...
	/* BL32 address */
	region_info.start = 0x43000000ULL;
	region_info.end = 0x47FFFFFFULL;
