...
#define CPU_PM_FN                                                          \
	(MTK_CPUPM_FN_CPUPM_GET_PWR_STATE | MTK_CPUPM_FN_PWR_STATE_VALID | \
	 MTK_CPUPM_FN_PWR_ON_CORE_PREPARE | MTK_CPUPM_FN_RESUME_CORE |     \
	 MTK_CPUPM_FN_SUSPEND_MCUSYS | MTK_CPUPM_FN_RESUME_MCUSYS |        \
	 MTK_CPUPM_FN_SMP_INIT | MTK_CPUPM_FN_SMP_CORE_ON |                \
