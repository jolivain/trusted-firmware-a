...
static uint64_t get_kernel_info_pc(void)
{
	return k_info.pc;
}

static uint64_t get_kernel_info_r0(void)
{
	return k_info.r0;
}

static uint64_t get_kernel_info_r1(void)
{
	return k_info.r1;
}

static uint64_t get_kernel_info_r2(void)
{
	return k_info.r2;
}
