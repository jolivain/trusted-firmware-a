...
/* smi larb configure */
/*
 * If enable multimedia security config, the SMI config register must be
 * configurated in security world.
 * And the SRAM path is also configurated in here to enhance security.
 */
