...
#define SUNXI_SRAM_SIZE			0x001d0000
/*
 * Technically there's only SRAM A2, but part of SRAM A2 is used for SPL,
 * and the memory map also shows a 2*64K/27*64K division.
 *
 * Fake the first 128K SRAM A2 as SRAM A1.
 */
#define SUNXI_SRAM_A1_BASE		0x00100000
#define SUNXI_SRAM_A1_SIZE		0x00020000
#define SUNXI_SRAM_A2_BASE		0x00120000
#define SUNXI_SRAM_A2_SIZE		0x001b0000
