...
#define BL31_BASE (SUNXI_SRAM_A2_BASE + SUNXI_SRAM_A2_BL31_OFFSET)
#define BL31_LIMIT (SUNXI_SRAM_A2_BASE + SUNXI_SRAM_A2_SIZE - SUNXI_SCP_SIZE)
...
#define PLAT_NUM_PWR_DOMAINS \
	(U(1) + PLATFORM_CLUSTER_COUNT + PLATFORM_CORE_COUNT)
