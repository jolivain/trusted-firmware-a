...
/*
 * The SCP firmware immediately follows Trusted Firmware in SRAM A2.
 */
#define SCP_FIRMWARE_ENTRY		BL31_LIMIT
			...
			const plat_psci_ops_t **psci_ops)
{
	...
	NOTICE("PSCI: System suspend %s\n",
	       scpi_available ? "available via SCPI" : "not available");
	if (scpi_available) {
