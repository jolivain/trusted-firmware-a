...
#define MV_PM_FW_IPC_VERSION \
	(MV_PM_FW_IPC_VERSION_MAGIC | MV_PM_FW_IPC_VERSION_SEQ)
...
enum mss_pm_ipc_init_state { IPC_UN_INITIALIZED = 1, IPC_INITIALIZED = 2 };

/* IPC queue direction */
enum mss_pm_ipc_init_msg_dir { IPC_MSG_TX = 0, IPC_MSG_RX = 1 };
