...
#define MVEBU_PM_NB_SRAM_LKG_PD_EN                                     \
	(MVEBU_PM_L2_SRAM_LKG_PD_EN | MVEBU_PM_EIP_SRAM_LKG_PD_EN |    \
	 MVEBU_PM_DDRMC_SRAM_LKG_PD_EN | MVEBU_PM_MCI_SRAM_LKG_PD_EN | \
	 MVEBU_PM_MMC_SRAM_LKG_PD_EN | MVEBU_PM_SATA_SRAM_LKG_PD_EN |  \
	 MVEBU_PM_DMA_SRAM_LKG_PD_EN | MVEBU_PM_SEC_SRAM_LKG_PD_EN |   \
	 MVEBU_PM_CPU_SRAM_LKG_PD_EN)
...
#define MVEBU_PM_SB_SRAM_LKG_PD_EN                                            \
	(MVEBU_PM_EBM_SRAM_LKG_PD_EN | MVEBU_PM_PCIE_SRAM_LKG_PD_EN |         \
	 MVEBU_PM_GBE1_TX_SRAM_LKG_PD_EN | MVEBU_PM_GBE1_RX_SRAM_LKG_PD_EN |  \
	 MVEBU_PM_GBE1_MIB_SRAM_LKG_PD_EN | MVEBU_PM_GBE0_TX_SRAM_LKG_PD_EN | \
	 MVEBU_PM_GBE0_RX_SRAM_LKG_PD_EN | MVEBU_PM_GBE0_MIB_SRAM_LKG_PD_EN | \
	 MVEBU_PM_SDIO_SRAM_LKG_PD_EN | MVEBU_PM_USB2_SRAM_LKG_PD_EN |        \
...
static void a3700_en_ddr_self_refresh(void)
{
	 ...
	 */
	mmio_setbits_32(MVEBU_DRAM_PWR_CTRL_REG,
...
static void a3700_pm_en_nb_gpio(uint32_t gpio)
{
	 ...
	 */
	mmio_setbits_32(MVEBU_PM_NB_WAKE_UP_EN_REG,
			MVEBU_PM_NB_GPIO_WKP_EN | MVEBU_PM_NB_WKP_EN |
...
static void a3700_pm_en_sb_gpio(uint32_t gpio)
{
	/* Enable using GPIO as wakeup event */
	mmio_setbits_32(MVEBU_PM_NB_WAKE_UP_EN_REG,
			MVEBU_PM_SB_WKP_NB_EN | MVEBU_PM_NB_WKP_EN |
				MVEBU_PM_CORE1_FIQ_IRQ_WKP_EN |
				MVEBU_PM_CORE0_FIQ_IRQ_WKP_EN);

	/* SB GPIO Wake UP | South Bridge Wake Up Enable */
	mmio_setbits_32(MVEBU_PM_SB_WK_EN_REG,
			MVEBU_PM_SB_GPIO_WKP_EN | MVEBU_PM_SB_GPIO_WKP_EN);
...
static wake_up_src_func
a3700_get_wake_up_src_func(enum pm_wake_up_src_type type)
{
	uint32_t loop;
