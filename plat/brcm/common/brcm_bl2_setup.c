...
#define BL2_COHERENT_RAM_END (unsigned long)(&__COHERENT_RAM_END__)
#endif
...
{
	/* Ensure the characters are flushed out from BL1 */
...
#if USE_COHERENT_MEM
			MAP_REGION_FLAT(BL2_COHERENT_RAM_BASE,
					BL2_COHERENT_RAM_END -
