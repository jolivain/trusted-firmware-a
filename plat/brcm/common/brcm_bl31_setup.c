...
#define BL31_COHERENT_RAM_END (uintptr_t)(&__COHERENT_RAM_END__)
#endif
...
{
	/* Ensure the characters are flushed out from BL2 */
	bcm_console_flush(PLAT_BRCM_BOOT_UART_BASE);
...
#if USE_COHERENT_MEM
		MAP_REGION_FLAT(BL31_COHERENT_RAM_BASE,
				BL31_COHERENT_RAM_END - BL31_COHERENT_RAM_BASE,
