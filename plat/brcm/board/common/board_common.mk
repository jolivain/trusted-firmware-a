...
ifeq (${DRIVER_SPD_ENABLE},1)
$(eval $(call add_define,DRIVER_SPD_ENABLE))
ifeq (${DRIVER_SPD_SPOOF},1)
$(eval $(call add_define,DRIVER_SPD_SPOOF))
BL2_SOURCES		+=	drivers/brcm/ddr/spd_spoof.c
else
BL2_SOURCES		+=	drivers/brcm/ddr/spd.c
endif
endif

ARM_RECOM_STATE_ID_ENC := 0

# Reuse arm_common but remove some features indicated here
$(eval $(call add_define,MEMORY_MAPPED_SYS_TIMER_NOT_SUPPORTED))
