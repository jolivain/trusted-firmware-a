...
static int cluster_power_status[PLAT_BRCM_CLUSTER_COUNT] = {
	CLUSTER_POWER_ON, CLUSTER_POWER_OFF, CLUSTER_POWER_OFF,
	CLUSTER_POWER_OFF
};
...
void ihost_power_on_cluster(u_register_t mpidr)
{
	...
	mmio_clrsetbits_32(
		ihost_base + A72_CRM_DOMAIN_4_CONTROL,
	...
	mmio_setbits_32(ihost_base + A72_CRM_SOFTRESETN_0,
			(1 << A72_CRM_SOFTRESETN_0__CRYSTAL26_SOFTRESETN) |
				(1
				 << A72_CRM_SOFTRESETN_0__CRM_PLL0_SOFTRESETN));
	...
	mmio_setbits_32(
		ihost_base + A72_CRM_CLOCK_CONTROL_0,
	...
	mmio_setbits_32(
		ihost_base + A72_CRM_CLOCK_CONTROL_1,
	...
	mmio_setbits_32(
		ihost_base + A72_CRM_SOFTRESETN_0,
		(1 << A72_CRM_SOFTRESETN_0__CRYSTAL26_SOFTRESETN) |
...
void ihost_power_on_secondary_core(u_register_t mpidr, uint64_t rvbar)
{
	...
	mmio_setbits_32(
		ihost_base + A72_CRM_SUBSYSTEM_CONFIG_0,
		(coreid ?
			 (2
			  << A72_CRM_SUBSYSTEM_CONFIG_0__DBGPWRDUP_CFG_SHIFT) :
			 (1
			  << A72_CRM_SUBSYSTEM_CONFIG_0__DBGPWRDUP_CFG_SHIFT)));
	...
	mmio_setbits_32(
		ihost_base + A72_CRM_SOFTRESETN_0,
		(coreid ? (1 << A72_CRM_SOFTRESETN_0__COREPOR1_SOFTRESETN) :
			  (1 << A72_CRM_SOFTRESETN_0__COREPOR0_SOFTRESETN)));

	mmio_setbits_32(
		ihost_base + A72_CRM_SOFTRESETN_1,
		(coreid ? ((1 << A72_CRM_SOFTRESETN_1__CORE1_SOFTRESETN) |
