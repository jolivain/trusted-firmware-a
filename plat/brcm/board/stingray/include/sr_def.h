...
#define SCR_TBUX_AXCACHE_CONFIG \
	((0x1 << SCR_AWCACHE_OFFSET) | (0x1 << SCR_ARCACHE_OFFSET))
...
#define BRCM_BL_RAM_SIZE (PLAT_BRCM_TRUSTED_SRAM_SIZE - BRCM_SHARED_RAM_SIZE)
 ...
 ******************************************************************************/
#define SR_SID_VAL(block_id, subblock_id, device_num) \
	((block_id << 13) | (subblock_id << 11) | (device_num))
