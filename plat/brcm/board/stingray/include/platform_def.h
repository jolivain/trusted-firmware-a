...
#define PLATFORM_CORE_COUNT                                            \
	(PLATFORM_CLUSTER0_CORE_COUNT + PLATFORM_CLUSTER1_CORE_COUNT + \
	 PLATFORM_CLUSTER2_CORE_COUNT + PLATFORM_CLUSTER3_CORE_COUNT)

#define PLAT_NUM_PWR_DOMAINS \
	(BRCM_SYSTEM_COUNT + BRCM_CLUSTER_COUNT + PLATFORM_CORE_COUNT)
...
#define BL1_RO_LIMIT (PLAT_BRCM_TRUSTED_ROM_BASE + PLAT_BRCM_TRUSTED_ROM_SIZE)
...
#define BL11_RW_LIMIT \
	(PLAT_BRCM_TRUSTED_SRAM_BASE + PLAT_BRCM_TRUSTED_SRAM_SIZE)
...
#define BL2_RW_LIMIT (PLAT_BRCM_TRUSTED_SRAM_BASE + PLAT_BRCM_TRUSTED_SRAM_SIZE)
...
#define BL1_RW_RECLAIM_BASE \
	(PLAT_BRCM_TRUSTED_SRAM_BASE + BL1_PERSISTENT_DATA_SIZE)
...
#define BL31_LIMIT (BRCM_AP_TZC_DRAM1_BASE + PLAT_BRCM_MAX_BL31_SIZE)
#else
/* Put BL3-1 at the end of external on-board SRAM connected as NOR flash */
#define BL31_BASE (NOR_BASE_ADDR + NOR_SIZE - PLAT_BRCM_MAX_BL31_SIZE)
...
#define MAX_MMAP_REGIONS (PLAT_BRCM_MMAP_ENTRIES + BRCM_BL_REGIONS)
...
#define PLAT_BRCM_G1S_IRQ_PROPS(grp)                                         \
	INTR_PROP_DESC(BRCM_IRQ_SEC_SGI_1, GIC_HIGHEST_SEC_PRIORITY, (grp),  \
		       GIC_INTR_CFG_EDGE),                                   \
		INTR_PROP_DESC(BRCM_IRQ_SEC_SPI_0, GIC_HIGHEST_SEC_PRIORITY, \
...
#define PLAT_BRCM_CLUSTER_TO_CCN_ID_MAP \
