...
#define NS3Z_SRAM_SIZE			0x00060000
...
#ifdef USE_XTABLE_ROM
#define SR_MMU_L1_TABLE			(PLAT_BRCM_TRUSTED_ROM_BASE + \
					 PLAT_BRCM_TRUSTED_ROM_SIZE + \
					 L1_MMU_TABLE_SIZE * \
					 BL2_L1_MMU_TABLE_OFFSET)
#endif
 ...
 * addresses.
 ******************************************************************************/
#ifdef RUN_BL1_FROM_SRAM
#define BL1_RO_BASE		        (PLAT_BRCM_TRUSTED_SRAM_BASE \
					+ PLAT_BRCM_TRUSTED_SRAM_SIZE)
#define BL1_RO_LIMIT			(PLAT_BRCM_TRUSTED_SRAM_BASE\
					+ NS3Z_SRAM_SIZE)
#else
...
#define BL10_RO_BASE			ROM_BASE_ADDR
#define BL10_RO_LIMIT			(ROM_BASE_ADDR \
					+ PLAT_BRCM_TRUSTED_ROM_SIZE)
...
/*******************************************************************************
 * BL11 specific defines.
 ******************************************************************************/
#if RUN_BL11_FROM_QSPI /* BL11 XIP from QSPI */
#define BL11_BASE			QSPI_BASE_ADDR
#elif RUN_BL11_FROM_NAND /* BL11 XIP from NAND */
#define BL11_BASE			NAND_BASE_ADDR
#elif RUN_BL11_FROM_SRAM /* BL11 running from SRAM standalone (jtag) */
#define BL11_BASE			BL2_BASE
#else
#define BL11_BASE			BL1_VM_BASE
#endif
#define BL11_LIMIT			(BL11_BASE + 0x40000)
...
#define PLAT_CSS_MAX_SCP_BL2_SIZE	0x9000
#define PLAT_CSS_SCP_COM_SHARED_MEM_BASE (CRMU_SHARED_SRAM_BASE)
/* dummy defined */
