...
#define FPD_APU_BASE		U(0xFD5C0000)
#define FPD_APU_CONFIG_0	(FPD_APU_BASE + U(0x20))
#define FPD_APU_RVBAR_L_0	(FPD_APU_BASE + U(0x40))
#define FPD_APU_RVBAR_H_0	(FPD_APU_BASE + U(0x44))
#define FPD_APU_PWRCTL		(FPD_APU_BASE + U(0x90))

#define FPD_APU_CONFIG_0_VINITHI_SHIFT	U(8)
#define APU_0_PWRCTL_CPUPWRDWNREQ_MASK	U(1)
#define APU_1_PWRCTL_CPUPWRDWNREQ_MASK	U(2)

/* PMC registers and bitfields */
#define PMC_GLOBAL_BASE			U(0xF1110000)
#define PMC_GLOBAL_GLOB_GEN_STORAGE4	(PMC_GLOBAL_BASE + U(0x40))
