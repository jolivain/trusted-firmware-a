...
#define PLATFORM_CORE_COUNT \
	(PLATFORM_CLUSTER_COUNT * PLATFORM_CORE_COUNT_PER_CLUSTER)
...
#define BL31_PROGBITS_LIMIT \
	U(VERSAL_NET_ATF_MEM_BASE + VERSAL_NET_ATF_MEM_PROGBITS_SIZE - 1)
#endif
#endif
...
#define PLAT_VERSAL_NET_G1S_IRQ_PROPS(grp)                                     \
	INTR_PROP_DESC(VERSAL_NET_IRQ_SEC_PHY_TIMER, GIC_HIGHEST_SEC_PRIORITY, \
