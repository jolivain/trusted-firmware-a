...
#define VERSAL_NET_CONSOLE_IS(con) \
	(VERSAL_NET_CONSOLE_ID_##con == VERSAL_NET_CONSOLE)
...
#define APU_PCIL_CORE_X_ISR_WAKE_REG(cpu_id) \
	(APU_PCLI + (CORE_0_ISR_WAKE_OFFSET + (APU_PCLI_CPU_STEP * (cpu_id))))
#define APU_PCIL_CORE_X_ISR_WAKE_MASK (0x00000001U)
#define CORE_0_IEN_WAKE_OFFSET (0x00000028ULL)
#define APU_PCIL_CORE_X_IEN_WAKE_REG(cpu_id) \
	(APU_PCLI + (CORE_0_IEN_WAKE_OFFSET + (APU_PCLI_CPU_STEP * (cpu_id))))
#define APU_PCIL_CORE_X_IEN_WAKE_MASK (0x00000001U)
#define CORE_0_IDS_WAKE_OFFSET (0x0000002CULL)
#define APU_PCIL_CORE_X_IDS_WAKE_REG(cpu_id) \
	(APU_PCLI + (CORE_0_IDS_WAKE_OFFSET + (APU_PCLI_CPU_STEP * (cpu_id))))
#define APU_PCIL_CORE_X_IDS_WAKE_MASK (0x00000001U)
#define CORE_0_ISR_POWER_OFFSET (0x00000010ULL)
#define APU_PCIL_CORE_X_ISR_POWER_REG(cpu_id) \
	(APU_PCLI + (CORE_0_ISR_POWER_OFFSET + (APU_PCLI_CPU_STEP * (cpu_id))))
#define APU_PCIL_CORE_X_ISR_POWER_MASK U(0x00000001)
#define CORE_0_IEN_POWER_OFFSET (0x00000018ULL)
#define APU_PCIL_CORE_X_IEN_POWER_REG(cpu_id) \
	(APU_PCLI + (CORE_0_IEN_POWER_OFFSET + (APU_PCLI_CPU_STEP * (cpu_id))))
#define APU_PCIL_CORE_X_IEN_POWER_MASK (0x00000001U)
#define CORE_0_IDS_POWER_OFFSET (0x0000001CULL)
#define APU_PCIL_CORE_X_IDS_POWER_REG(cpu_id) \
	(APU_PCLI + (CORE_0_IDS_POWER_OFFSET + (APU_PCLI_CPU_STEP * (cpu_id))))
