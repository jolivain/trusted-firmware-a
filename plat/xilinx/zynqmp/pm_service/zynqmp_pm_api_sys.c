...
/**
 * pm_secure_rsaaes() - Load the secure images. This function provides
 *                      access to the xilsecure library to load the
 *                      authenticated, encrypted, and authenticated/encrypted
 *                      images.
 * @address_low: lower 32-bit Linear memory space address.
 * @address_high: higher 32-bit Linear memory space address.
 * @size: Number of 32bit words.
...
/**
 * pm_aes_engine() - Aes data blob encryption/decryption. This function
 *                   provides access to the xilsecure library to
