...
#define ZYNQMP_ULPI_RESET_VAL_HIGH \
	(CRL_APB_BOOT_ENABLE_PIN_1 | CRL_APB_BOOT_DRIVE_PIN_1)
...
#define ZYNQMP_CSU_IDCODE_XILINX_ID_MASK \
	(0xFFFU << ZYNQMP_CSU_IDCODE_XILINX_ID_SHIFT)
...
#define ZYNQMP_CSU_IDCODE_DEVICE_CODE_MASK \
	(0xFU << ZYNQMP_CSU_IDCODE_DEVICE_CODE_SHIFT)
#define ZYNQMP_CSU_IDCODE_SUB_FAMILY_SHIFT 19U
#define ZYNQMP_CSU_IDCODE_SUB_FAMILY_MASK \
	(0x3U << ZYNQMP_CSU_IDCODE_SUB_FAMILY_SHIFT)
#define ZYNQMP_CSU_IDCODE_FAMILY_SHIFT 21U
#define ZYNQMP_CSU_IDCODE_FAMILY_MASK (0x7FU << ZYNQMP_CSU_IDCODE_FAMILY_SHIFT)
#define ZYNQMP_CSU_IDCODE_FAMILY 0x23

#define ZYNQMP_CSU_IDCODE_REVISION_SHIFT 28U
#define ZYNQMP_CSU_IDCODE_REVISION_MASK \
	(0xFU << ZYNQMP_CSU_IDCODE_REVISION_SHIFT)
