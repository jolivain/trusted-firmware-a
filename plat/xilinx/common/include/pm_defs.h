...
/* IOCTL IDs */
#define IOCTL_GET_RPU_OPER_MODE		0U
#define IOCTL_SET_RPU_OPER_MODE		1U
#define IOCTL_RPU_BOOT_ADDR_CONFIG	2U
#define IOCTL_TCM_COMB_CONFIG		3U
#define IOCTL_SET_TAPDELAY_BYPASS	4U
#define IOCTL_SET_SGMII_MODE		5U
#define IOCTL_SD_DLL_RESET		6U
#define IOCTL_SET_SD_TAPDELAY		7U
...
#define IOCTL_WRITE_GGS			12U
#define IOCTL_READ_GGS			13U
#define IOCTL_WRITE_PGGS		14U
#define IOCTL_READ_PGGS			15U
#define	IOCTL_SET_SGI			25U

/* IOCTL for ULPI reset */
#define IOCTL_ULPI_RESET		16U

/* Set healthy bit value */
#define IOCTL_SET_BOOT_HEALTH_STATUS	17U
#define IOCTL_AFI			18U

/* Probe counter read/write */
#define IOCTL_PROBE_COUNTER_READ	19U
#define IOCTL_PROBE_COUNTER_WRITE	20U
#define IOCTL_OSPI_MUX_SELECT		21U

/* IOCTL for USB power request */
#define IOCTL_USB_SET_STATE		22U

/* IOCTL to get last reset reason */
#define IOCTL_GET_LAST_RESET_REASON	23U

/* AI engine NPI ISR clear */
#define IOCTL_AIE_ISR_CLEAR		24U

/* Register SGI to ATF */
#define IOCTL_REGISTER_SGI		25U
