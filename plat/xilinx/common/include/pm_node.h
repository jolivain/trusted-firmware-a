...
#define NODEID(CLASS, SUBCLASS, TYPE, INDEX)	\
	     ((((CLASS) & (uint32_t)NODE_CLASS_MASK_BITS) << NODE_CLASS_SHIFT) | \
	     (((SUBCLASS) & (uint32_t)NODE_SUBCLASS_MASK_BITS) << NODE_SUBCLASS_SHIFT) | \
	     (((TYPE) & (uint32_t)NODE_TYPE_MASK_BITS) << NODE_TYPE_SHIFT) | \
	     (((INDEX) & (uint32_t)NODE_INDEX_MASK_BITS) << NODE_INDEX_SHIFT))
