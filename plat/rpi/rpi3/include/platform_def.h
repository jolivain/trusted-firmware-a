...
#define PLAT_RPI3_TM_HOLD_BASE \
	(PLAT_RPI3_TM_ENTRYPOINT + PLAT_RPI3_TM_ENTRYPOINT_SIZE)
#define PLAT_RPI3_TM_HOLD_ENTRY_SIZE ULL(8)
#define PLAT_RPI3_TM_HOLD_SIZE \
	(PLAT_RPI3_TM_HOLD_ENTRY_SIZE * PLATFORM_CORE_COUNT)

#define PLAT_RPI3_TRUSTED_MAILBOX_SIZE \
	(PLAT_RPI3_TM_ENTRYPOINT_SIZE + PLAT_RPI3_TM_HOLD_SIZE)
...
#define RPI3_OPTEE_PAGEABLE_LOAD_BASE \
	(BL32_DRAM_LIMIT - RPI3_OPTEE_PAGEABLE_LOAD_SIZE)
#endif
