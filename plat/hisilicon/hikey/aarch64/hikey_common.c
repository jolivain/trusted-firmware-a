...
#define MAP_ROM_PARAM                                     \
	MAP_REGION_FLAT(XG2RAM0_BASE, BL1_XG2RAM0_OFFSET, \
 ...
 */
#define MAP_MMC_SRAM                                                       \
	MAP_REGION_FLAT(HIKEY_BL1_MMC_DESC_BASE,                           \
			HIKEY_BL1_MMC_DESC_SIZE + HIKEY_BL1_MMC_DATA_SIZE, \
 ...
 */
#ifdef IMAGE_BL1
static const mmap_region_t hikey_mmap[] = { MAP_DEVICE,
					    MAP_ROM_PARAM,
					    MAP_MMC_SRAM,
					    { 0 } };
#endif
...
#ifdef IMAGE_BL2
static const mmap_region_t hikey_mmap[] = { MAP_DDR,
					    MAP_DEVICE,
					    MAP_TSP_MEM,
					    MAP_SRAM,
					    { 0 } };
...
#ifdef IMAGE_BL32
static const mmap_region_t hikey_mmap[] = { MAP_DEVICE, MAP_DDR, { 0 } };
#endif
