...
#define DDR_SDP_BASE (DDR_SEC_BASE - 0x400000 /* align */ - DDR_SDP_SIZE)
...
#define HIKEY_FB_DOWNLOAD_BASE (HIKEY_FB_BUFFER_BASE + HIKEY_FB_BUFFER_SIZE)
...
#define HIKEY_USB_DESC_EP0_OUT_BASE \
	(HIKEY_USB_DESC_IN_BASE + HIKEY_USB_DESC_IN_SIZE)
#define HIKEY_USB_DESC_EP0_OUT_SIZE 0x00040000
#define HIKEY_USB_DESC_EPX_OUT_BASE \
	(HIKEY_USB_DESC_EP0_OUT_BASE + HIKEY_USB_DESC_EP0_OUT_SIZE)
...
#define HIKEY_BL1_MMC_DATA_BASE \
	(HIKEY_BL1_MMC_DESC_BASE + HIKEY_BL1_MMC_DESC_SIZE)
