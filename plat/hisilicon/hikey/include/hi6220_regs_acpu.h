...
#define SRST_CLUSTER1                                                     \
	(SRST_PRESET1_RSTEN | SRST_CLUSTER1_RSTEN | SRST_L2_HPM_1_RSTEN | \
	 SRST_AARM_L2_1_RSTEN)
#define SRST_CLUSTER0                                                     \
	(SRST_PRESET0_RSTEN | SRST_CLUSTER0_RSTEN | SRST_L2_HPM_0_RSTEN | \
...
#define ACPU_SC_A53_x_MTCMOS_TIMER(x) \
	((x) ? ACPU_SC_A53_1_MTCMOS_TIMER : ACPU_SC_A53_0_MTCMOS_TIMER)
...
#define ACPU_SC_CPUx_CTRL(x) \
	((x < 8) ? (ACPU_SC_CPU0_CTRL + 0x100 * x) : ACPU_SC_CPU0_CTRL)
#define ACPU_SC_CPUx_STAT(x) \
	((x < 8) ? (ACPU_SC_CPU0_STAT + 0x100 * x) : ACPU_SC_CPU0_STAT)
#define ACPU_SC_CPUx_CLKEN(x) \
	((x < 8) ? (ACPU_SC_CPU0_CLKEN + 0x100 * x) : ACPU_SC_CPU0_CLKEN)
#define ACPU_SC_CPUx_CLK_STAT(x) \
	((x < 8) ? (ACPU_SC_CPU0_CLK_STAT + 0x100 * x) : ACPU_SC_CPU0_CLK_STAT)
#define ACPU_SC_CPUx_RSTEN(x) \
	((x < 8) ? (ACPU_SC_CPU0_RSTEN + 0x100 * x) : ACPU_SC_CPU0_RSTEN)
#define ACPU_SC_CPUx_RSTDIS(x) \
	((x < 8) ? (ACPU_SC_CPU0_RSTDIS + 0x100 * x) : ACPU_SC_CPU0_RSTDIS)
#define ACPU_SC_CPUx_MTCMOS_EN(x)                         \
	((x < 8) ? (ACPU_SC_CPU0_MTCMOS_EN + 0x100 * x) : \
		   ACPU_SC_CPU0_MTCMOS_EN)
#define ACPU_SC_CPUx_PW_ISODIS(x)                         \
	((x < 8) ? (ACPU_SC_CPU0_PW_ISODIS + 0x100 * x) : \
		   ACPU_SC_CPU0_PW_ISODIS)
#define ACPU_SC_CPUx_PW_ISO_STAT(x)                         \
	((x < 8) ? (ACPU_SC_CPU0_PW_ISO_STAT + 0x100 * x) : \
		   ACPU_SC_CPU0_PW_ISO_STAT)
#define ACPU_SC_CPUx_MTCMOS_TIMER_STAT(x)                         \
	((x < 8) ? (ACPU_SC_CPU0_MTCMOS_TIMER_STAT + 0x100 * x) : \
		   ACPU_SC_CPU0_MTCMOS_TIMER_STAT)
#define ACPU_SC_CPUx_RVBARADDR(x)                         \
	((x < 8) ? (ACPU_SC_CPU0_RVBARADDR + 0x100 * x) : \
		   ACPU_SC_CPU0_RVBARADDR)
...
#define HPM_OSC_DIV_VAL (0x56 << ACPU_SC_VD_HPM_CTRL_OSC_DIV_SHIFT)
#define HPM_OSC_DIV_MASK (ACPU_SC_VD_HPM_CTRL_OSC_DIV_MASK)

#define HPM_DLY_EXP_VAL (0xC7A << ACPU_SC_VD_HPM_CTRL_DLY_EXP_SHIFT)
#define HPM_DLY_EXP_MASK (ACPU_SC_VD_HPM_CTRL_DLY_EXP_MASK)
