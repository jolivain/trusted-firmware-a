...
DEFINE_SVC_UUID2(hisi_sip_svc_uid, 0x74df99e5, 0x8276, 0xaa40, 0x9f, 0xf8, 0xc0,
		 0x85, 0x52, 0xbc, 0x39, 0x3f);
 ...
 */
static uintptr_t hisi_sip_handler(unsigned int smc_fid, u_register_t x1,
				  ...
				  u_register_t flags)
{
	...
	case HISI_SIP_SVC_VERSION:
		...
		SMC_RET2(handle, HISI_SIP_SVC_VERSION_MAJOR,
...
DECLARE_RT_SVC(hisi_sip_svc, OEN_SIP_START, OEN_SIP_END, SMC_TYPE_FAST,
	       hisi_sip_setup, hisi_sip_handler);
