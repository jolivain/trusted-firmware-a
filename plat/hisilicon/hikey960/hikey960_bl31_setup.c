...
uint64_t fastboot_serno; // fastboot serial number consumed by plat_tbase.c
 ...
 * is to be determine on a per platform basis to accommodate usecases and memory
 * constraints.
...
{
	/* It turns out that fastboot complains if we have a 2nd data section:
	 * "Invalid sparse file format at header magic"
	 * So here we initialize the object stored in that place
	 */
