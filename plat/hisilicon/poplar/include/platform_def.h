...
#define POPLAR_OPTEE_PAGEABLE_LOAD_BASE \
	(BL32_DRAM_LIMIT - POPLAR_OPTEE_PAGEABLE_LOAD_SIZE) /* 0x03C0_0000 */
#endif
...
#define POPLAR_G1S_IRQ_PROPS(grp)                                             \
	INTR_PROP_DESC(HISI_IRQ_SEC_SGI_0, GIC_HIGHEST_SEC_PRIORITY, grp,     \
		       GIC_INTR_CFG_LEVEL),                                   \
		INTR_PROP_DESC(HISI_IRQ_SEC_SGI_1, GIC_HIGHEST_SEC_PRIORITY,  \
			       grp, GIC_INTR_CFG_LEVEL),                      \
		INTR_PROP_DESC(HISI_IRQ_SEC_SGI_2, GIC_HIGHEST_SEC_PRIORITY,  \
			       grp, GIC_INTR_CFG_LEVEL),                      \
		INTR_PROP_DESC(HISI_IRQ_SEC_SGI_3, GIC_HIGHEST_SEC_PRIORITY,  \
			       grp, GIC_INTR_CFG_LEVEL),                      \
		INTR_PROP_DESC(HISI_IRQ_SEC_SGI_4, GIC_HIGHEST_SEC_PRIORITY,  \
			       grp, GIC_INTR_CFG_LEVEL),                      \
		INTR_PROP_DESC(HISI_IRQ_SEC_SGI_5, GIC_HIGHEST_SEC_PRIORITY,  \
			       grp, GIC_INTR_CFG_LEVEL),                      \
		INTR_PROP_DESC(HISI_IRQ_SEC_SGI_6, GIC_HIGHEST_SEC_PRIORITY,  \
			       grp, GIC_INTR_CFG_LEVEL),                      \
		INTR_PROP_DESC(HISI_IRQ_SEC_SGI_7, GIC_HIGHEST_SEC_PRIORITY,  \
			       grp, GIC_INTR_CFG_LEVEL),                      \
		INTR_PROP_DESC(HISI_IRQ_SEC_TIMER0, GIC_HIGHEST_SEC_PRIORITY, \
			       grp, GIC_INTR_CFG_LEVEL),                      \
		INTR_PROP_DESC(HISI_IRQ_SEC_TIMER1, GIC_HIGHEST_SEC_PRIORITY, \
			       grp, GIC_INTR_CFG_LEVEL),                      \
		INTR_PROP_DESC(HISI_IRQ_SEC_TIMER2, GIC_HIGHEST_SEC_PRIORITY, \
			       grp, GIC_INTR_CFG_LEVEL),                      \
		INTR_PROP_DESC(HISI_IRQ_SEC_TIMER3, GIC_HIGHEST_SEC_PRIORITY, \
			       grp, GIC_INTR_CFG_LEVEL),                      \
		INTR_PROP_DESC(HISI_IRQ_SEC_AXI, GIC_HIGHEST_SEC_PRIORITY,    \
			       grp, GIC_INTR_CFG_LEVEL)
