...
/* GPIO */
#define GPIO_MAX (13)
#define GPIO_BASE(x) (x != 5 ? 0xf820000 + x * 0x1000 : 0xf8004000)
...
#define EMMC_INIT_PARAMS(base)                                              \
	{                                                                   \
		.bus_width = MMC_BUS_WIDTH_8, .clk_rate = 25 * 1000 * 1000, \
		.desc_base = (base), .desc_size = EMMC_DESC_SIZE,           \
		.flags = MMC_FLAG_CMD23, .reg_base = REG_BASE_MCI,          \
	}
