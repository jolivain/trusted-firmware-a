...
#define MAP_DDR MAP_REGION_FLAT(DDR_BASE, DDR_SIZE, MT_MEMORY | MT_RW | MT_NS)
...
#define MAP_OPTEE_PAGEABLE                               \
	MAP_REGION_FLAT(POPLAR_OPTEE_PAGEABLE_LOAD_BASE, \
			POPLAR_OPTEE_PAGEABLE_LOAD_SIZE, \
			MT_MEMORY | MT_RW | MT_SECURE)
#endif

static const mmap_region_t poplar_mmap[] = { MAP_DDR,
					     MAP_DEVICE,
					     MAP_TSP_MEM,
#ifdef SPD_opteed
					     MAP_OPTEE_PAGEABLE,
