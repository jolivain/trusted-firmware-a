...
static void ni_enable_fcu_ns_access(uintptr_t comp_addr)
{
	...
	for (uint32_t i = 0; i < subfeature_count; i++) {
		subfeature_type = NI_NODE_TYPE(mmio_read_32(comp_addr + NI_COMP_SUBFEATURE_TYPE(i)));
