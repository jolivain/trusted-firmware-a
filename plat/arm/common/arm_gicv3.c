...
static uintptr_t gicr_base_addrs[2] __unused = {
	PLAT_ARM_GICR_BASE,	/* GICR Base address of the primary CPU */
	0U			/* Zero Termination */
};

/* List of zero terminated GICR frame addresses which CPUs will probe */
static uintptr_t *gicr_frames = gicr_base_addrs;
 ...
 */
void plat_arm_override_gicr_frames(uintptr_t *plat_gicr_frames)
{
...
{
	int result;
	uintptr_t *plat_gicr_frames = gicr_frames;
