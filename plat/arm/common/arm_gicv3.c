 ...
 */
static volatile gicv3_redist_ctx_t rdist_ctx __section("arm_el3_tzc_dram") __used;
static volatile gicv3_dist_ctx_t dist_ctx __section("arm_el3_tzc_dram") __used;
