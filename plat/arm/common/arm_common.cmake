...
stgt_add_src(
    ...
    # TODO: if EL3_PAYLOAD_BASE=1 TODO: TBBR
)

target_link_libraries(bl1 PRIVATE common driver-io-fip driver-io-memmap driver-io-storage)
...
stgt_add_src(
    ...
    bl2
    SRC
    ${PROJECT_SOURCE_DIR}/drivers/delay_timer/delay_timer.c # TODO: this should
                                                            # be in
                                                            # platform.cmake?
    ...
    ${PROJECT_SOURCE_DIR}/plat/arm/common/arm_dyn_cfg_helpers.c
    ${PROJECT_SOURCE_DIR}/common/fdt_wrappers.c
    ${PROJECT_SOURCE_DIR}/plat/arm/common/${TFA_ARCH}/arm_bl2_mem_params_desc.c
    ${PROJECT_SOURCE_DIR}/plat/arm/common/arm_image_load.c
    ${PROJECT_SOURCE_DIR}/common/desc_image_load.c
    # TODO: if BL2_AT_EL3=1 TODO: if JUNO_AARCH32_EL3_RUNTIME=1 TODO: SPD TODO:
    # TBBR
)

target_link_libraries(bl2 PRIVATE driver-io-fip driver-io-memmap driver-io-storage)
...
stgt_add_src_cond(
    ...
    1
    SRC
    ${PROJECT_SOURCE_DIR}/plat/arm/common/arm_bl2_el3_setup.c)
...
stgt_add_src(
    ...
    # TODO: if SDEI_SUPPORT=1 TODO: if ENABLE_SPM=1
)
...
stgt_add_src_cond(
    ...
    1
    SRC
    ${PROJECT_SOURCE_DIR}/plat/arm/common/aarch64/execution_state_switch.c # TODO:
                                                                           # compare to
                                                                           # .mk
    ${PROJECT_SOURCE_DIR}/plat/arm/common/arm_sip_svc.c
    ${PROJECT_SOURCE_DIR}/lib/pmf/pmf_smc.c)

stgt_add_src(NAME bl1 bl2 SRC ${PROJECT_SOURCE_DIR}/lib/fconf/fconf.c
             ${PROJECT_SOURCE_DIR}/lib/fconf/fconf_dyn_cfg_getter.c)
