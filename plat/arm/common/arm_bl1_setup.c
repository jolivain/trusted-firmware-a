...
#if TRANSFER_LIST
static struct transfer_list_header *secure_tl = NULL;
#endif
...
void arm_bl1_platform_setup(void)
{
	...
	secure_tl = transfer_list_init((void *)FW_SECURE_HANDOFF_BASE,
				       FW_HANDOFF_SIZE);
...
int bl1_plat_handle_post_image_load(unsigned int image_id)
{
	...
	te = transfer_list_add(secure_tl, TL_TAG_SRAM_LAYOUT64, sizeof(meminfo_t),
			       NULL);
	assert(te != NULL);
