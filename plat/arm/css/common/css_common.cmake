...
# plat_bl_common
stgt_add_src(
    NAME bl1 bl2 bl31 SRC
    ${PROJECT_SOURCE_DIR}/plat/arm/css/common/${TFA_ARCH}/css_helpers.S)

stgt_get_param(NAME bl2 KEY CSS_USE_SCMI_SDS_DRIVER RET
               _css_use_scmi_sds_driver)
if(_css_use_scmi_sds_driver EQUAL 1)
    stgt_add_src(
        NAME bl1 bl2 bl31 SRC
        ${PROJECT_SOURCE_DIR}/drivers/arm/css/sds/${TFA_ARCH}/sds_helpers.S)
endif()
...
# plat_bl31
stgt_add_src(NAME bl31 SRC ${PROJECT_SOURCE_DIR}/plat/arm/css/common/css_pm.c
