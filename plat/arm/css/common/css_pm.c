...
static void css_cluster_on_dsu_pmu_context_restore(void)
{
#if PRESERVE_DSU_PMU_REGS
	int core_pos;
		...
		const psci_power_state_t *target_state)
{
	...
	if (CSS_CLUSTER_PWR_STATE(target_state) == ARM_LOCAL_STATE_OFF) {
		...
		css_cluster_on_dsu_pmu_context_restore();
...
static void css_cluster_off_dsu_pmu_context_save(void)
{
#if PRESERVE_DSU_PMU_REGS
...
static void css_power_down_common(const psci_power_state_t *target_state)
{
	...
	if (CSS_CLUSTER_PWR_STATE(target_state) == ARM_LOCAL_STATE_OFF) {
		...
		css_cluster_off_dsu_pmu_context_save();
