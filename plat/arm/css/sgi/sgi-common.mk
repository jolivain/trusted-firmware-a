...
ifeq ($(CSS_SGI_CHIP_COUNT), 0)
 $(error "Chip count for SGI/RD platforms should be either 1 or 2, currently \
 set to 0")
else ifeq ($(CSS_SGI_CHIP_COUNT),$(filter $(CSS_SGI_CHIP_COUNT),1 2))
else
 $(error  "Chip count for SGI/RD platforms should either 1 or 2")
endif
