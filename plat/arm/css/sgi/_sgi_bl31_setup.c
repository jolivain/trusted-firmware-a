...
static scmi_channel_plat_info_t rd_n1e1_edge_scmi_plat_info[] = {
	{
		.scmi_mbx_mem = CSS_SCMI_PAYLOAD_BASE,
		.db_base_addr = PLAT_CSS_MHU_BASE,
	...
	},
	{
		.scmi_mbx_mem = CSS_SCMI_PAYLOAD_BASE,
		.db_base_addr = PLAT_CSS_MHU_BASE
			+ PLAT_ARM_SGI_REMOTE_CHIP_MEM_OFFSET(1),
		.db_reg_addr = PLAT_CSS_MHU_BASE
			+ PLAT_ARM_SGI_REMOTE_CHIP_MEM_OFFSET(1) + SENDER_REG_SET(0),
		.db_preserve_mask = 0xfffffffe,
		.db_modify_mask = 0x1,
		.ring_doorbell = &mhuv2_ring_doorbell,
	},
	{
		.scmi_mbx_mem = CSS_SCMI_PAYLOAD_BASE +
			PLAT_ARM_SGI_REMOTE_CHIP_MEM_OFFSET(2),
		.db_base_addr = PLAT_CSS_MHU_BASE +
			PLAT_ARM_SGI_REMOTE_CHIP_MEM_OFFSET(2),
		.db_reg_addr = PLAT_CSS_MHU_BASE +
			PLAT_ARM_SGI_REMOTE_CHIP_MEM_OFFSET(2) + SENDER_REG_SET(0),
		.db_preserve_mask = 0xfffffffe,
		.db_modify_mask = 0x1,
		.ring_doorbell = &mhuv2_ring_doorbell,
	},
	{
		.scmi_mbx_mem = CSS_SCMI_PAYLOAD_BASE +
			PLAT_ARM_SGI_REMOTE_CHIP_MEM_OFFSET(3),
		.db_base_addr = PLAT_CSS_MHU_BASE +
			PLAT_ARM_SGI_REMOTE_CHIP_MEM_OFFSET(3),
		.db_reg_addr = PLAT_CSS_MHU_BASE +
			PLAT_ARM_SGI_REMOTE_CHIP_MEM_OFFSET(3) + SENDER_REG_SET(0),
		.db_preserve_mask = 0xfffffffe,
		.db_modify_mask = 0x1,
		.ring_doorbell = &mhuv2_ring_doorbell,
	},
...
scmi_channel_plat_info_t *plat_css_get_scmi_info(int channel_no)
{
	if (sgi_plat_info.platform_id == RD_N1E1_EDGE_SID_VER_PART_NUM)
		return &(rd_n1e1_edge_scmi_plat_info[channel_no]);
