...
PLAT_COMMON_SOURCES	:=	plat/arm/board/fvp_r/fvp_r_common.c
...
PLAT_COMMON_SOURCES	+=	${MBEDTLS_SOURCES}				\
				${FVP_R_AUTH_SOURCES}
endif

ifeq (${USE_SP804_TIMER},1)
PLAT_COMMON_SOURCES		+=	drivers/arm/sp804/sp804_delay_timer.c
else
PLAT_COMMON_SOURCES		+=	drivers/delay_timer/generic_delay_timer.c
endif
...
PLAT_COMMON_SOURCES	+=	plat/arm/board/fvp_r/fvp_r_stack_protector.c
endif
