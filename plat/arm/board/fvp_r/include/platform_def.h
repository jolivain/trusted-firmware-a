...
#define PLATFORM_CORE_COUNT                                       \
	(U(FVP_R_CLUSTER_COUNT) * U(FVP_R_MAX_CPUS_PER_CLUSTER) * \
	 U(FVP_R_MAX_PE_PER_CPU))

#define PLAT_NUM_PWR_DOMAINS \
	(U(FVP_R_CLUSTER_COUNT) + PLATFORM_CORE_COUNT + U(1))
...
#define PLAT_BL1_RO_LIMIT (BL1_RO_BASE + PLAT_ARM_TRUSTED_ROM_SIZE)
