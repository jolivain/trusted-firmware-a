...
CORSTONE700_PLAT_COMMON = corstone700
...
BL32_SOURCES		+=	plat/arm/common/aarch32/arm_helpers.S	\
				...
				plat/arm/board/${CORSTONE700_PLAT_COMMON}/drivers/mhu/mhu.c

PLAT_INCLUDES		:=	-Iplat/arm/board/${CORSTONE700_PLAT_COMMON}/include	\
				-Iinclude/plat/arm/common	\
				-Iplat/arm/board/${CORSTONE700_PLAT_COMMON}/drivers/mhu
...
#Device tree
CORSTONE700_HW_CONFIG_DTS	:=	fdts/${PLAT}.dts
