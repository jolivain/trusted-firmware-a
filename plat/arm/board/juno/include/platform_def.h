...
#define PLAT_NUM_PWR_DOMAINS \
	(ARM_SYSTEM_COUNT + JUNO_CLUSTER_COUNT + PLATFORM_CORE_COUNT)
#define PLATFORM_CORE_COUNT \
	(JUNO_CLUSTER0_CORE_COUNT + JUNO_CLUSTER1_CORE_COUNT)
...
#define ARM_DTB_DRAM_NS                                                  \
	MAP_REGION_FLAT(JUNO_DTB_DRAM_MAP_START, JUNO_DTB_DRAM_MAP_SIZE, \
...
#define PLAT_ARM_G1S_IRQ_PROPS(grp)                                            \
	CSS_G1S_IRQ_PROPS(grp), ARM_G1S_IRQ_PROPS(grp),                        \
		...
		INTR_PROP_DESC(JUNO_IRQ_USB_SMMU, GIC_HIGHEST_SEC_PRIORITY,    \
			       (grp), GIC_INTR_CFG_LEVEL),                     \
		INTR_PROP_DESC(JUNO_IRQ_THIN_LINKS_SMMU,                       \
