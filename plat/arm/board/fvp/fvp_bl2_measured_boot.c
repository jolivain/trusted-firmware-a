...
struct rss_mboot_metadata fvp_rss_mboot_metadata[] = {
	{.id = BL31_IMAGE_ID,	 .slot = U(7),	.sw_type = RSS_MBOOT_BL31_STRING,	   .lock_measurement = true },
	{.id = HW_CONFIG_ID,	 .slot = U(8),	.sw_type = RSS_MBOOT_HW_CONFIG_STRING,	   .lock_measurement = true },
	{.id = SOC_FW_CONFIG_ID, .slot = U(9),	.sw_type = RSS_MBOOT_SOC_FW_CONFIG_STRING, .lock_measurement = true },
	{.id = RMM_IMAGE_ID,	 .slot = U(10),	.sw_type = RSS_MBOOT_RMM_STRING,	   .lock_measurement = true },
