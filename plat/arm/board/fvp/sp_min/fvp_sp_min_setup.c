...
#if !RESET_TO_SP_MIN && !BL2_AS_ENTRY_POINT
...
#endif /* !RESET_TO_SP_MIN && !BL2_AS_ENTRY_POINT */
...
void sp_min_plat_arch_setup(void)
{
	 ...
	 * gets deprecated.
	 */
#if !RESET_TO_SP_MIN && !BL2_AS_ENTRY_POINT && !ARM_XLAT_TABLES_LIB_V1
...
#endif /*!RESET_TO_SP_MIN && !BL2_AS_ENTRY_POINT && !ARM_XLAT_TABLES_LIB_V1*/
}
