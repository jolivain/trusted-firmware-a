...
#if !RESET_TO_SP_MIN && !BL2_WITHOUT_BL1
...
#endif /* !RESET_TO_SP_MIN && !BL2_WITHOUT_BL1 */
...
void sp_min_plat_arch_setup(void)
{
	 ...
	 * Also, BL2 skips loading HW_CONFIG dtb for BL2_WITHOUT_BL1 builds.
	 ...
	 * gets deprecated.
	 */
#if !RESET_TO_SP_MIN && !BL2_WITHOUT_BL1 && !ARM_XLAT_TABLES_LIB_V1
...
#endif /* !RESET_TO_SP_MIN && !BL2_WITHOUT_BL1 && !ARM_XLAT_TABLES_LIB_V1 */
}
