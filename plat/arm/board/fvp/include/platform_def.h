...
#define PLATFORM_CORE_COUNT                                   \
	(U(FVP_CLUSTER_COUNT) * U(FVP_MAX_CPUS_PER_CLUSTER) * \
	 U(FVP_MAX_PE_PER_CPU))

#define PLAT_NUM_PWR_DOMAINS (U(FVP_CLUSTER_COUNT) + PLATFORM_CORE_COUNT + U(1))
...
#define ARM_DTB_DRAM_NS                                                \
	MAP_REGION_FLAT(FVP_DTB_DRAM_MAP_START, FVP_DTB_DRAM_MAP_SIZE, \
...
#define PLAT_ARM_MAX_BL31_SIZE \
	(PLAT_ARM_TRUSTED_SRAM_SIZE - ARM_SHARED_RAM_SIZE - ARM_L0_GPT_SIZE)
#else
/*
...
#define PLAT_ARM_G1S_IRQ_PROPS(grp)                                       \
	ARM_G1S_IRQ_PROPS(grp),                                           \
		...
		INTR_PROP_DESC(FVP_IRQ_SEC_SYS_TIMER,                     \
