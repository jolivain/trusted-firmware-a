...
#define PLAT_ARM_DRAM3_END	(PLAT_ARM_DRAM3_BASE + PLAT_ARM_DRAM3_SIZE - 1U)

#define PLAT_ARM_DRAM4_BASE	ULL(0x88000000000) /* 44-bit range */
#define PLAT_ARM_DRAM4_SIZE	ULL(0x78000000000) /* 7.5 TB */
#define PLAT_ARM_DRAM4_END	(PLAT_ARM_DRAM4_BASE + PLAT_ARM_DRAM4_SIZE - 1U)

#define PLAT_ARM_DRAM5_BASE	ULL(0x880000000000) /* 48-bit range */
#define PLAT_ARM_DRAM5_SIZE	ULL(0x780000000000) /* 120 TB */
#define PLAT_ARM_DRAM5_END	(PLAT_ARM_DRAM5_BASE + PLAT_ARM_DRAM5_SIZE - 1U)

#define PLAT_ARM_DRAM6_BASE	ULL(0x8800000000000) /* 52-bit range */
#define PLAT_ARM_DRAM6_SIZE	ULL(0x7800000000000) /* 1920 TB */
#define PLAT_ARM_DRAM6_END	(PLAT_ARM_DRAM6_BASE + PLAT_ARM_DRAM6_SIZE - 1U)
