...
#define PLAT_FVP_BL2_ROMLIB_OPTIMIZATION UL(0x6000)
#else
#define PLAT_ARM_MAX_ROMLIB_RW_SIZE	UL(0)
#define PLAT_ARM_MAX_ROMLIB_RO_SIZE	UL(0)
#define PLAT_FVP_BL2_ROMLIB_OPTIMIZATION UL(0)
#endif
...
# define PLAT_ARM_MAX_BL2_SIZE	(UL(0x1D000) - PLAT_FVP_BL2_ROMLIB_OPTIMIZATION)
#else
# define PLAT_ARM_MAX_BL2_SIZE	(UL(0x11000) - PLAT_FVP_BL2_ROMLIB_OPTIMIZATION)
#endif
