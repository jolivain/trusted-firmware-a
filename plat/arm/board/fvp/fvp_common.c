...
#endif
#ifdef FW_SECURE_HANDOFF_BASE
#define MAP_FW_SECURE_HANDOFF                                    \
	MAP_REGION_FLAT(FW_SECURE_HANDOFF_BASE, FW_HANDOFF_SIZE, \
...
#endif
#ifdef MAP_FW_SECURE_HANDOFF
	MAP_FW_SECURE_HANDOFF,
#endif
	{ 0 }
};
#endif
