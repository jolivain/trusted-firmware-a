...
#if SPMC_AT_EL3
/*
 * On the FVP platform when using the EL3 SPMC implementation allocate the datastore
 * for tracking shared memory descriptors in the TZC DRAM section to ensure
 * sufficient storage can be allocated.
