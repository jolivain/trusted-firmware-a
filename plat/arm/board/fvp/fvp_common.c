...
int plat_rmmd_load_manifest(struct rmm_manifest *manifest)
{
	...
	assert((console_ptr + (sizeof(struct console_info) * plat_console.consoles) - manifest)
	...
	memset((void *)console_ptr, '\0', sizeof(struct console_info));
	...
	strlcpy(console_ptr[0].name, FVP_RMM_CONSOLE_NAME, RMMD_CONSOLE_MAX_NAME_LEN-1UL);
