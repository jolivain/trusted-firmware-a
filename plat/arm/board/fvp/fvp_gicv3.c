...
void plat_arm_gic_driver_init(void)
{
	...
	arm_gic_data.gicd_base = FCONF_GET_PROPERTY(hw_config, gicv3_config, gicd_base);
	gicr_base_addrs[0] = FCONF_GET_PROPERTY(hw_config, gicv3_config, gicr_base);
#endif
	...
	if (gicv3_rdistif_probe((uintptr_t)gicr_base_addrs[0]) == -1) {
