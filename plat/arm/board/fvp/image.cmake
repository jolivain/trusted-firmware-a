...
set(_fiptool_args
    ...
    --tb-fw
    ${CMAKE_BINARY_DIR}/bl2.bin
    # TODO: retrieve this path from the config or command line --nt-fw
    # ${PROJECT_SOURCE_DIR}/../tf-a-tests/build/fvp/debug/tftf.bin
)
...
add_custom_target(
    fip ALL
    DEPENDS bl2
            $<$<STREQUAL:${TFA_ARCH},aarch64>:bl31>
            $<$<BOOL:${AARCH32_SP}>:bl32>
            ${CMAKE_BINARY_DIR}/hw.dtb
            ${CMAKE_BINARY_DIR}/tb_fw.dtb
            ${CMAKE_BINARY_DIR}/nt_fw.dtb
            ${CMAKE_BINARY_DIR}/fw.dtb
            $<$<STREQUAL:${TFA_ARCH},aarch64>:${CMAKE_BINARY_DIR}/soc_fw.dtb>
