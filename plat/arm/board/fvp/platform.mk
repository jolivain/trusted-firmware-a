...
FVP_GIC_SOURCES		:=	${GICV3_SOURCES}			\
	...
	ifeq ($(filter 1,${BL2_AS_ENTRY_POINT} \
...
ifeq ($(filter 1,${BL2_AS_ENTRY_POINT} ${RESET_TO_BL31}),)
...
ifeq ($(filter 1,${BL2_AS_ENTRY_POINT} ${ARM_XLAT_TABLES_LIB_V1}),)
    ifeq (${ARCH},aarch32)
