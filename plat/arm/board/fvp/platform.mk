...
FVP_GIC_SOURCES		:=	${GICV3_SOURCES}			\
	...
	ifeq ($(filter 1,${BL2_WITHOUT_BL1} ${RESET_TO_BL31} ${RESET_TO_SP_MIN}),)
...
ifeq ($(filter 1,${BL2_WITHOUT_BL1} ${RESET_TO_BL31}),)
...
ifeq ($(filter 1,${BL2_WITHOUT_BL1} ${ARM_XLAT_TABLES_LIB_V1}),)
    ifeq (${ARCH},aarch32)
