...
#if !RESET_TO_BL31 && !BL2_AS_ENTRY_POINT
...
#endif /* !RESET_TO_BL31 && !BL2_AS_ENTRY_POINT */
...
void __init bl31_plat_arch_setup(void)
{
	 ...
	 * gets deprecated.
	 */
#if !RESET_TO_BL31 && !BL2_AS_ENTRY_POINT && !ARM_XLAT_TABLES_LIB_V1
	assert(hw_config_info != NULL);
...
#endif /* !RESET_TO_BL31 && !BL2_AS_ENTRY_POINT && !ARM_XLAT_TABLES_LIB_V1 */
}
