...
#if !RESET_TO_BL31 && !BL2_WITHOUT_BL1
...
#endif /* !RESET_TO_BL31 && !BL2_WITHOUT_BL1 */
...
void __init bl31_plat_arch_setup(void)
{
	 ...
	 * gets deprecated.
	 */
#if !RESET_TO_BL31 && !BL2_WITHOUT_BL1 && !ARM_XLAT_TABLES_LIB_V1
	assert(hw_config_info != NULL);
...
#endif /* !RESET_TO_BL31 && !BL2_WITHOUT_BL1 && !ARM_XLAT_TABLES_LIB_V1 */
}
