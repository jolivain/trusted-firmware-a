...
#define SPMD_LP_PARTITION_ID EL3_SPMD_LP_ID_START
...
static void fvp_get_partition_info(void)
{
	...
	if (!spmd_el3_partition_info_get(target_uuid, 0, 0, &ret))
		panic();
