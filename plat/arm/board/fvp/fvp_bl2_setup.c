...
struct bl_params *plat_get_next_bl_params(void)
{
	...
	/* Ensure the memory descriptors are copied into ARM_BL2_MEM_DESC_BASE when
	 * firmware handoff is disabled. This should happen first or param_node below will point to the structure defined in static memory.
	 */
#if !TRANSFER_LIST
	...
	flush_dcache_range((uintptr_t)arm_bl_params->head->ep_info,
