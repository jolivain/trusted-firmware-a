...
#define PLATFORM_CORE_COUNT                                           \
	(PLAT_ARM_CLUSTER_COUNT * CORSTONE1000_MAX_CPUS_PER_CLUSTER * \
...
#define PLAT_ARM_TRUSTED_SRAM_SIZE \
	(TOTAL_SRAM_SIZE - ARM_NS_SHARED_RAM_SIZE - ARM_SHARED_RAM_SIZE)
...
#define BL2_BASE (BL2_LIMIT - PLAT_ARM_MAX_BL2_SIZE + BL2_SIGNATURE_SIZE)
#define BL2_LIMIT (ARM_BL_RAM_BASE + ARM_BL_RAM_SIZE)

#define BL31_BASE (BL2_SIGNATURE_BASE - PLAT_ARM_MAX_BL31_SIZE)
#define BL31_LIMIT BL2_SIGNATURE_BASE

#define CORSTONE1000_TOS_FW_CONFIG_BASE \
	(BL31_BASE - CORSTONE1000_TOS_FW_CONFIG_SIZE)
...
#define ARM_NS_SHARED_RAM_BASE                     \
	(ARM_TRUSTED_SRAM_BASE + TOTAL_SRAM_SIZE - \
	 (PLAT_ARM_MAX_BL31_SIZE + PLAT_ARM_MAX_BL32_SIZE))
...
#define ARM_FW_CONFIG_LIMIT (ARM_SHARED_RAM_BASE + (ARM_SHARED_RAM_SIZE >> 1))
...
#define CORSTONE1000_EXTERNAL_FLASH                           \
	MAP_REGION_FLAT(PLAT_ARM_NVM_BASE, PLAT_ARM_NVM_SIZE, \
...
#define ARM_MAP_NS_SHARED_RAM                                           \
	MAP_REGION_FLAT(ARM_NS_SHARED_RAM_BASE, ARM_NS_SHARED_RAM_SIZE, \
...
#define ARM_MAP_BL_CONFIG_REGION                                    \
	MAP_REGION_FLAT(ARM_FW_CONFIG_BASE,                         \
...
#define CORSTONE1000_MAP_DEVICE                                             \
	MAP_REGION_FLAT(CORSTONE1000_DEVICE_BASE, CORSTONE1000_DEVICE_SIZE, \
			MT_DEVICE | MT_RW | MT_SECURE)
