...
static pas_region_t pas_regions[] = {
	...
	NRD_PAS_SECURE_SRAM_ERB_RSS,
	NRD_PAS_NS_SRAM_ERB_RSS,
	NRD_PAS_ROOT_SRAM_ERB_RSS,
	NRD_PAS_REALM_SRAM_ERB_RSS,
	NRD_PAS_RSS_SECURE_SRAM_ERB_RSM,
	NRD_PAS_RSS_NS_SRAM_ERB_RSM,
	...
	NRD_PAS_AP_RSS_NS_MHU,
	NRD_PAS_AP_RSS_SECURE_MHU,
	NRD_PAS_AP_RSS_ROOT_MHU,
	NRD_PAS_AP_RSS_REALM_MHU,
	NRD_PAS_SCP_MCP_RSS_CROSS_CHIP_MHU,
	NRD_PAS_SYNCNT_MSTUPDTVAL_ADDR,
	NRD_PAS_STM_SYSTEM_ITS,
	NRD_PAS_SCP_MCP_RSS_SHARED_SRAM,
	NRD_PAS_GIC,
	NRD_PAS_MMIO_L,
	NRD_PAS_NS_DRAM,
