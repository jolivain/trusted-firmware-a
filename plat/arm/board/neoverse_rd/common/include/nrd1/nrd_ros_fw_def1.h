 ...
 *
 * This file is limited to include the RoS firmware specific definitions for
 * platforms based on the A75, N1 and V1 CPUs. RoS (Rest Of System) is used
 * to refer to the part of the reference design platform that excludes CSS.
 */
