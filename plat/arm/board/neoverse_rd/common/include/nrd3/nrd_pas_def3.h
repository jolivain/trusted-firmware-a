 ...
 * 0x2A57FFFF       |        |       |       |RECORD BLOCK - RSS       |
 * ---------------------------------------------------------------------
 * 0x2A580000       |64KB    |L1 GPT |NS     |NS SRAM ERROR            |
 * 0x2A58FFFF       |        |       |       |RECORD BLOCK - RSS       |
 * ---------------------------------------------------------------------
 * 0x2A590000       |64KB    |L1 GPT |ROOT   |ROOT SRAM ERROR          |
 * 0x2A59FFFF       |        |       |       |RECORD BLOCK - RSS       |
 * ---------------------------------------------------------------------
 * 0x2A5A0000       |64KB    |L1 GPT |REALM  |REALM SRAM ERROR         |
 * 0x2A5AFFFF       |        |       |       |RECORD BLOCK - RSS       |
 * ---------------------------------------------------------------------
 * 0x2A5B0000       |64KB    |L1 GPT |SECURE |RSS SECURE SRAM ERROR    |
 * 0x2A5BFFFF       |        |       |       |RECORD BLOCK - RSM       |
 * ---------------------------------------------------------------------
 * 0x2A5C0000       |64KB    |L1 GPT |NS     |RSS NS SRAM ERROR        |
 ...
 * 0x2AB1FFFF       |        |       |       |MHU                      |
 * ---------------------------------------------------------------------
 * 0x2AB20000       |128KB   |L1 GPT |SECURE |AP-RSS SECURE            |
 * 0x2AB3FFFF       |        |       |       |MHU                      |
 * ---------------------------------------------------------------------
 * 0x2AB40000       |128KB   |L1 GPT |ROOT   |AP-RSS ROOT              |
 * 0x2AB5FFFF       |        |       |       |MHU                      |
 * ---------------------------------------------------------------------
 * 0x2AB60000       |128KB   |L1 GPT |REALM  |AP-RSS REALM             |
 * 0x2AB7FFFF       |        |       |       |MHU                      |
 * ---------------------------------------------------------------------
 * 0x2AC00000       |1152KB  |L1 GPT |ROOT   |SCP MCP RSS              |
 ...
 * 0x37FFFFFF       |        |       |       |                         |
 * ---------------------------------------------------------------------
 * 0x60000000       |512MB   |L1 GPT |ANY    |MMIO_L                   |
 * 0x7FFFFFFF       |        |       |       |                         |
 * ---------------------------------------------------------------------
 ...
 * 0x104FFFFFFF     |        |       |       |                         |
 * ---------------------------------------------------------------------
 * 0x4000000000     |258GB   |L1 GPT |ANY    |MMIO_H                   |
 * 0x807FFFFFFF     |        |       |       |                         |
 * ---------------------------------------------------------------------
...
#define NRD_PAS_SECURE_SRAM_ERB_RSS					\
		GPT_MAP_REGION_GRANULE(					\
			NRD_CSS_SECURE_SRAM_ERB_RSS_BASE,		\
			NRD_CSS_SECURE_SRAM_ERB_RSS_SIZE,		\
			GPT_GPI_SECURE)

#define NRD_PAS_NS_SRAM_ERB_RSS						\
		GPT_MAP_REGION_GRANULE(					\
			NRD_CSS_NS_SRAM_ERB_RSS_BASE,			\
			NRD_CSS_NS_SRAM_ERB_RSS_SIZE,			\
			GPT_GPI_NS)

#define NRD_PAS_ROOT_SRAM_ERB_RSS					\
		GPT_MAP_REGION_GRANULE(					\
			NRD_CSS_ROOT_SRAM_ERB_RSS_BASE,			\
			NRD_CSS_ROOT_SRAM_ERB_RSS_SIZE,			\
			GPT_GPI_ROOT)

#define NRD_PAS_REALM_SRAM_ERB_RSS					\
		GPT_MAP_REGION_GRANULE(					\
			NRD_CSS_REALM_SRAM_ERB_RSS_BASE,		\
			NRD_CSS_REALM_SRAM_ERB_RSS_SIZE,		\
			GPT_GPI_REALM)

#define NRD_PAS_RSS_SECURE_SRAM_ERB_RSM					\
		GPT_MAP_REGION_GRANULE(					\
			NRD_CSS_RSS_SECURE_SRAM_ERB_RSM_BASE,		\
			NRD_CSS_RSS_SECURE_SRAM_ERB_RSM_SIZE,		\
			GPT_GPI_SECURE)

#define NRD_PAS_RSS_NS_SRAM_ERB_RSM					\
		GPT_MAP_REGION_GRANULE(					\
			NRD_CSS_RSS_NS_SRAM_ERB_RSM_BASE,		\
			NRD_CSS_RSS_NS_SRAM_ERB_RSM_SIZE,		\
			GPT_GPI_NS)
...
#define NRD_PAS_AP_RSS_NS_MHU						\
		GPT_MAP_REGION_GRANULE(					\
			NRD_CSS_AP_RSS_NS_MHU_BASE,			\
			NRD_CSS_AP_RSS_NS_MHU_SIZE,			\
			GPT_GPI_NS)

#define NRD_PAS_AP_RSS_SECURE_MHU					\
		GPT_MAP_REGION_GRANULE(					\
			NRD_CSS_AP_RSS_SECURE_MHU_BASE,			\
			NRD_CSS_AP_RSS_SECURE_MHU_SIZE,			\
			GPT_GPI_SECURE)

#define NRD_PAS_AP_RSS_ROOT_MHU						\
		GPT_MAP_REGION_GRANULE(					\
			NRD_CSS_AP_RSS_ROOT_MHU_BASE,			\
			NRD_CSS_AP_RSS_ROOT_MHU_SIZE,			\
			GPT_GPI_ROOT)

#define NRD_PAS_AP_RSS_REALM_MHU					\
		GPT_MAP_REGION_GRANULE(					\
			NRD_CSS_AP_RSS_REALM_MHU_BASE,			\
			NRD_CSS_AP_RSS_REALM_MHU_SIZE,			\
			GPT_GPI_REALM)

#define NRD_PAS_SCP_MCP_RSS_CROSS_CHIP_MHU				\
		GPT_MAP_REGION_GRANULE(					\
			NRD_CSS_SCP_MCP_RSS_CROSS_CHIP_MHU_BASE,	\
			NRD_CSS_SCP_MCP_RSS_CROSS_CHIP_MHU_SIZE,	\
			GPT_GPI_ROOT)
...
#define NRD_PAS_SCP_MCP_RSS_SHARED_SRAM					\
		GPT_MAP_REGION_GRANULE(					\
			NRD_CSS_SCP_MCP_RSS_SHARED_SRAM_BASE,		\
			NRD_CSS_SCP_MCP_RSS_SHARED_SRAM_SIZE,		\
			GPT_GPI_ANY)
