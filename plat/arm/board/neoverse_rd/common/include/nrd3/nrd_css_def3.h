...
/* SRAM Secure Error Record Block - RSS */
#define NRD_CSS_SECURE_SRAM_ERB_RSS_BASE	UL(0x2A570000)
#define NRD_CSS_SECURE_SRAM_ERB_RSS_SIZE	UL(0x00010000)

/* SRAM NS Error Record Block - RSS */
#define NRD_CSS_NS_SRAM_ERB_RSS_BASE		UL(0x2A580000)
#define NRD_CSS_NS_SRAM_ERB_RSS_SIZE		UL(0x00010000)

/* SRAM Root Error Record Block - RSS */
#define NRD_CSS_ROOT_SRAM_ERB_RSS_BASE		UL(0x2A590000)
#define NRD_CSS_ROOT_SRAM_ERB_RSS_SIZE		UL(0x00010000)

/* SRAM Realm Error Record Block - RSS */
#define NRD_CSS_REALM_SRAM_ERB_RSS_BASE		UL(0x2A5A0000)
#define NRD_CSS_REALM_SRAM_ERB_RSS_SIZE		UL(0x00010000)

/* RSS SRAM Secure Error Record Block - RSM */
#define NRD_CSS_RSS_SECURE_SRAM_ERB_RSM_BASE	UL(0x2A5B0000)
#define NRD_CSS_RSS_SECURE_SRAM_ERB_RSM_SIZE	UL(0x00010000)

/* RSS SRAM Secure Error Record Block - RSM */
#define NRD_CSS_RSS_NS_SRAM_ERB_RSM_BASE	UL(0x2A5C0000)
#define NRD_CSS_RSS_NS_SRAM_ERB_RSM_SIZE	UL(0x00010000)
...
/* AP - RSS NS MHU */
#define NRD_CSS_AP_RSS_NS_MHU_BASE		UL(0x2AB00000)
#define NRD_CSS_AP_RSS_NS_MHU_SIZE		UL(0x00020000)

/* AP - RSS Secure MHU */
#define NRD_CSS_AP_RSS_SECURE_MHU_BASE		UL(0x2AB20000)
#define NRD_CSS_AP_RSS_SECURE_MHU_SIZE		UL(0x00020000)

/* AP - RSS Root MHU */
#define NRD_CSS_AP_RSS_ROOT_MHU_BASE		UL(0x2AB40000)
#define NRD_CSS_AP_RSS_ROOT_MHU_SIZE		UL(0x00020000)

/* AP - RSS Realm MHU */
#define NRD_CSS_AP_RSS_REALM_MHU_BASE		UL(0x2AB60000)
#define NRD_CSS_AP_RSS_REALM_MHU_SIZE		UL(0x00020000)

/* SCP - MCP - RSS Cross chip MHU */
#define NRD_CSS_SCP_MCP_RSS_CROSS_CHIP_MHU_BASE	UL(0x2AC00000)
#define NRD_CSS_SCP_MCP_RSS_CROSS_CHIP_MHU_SIZE	UL(0x00120000)
...
/* SCP - MCP - RSS Shared SRAM */
#define NRD_CSS_SCP_MCP_RSS_SHARED_SRAM_BASE	UL(0x2F000000)
#define NRD_CSS_SCP_MCP_RSS_SHARED_SRAM_SIZE	UL(0x00400000)
...
/* PCIe MMIO Low */
#define NRD_CSS_MMIO_L_BASE			UL(0x60000000)
#define NRD_CSS_MMIO_L_SIZE			UL(0x20000000)
...
/* PCIe ECAM */
#define NRD_CSS_ECAM_BASE			ULL(0x1010000000)
#define NRD_CSS_ECAM_SIZE			UL(0x40000000)

/* PCIe MMIO High */
#define NRD_CSS_MMIO_H_BASE			ULL(0x4000000000)
#define NRD_CSS_MMIO_H_SIZE			ULL(0x4080000000)
...
#define AP_RSS_ROOT_MHU_V3_PBX		NRD_CSS_AP_RSS_ROOT_MHU_BASE
#define AP_RSS_ROOT_MHU_V3_MBX		NRD_CSS_AP_RSS_ROOT_MHU_BASE + \
						MHU_V3_MBX_FRAME_OFFSET

#define AP_RSS_SECURE_MHU_V3_PBX	NRD_CSS_AP_RSS_SECURE_MHU_BASE
#define AP_RSS_SECURE_MHU_V3_MBX	NRD_CSS_AP_RSS_SECURE_MHU_BASE + \
						MHU_V3_MBX_FRAME_OFFSET
