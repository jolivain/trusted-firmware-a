 ...
 * definitions for the platforms based on the N2/V2 CPUs. The common platform
 * support for Arm platforms expect platforms to define certain definitions and
 * those definitions are referred to as the platform port definitions.
 */
