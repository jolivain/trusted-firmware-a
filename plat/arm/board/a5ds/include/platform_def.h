...
#define ARM_BL_RAM_BASE (A5DS_SHARED_RAM_BASE + A5DS_SHARED_RAM_SIZE)
#define ARM_BL_RAM_SIZE \
	(PLAT_ARM_BL_PLUS_SHARED_RAM_SIZE - A5DS_SHARED_RAM_SIZE)
 ...
 * initialized.
 */
#define ARM_NS_DRAM1_SIZE (ARM_DRAM1_SIZE - BOOT_SIZE - 0x00200000)

#define MAP_BOOT_RW \
	MAP_REGION_FLAT(BOOT_BASE, BOOT_SIZE, MT_DEVICE | MT_RW | MT_SECURE)

#define ARM_MAP_SHARED_RAM                                          \
	MAP_REGION_FLAT(A5DS_SHARED_RAM_BASE, A5DS_SHARED_RAM_SIZE, \
...
#define ARM_MAP_SRAM \
	MAP_REGION_FLAT(SRAM_BASE, SRAM_SIZE, MT_MEMORY | MT_RW | MT_NS)
...
#define PLAT_NUM_PWR_DOMAINS (A5DS_CLUSTER_COUNT + PLATFORM_CORE_COUNT) + U(1)
...
#define A5DS_HOLD_SIZE (PLATFORM_CORE_COUNT * A5DS_HOLD_ENTRY_SIZE)
...
#define PLAT_ARM_G1S_IRQ_PROPS(grp)                                        \
	ARM_G1S_IRQ_PROPS(grp),                                            \
		INTR_PROP_DESC(A5DS_IRQ_TZ_WDOG, GIC_HIGHEST_SEC_PRIORITY, \
