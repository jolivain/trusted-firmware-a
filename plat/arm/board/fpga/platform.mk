...
# This can be overriden depending on CPU(s) used in the FPGA image
...
FPGA_GIC_SOURCES	:=	drivers/arm/gic/common/gic_common.c	\
				...
				plat/arm/board/fpga/fpga_gicv3.c	\
				drivers/arm/gic/v3/gic600.c

PLAT_INCLUDES		:=	-Iplat/arm/board/fpga/include

PLAT_BL_COMMON_SOURCES	:=	plat/arm/board/fpga/${ARCH}/fpga_helpers.S

BL31_SOURCES		+=	drivers/delay_timer/delay_timer.c		\
				drivers/delay_timer/generic_delay_timer.c	\
				drivers/arm/pl011/${ARCH}/pl011_console.S	\
				plat/common/plat_psci_common.c			\
				plat/arm/board/fpga/fpga_pm.c			\
				plat/arm/board/fpga/fpga_topology.c		\
				plat/arm/board/fpga/fpga_console.c		\
				plat/arm/board/fpga/fpga_bl31_setup.c		\
				${FPGA_CPU_LIBS}				\
				${FPGA_GIC_SOURCES}
