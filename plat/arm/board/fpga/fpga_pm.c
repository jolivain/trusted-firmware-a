 ...
 *
 * Hotplug is currently unimplemented due to potential variations of the
 * platform as configured by the FPGA image, e.g. not system configurations
 * will utilize a power controller.
 */

unsigned long hold_base[PLATFORM_CORE_COUNT];
