...
#define N1SDP_REMOTE_DRAM1_BASE ARM_DRAM1_BASE + PLAT_ARM_REMOTE_CHIP_OFFSET
#define N1SDP_REMOTE_DRAM1_SIZE ARM_DRAM1_SIZE

#define N1SDP_REMOTE_DRAM2_BASE \
	PLAT_ARM_DRAM2_BASE + PLAT_ARM_REMOTE_CHIP_OFFSET
...
#define PLAT_ARM_G1S_IRQS ARM_G1S_IRQS, CSS_IRQ_MHU
...
#define N1SDP_REMOTE_DEVICE_BASE N1SDP_DEVICE_BASE + PLAT_ARM_REMOTE_CHIP_OFFSET
...
#define N1SDP_MAP_DEVICE                                      \
	MAP_REGION_FLAT(N1SDP_DEVICE_BASE, N1SDP_DEVICE_SIZE, \
			MT_DEVICE | MT_RW | MT_SECURE)

#define ARM_MAP_DRAM1                                   \
	MAP_REGION_FLAT(ARM_DRAM1_BASE, ARM_DRAM1_SIZE, \
			MT_MEMORY | MT_RW | MT_NS)

#define N1SDP_MAP_REMOTE_DEVICE                                             \
	MAP_REGION_FLAT(N1SDP_REMOTE_DEVICE_BASE, N1SDP_REMOTE_DEVICE_SIZE, \
			MT_DEVICE | MT_RW | MT_SECURE)

#define N1SDP_MAP_REMOTE_DRAM1                                            \
	MAP_REGION_FLAT(N1SDP_REMOTE_DRAM1_BASE, N1SDP_REMOTE_DRAM1_SIZE, \
			MT_MEMORY | MT_RW | MT_NS)

#define N1SDP_MAP_REMOTE_DRAM2                                            \
	MAP_REGION_FLAT(N1SDP_REMOTE_DRAM2_BASE, N1SDP_REMOTE_DRAM2_SIZE, \
			MT_MEMORY | MT_RW | MT_NS)
