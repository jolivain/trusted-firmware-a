...
#define REMOTE_CHIP_OFFSET		(1ULL << 42)

#define N1SDP_REMOTE_DRAM1_BASE		ARM_DRAM1_BASE + REMOTE_CHIP_OFFSET
#define N1SDP_REMOTE_DRAM1_SIZE		ARM_DRAM1_SIZE

#define N1SDP_REMOTE_DRAM2_BASE		PLAT_ARM_DRAM2_BASE + REMOTE_CHIP_OFFSET
...
#define PLAT_N1SDP_CHIP_COUNT			2
#define N1SDP_MAX_CPUS_PER_CHIP			4
...
#define N1SDP_REMOTE_DEVICE_BASE	N1SDP_DEVICE_BASE + REMOTE_CHIP_OFFSET
