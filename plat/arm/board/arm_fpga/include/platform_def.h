...
#define FPGA_MAX_CPUS_COUNT  (FPGA_MAX_CLUSTER_COUNT * \
			      FPGA_MAX_CPUS_PER_CLUSTER)

#define PLATFORM_CORE_COUNT (FPGA_MAX_CPUS_COUNT * FPGA_MAX_PE_PER_CPU)


#define PLAT_NUM_PWR_DOMAINS		(1 + FPGA_MAX_CLUSTER_COUNT + \
					 FPGA_MAX_CPUS_COUNT + \
					 PLATFORM_CORE_COUNT)
...
#define PLAT_MAX_PWR_LVL		MPIDR_AFFLVL3
