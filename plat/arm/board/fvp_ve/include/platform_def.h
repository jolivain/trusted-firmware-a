...
#define ARM_DRAM2_END (ARM_DRAM2_BASE + ARM_DRAM2_SIZE - 1)
 ...
 * initialized.
 */
#define ARM_NS_DRAM1_SIZE (ARM_DRAM1_SIZE - 0x00200000)
...
#define ARM_BL_RAM_BASE (FVP_VE_SHARED_RAM_BASE + FVP_VE_SHARED_RAM_SIZE)
#define ARM_BL_RAM_SIZE \
	(PLAT_ARM_BL_PLUS_SHARED_RAM_SIZE - FVP_VE_SHARED_RAM_SIZE)
...
#define ARM_MAP_SHARED_RAM                                              \
	MAP_REGION_FLAT(FVP_VE_SHARED_RAM_BASE, FVP_VE_SHARED_RAM_SIZE, \
 ...
 */
#define BL1_RW_BASE \
	(ARM_BL_RAM_BASE + ARM_BL_RAM_SIZE - (PLAT_ARM_MAX_BL1_RW_SIZE))
...
#define PLAT_NUM_PWR_DOMAINS \
	((FVP_VE_CLUSTER_COUNT + PLATFORM_CORE_COUNT) + U(1))
...
#define PLAT_ARM_G1S_IRQ_PROPS(grp)                                          \
	ARM_G1S_IRQ_PROPS(grp),                                              \
		INTR_PROP_DESC(FVP_VE_IRQ_TZ_WDOG, GIC_HIGHEST_SEC_PRIORITY, \
			       (grp), GIC_INTR_CFG_LEVEL),                   \
		INTR_PROP_DESC(FVP_VE_IRQ_SEC_SYS_TIMER,                     \
