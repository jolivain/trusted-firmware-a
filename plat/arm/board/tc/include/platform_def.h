...
#define TC0_HW_CONFIG_DTB_BASE        ULL(0x83000000)
#define TC0_HW_CONFIG_DTB_SIZE        ULL(0x8000)

#define TC0_DTB_DRAM_NS            MAP_REGION_FLAT(        \
                   TC0_HW_CONFIG_DTB_BASE,    \
                   TC0_HW_CONFIG_DTB_SIZE,    \
