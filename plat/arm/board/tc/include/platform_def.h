 ...
 *
 */
#define TC_TZC_DRAM1_BASE (ARM_AP_TZC_DRAM1_BASE - TC_TZC_DRAM1_SIZE)
#define TC_TZC_DRAM1_SIZE 96 * SZ_1M /* 96 MB */
#define TC_TZC_DRAM1_END (TC_TZC_DRAM1_BASE + TC_TZC_DRAM1_SIZE - 1)

#define TC_NS_DRAM1_BASE ARM_DRAM1_BASE
#define TC_NS_DRAM1_SIZE \
	(ARM_DRAM1_SIZE - ARM_TZC_DRAM1_SIZE - TC_TZC_DRAM1_SIZE)
#define TC_NS_DRAM1_END (TC_NS_DRAM1_BASE + TC_NS_DRAM1_SIZE - 1)

/*
 * Mappings for TC DRAM1 (non-secure) and TC TZC DRAM1 (secure)
 */
#define TC_MAP_NS_DRAM1                                     \
	MAP_REGION_FLAT(TC_NS_DRAM1_BASE, TC_NS_DRAM1_SIZE, \
			MT_MEMORY | MT_RW | MT_NS)

#define TC_MAP_TZC_DRAM1                                      \
	MAP_REGION_FLAT(TC_TZC_DRAM1_BASE, TC_TZC_DRAM1_SIZE, \
			MT_MEMORY | MT_RW | MT_SECURE)

#define PLAT_HW_CONFIG_DTB_BASE ULL(0x83000000)
#define PLAT_HW_CONFIG_DTB_SIZE ULL(0x8000)

#define PLAT_DTB_DRAM_NS                                                  \
	MAP_REGION_FLAT(PLAT_HW_CONFIG_DTB_BASE, PLAT_HW_CONFIG_DTB_SIZE, \
...
#define TC_MAP_DEVICE                                   \
	MAP_REGION_FLAT(TC_DEVICE_BASE, TC_DEVICE_SIZE, \
			MT_DEVICE | MT_RW | MT_SECURE)

#define TC_FLASH0_RO                                      \
	MAP_REGION_FLAT(V2M_FLASH0_BASE, V2M_FLASH0_SIZE, \
...
#define TZC400_BASE(n) (PLAT_ARM_TZC_BASE + (n * TZC400_OFFSET))
...
#define TC_TZC_REGIONS_DEF                                                     \
	{ TC_TZC_DRAM1_BASE, ARM_SCP_TZC_DRAM1_END, TZC_REGION_S_RDWR,         \
