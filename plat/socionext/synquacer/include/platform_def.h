...
#define SQ_SYSTEM_PWR_STATE(state)                        \
	((PLAT_MAX_PWR_LVL > SQ_PWR_LVL1) ?               \
		 (state)->pwr_domain_state[SQ_PWR_LVL2] : \
		 0)
...
#define PLAT_SPM_SPM_BUF_EL0_MMAP                                            \
...
#define PLAT_SP_IMAGE_NS_BUF_MMAP                                            \
	MAP_REGION2(PLAT_SP_IMAGE_NS_BUF_BASE, PLAT_SP_IMAGE_NS_BUF_BASE,    \
		    PLAT_SP_IMAGE_NS_BUF_SIZE, MT_RW_DATA | MT_NS | MT_USER, \
		    PAGE_SIZE)
...
#define PLAT_SQ_SP_IMAGE_MMAP                                    \
	MAP_REGION2(BL32_BASE, BL32_BASE, PLAT_SQ_SP_IMAGE_SIZE, \
		    MT_CODE | MT_SECURE | MT_USER, PAGE_SIZE)
...
#define PLAT_SQ_SP_IMAGE_RW_MMAP                                       \
	MAP_REGION2(PLAT_SQ_SP_HEAP_BASE, PLAT_SQ_SP_HEAP_BASE,        \
		    (PLAT_SQ_SP_HEAP_SIZE + PLAT_SP_IMAGE_STACK_SIZE), \
		    MT_RW_DATA | MT_SECURE | MT_USER, PAGE_SIZE)

#define PLAT_SQ_SP_PRIV_BASE \
	(PLAT_SP_IMAGE_STACK_BASE + PLAT_SP_IMAGE_STACK_SIZE)
...
#define PLAT_SQ_UART1_MMAP                                      \
	MAP_REGION_FLAT(PLAT_SQ_UART1_BASE, PLAT_SQ_UART1_SIZE, \
			MT_DEVICE | MT_RW | MT_NS | MT_PRIVILEGED)

#define PLAT_SQ_PERIPH_BASE 0x50000000
#define PLAT_SQ_PERIPH_SIZE ULL(0x8000000)
#define PLAT_SQ_PERIPH_MMAP                                       \
	MAP_REGION_FLAT(PLAT_SQ_PERIPH_BASE, PLAT_SQ_PERIPH_SIZE, \
			MT_DEVICE | MT_RW | MT_NS | MT_USER)

#define PLAT_SQ_FLASH_BASE 0x08000000
#define PLAT_SQ_FLASH_SIZE ULL(0x8000000)
#define PLAT_SQ_FLASH_MMAP                                      \
	MAP_REGION_FLAT(PLAT_SQ_FLASH_BASE, PLAT_SQ_FLASH_SIZE, \
			MT_DEVICE | MT_RW | MT_NS | MT_USER)
