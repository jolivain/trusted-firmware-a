...
/*
 * There are 4 UART ports. By default, we want to use the same one as used
 * by the previous firmware stage.
 */
...
void uniphier_console_setup(void)
{
	...
	/*
	 * The console might be still printing characters passed by the
