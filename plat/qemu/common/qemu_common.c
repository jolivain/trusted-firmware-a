...
#define MAP_FLASH0                                          \
	MAP_REGION_FLAT(QEMU_FLASH0_BASE, QEMU_FLASH0_SIZE, \
			MT_MEMORY | MT_RO | MT_SECURE)

#define MAP_FLASH1                                          \
	MAP_REGION_FLAT(QEMU_FLASH1_BASE, QEMU_FLASH1_SIZE, \
			MT_MEMORY | MT_RO | MT_SECURE)
 ...
 */
#ifdef IMAGE_BL1
static const mmap_region_t plat_qemu_mmap[] = { MAP_FLASH0,	MAP_FLASH1,
						MAP_SHARED_RAM, MAP_DEVICE0,
#ifdef MAP_DEVICE1
						MAP_DEVICE1,
#endif
#ifdef MAP_DEVICE2
...
#endif
#ifdef IMAGE_BL2
static const mmap_region_t plat_qemu_mmap[] = { MAP_FLASH0,
						MAP_FLASH1,
						MAP_SHARED_RAM,
						MAP_DEVICE0,
#ifdef MAP_DEVICE1
