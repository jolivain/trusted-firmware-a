...
#if BL32_RAM_LOCATION_ID == SEC_DRAM_ID
# error " BL32_RAM_LOCATION_ID can not be SEC_DRAM_ID, not supported yet"
#endif
...
# define QEMU_SP_IMAGE_MMAP		MAP_REGION_FLAT(QEMU_SP_IMAGE_BASE, \
							QEMU_SP_IMAGE_SIZE, \
							MT_MEMORY | MT_RW | \
							MT_SECURE)
#endif
...
# define QEMU_SP_IMAGE_MMAP		MAP_REGION2(QEMU_SP_IMAGE_BASE, \
						    QEMU_SP_IMAGE_BASE, \
						    QEMU_SP_IMAGE_SIZE, \
						    MT_CODE | MT_SECURE | \
						    MT_USER,		\
...
#define QEMU_SP_IMAGE_NS_BUF_MMAP	MAP_REGION2(QEMU_SP_IMAGE_NS_BUF_BASE, \
...
#define QEMU_SP_IMAGE_RW_MMAP		MAP_REGION2(PLAT_SP_IMAGE_STACK_BASE, \
