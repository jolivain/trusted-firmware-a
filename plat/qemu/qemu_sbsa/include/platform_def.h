...
#define BL32_MEM_SIZE			(BL_RAM_SIZE - BL1_SIZE - BL2_SIZE - BL31_SIZE)
...
# define QEMU_SP_IMAGE_MMAP		MAP_REGION_FLAT(PLAT_QEMU_SP_IMAGE_BASE, \
...
#define QEMU_SP_IMAGE_NS_BUF_MMAP	MAP_REGION2(PLAT_QEMU_SP_IMAGE_NS_BUF_BASE, \
...
#define QEMU_SP_IMAGE_RW_MMAP		MAP_REGION2(PLAT_QEMU_SP_IMAGE_HEAP_BASE, \
