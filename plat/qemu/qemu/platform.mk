...
ifeq ($(SPMD_SPM_AT_SEL2),1)
BL2_SOURCES             +=	plat/qemu/common/fconf/qemu_fconf_sp.c
endif
...
ARM_SPMC_MANIFEST_DTS	:=	plat/arm/board/qemu/fdts/${PLAT}_spmc_manifest.dts
endif

FDT_SOURCES		+=	${ARM_SPMC_MANIFEST_DTS}
QEMU_TOS_FW_CONFIG	:=	${BUILD_PLAT}/fdts/$(notdir $(basename ${ARM_SPMC_MANIFEST_DTS})).dtb
