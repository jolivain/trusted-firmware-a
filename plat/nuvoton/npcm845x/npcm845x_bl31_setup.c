...
int board_uart_init(void)
{
	...
	UART_Init(UART0_DEV, UART_MUX_MODE1_HSP1_SI2____HSP2_UART2__UART1_s_HSP1__UART3_s_SI2,
...
#endif /* INITIALIZE_UART_BY_BOOTBLOCK */
...
{
	/* now we don't use ARM mailbox, so that function added to ignore the weak one */
	return;
}
