...
/* The rest of the PSCI implementation are for testing purposes only. Not supported in Arbel */
...
#ifdef NPCM845X_DEBUG
void __dead2 npcm845x_pwr_domain_pwr_down_wfi(const psci_power_state_t *target_state)
{
	disable_mmu_el3();
