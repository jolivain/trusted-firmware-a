 ...
 ******************************************************************************/
#define MC_STREAMID_OVERRIDE_TO_SECURITY_CFG(addr) \
...
#define MC_TXN_OVERRIDE_CONFIG_AXID_OVERRIDE_SO_DEV_CGID_SO_DEV_CLIENT \
	(1U << 12)
...
#define mc_set_tsa_passthrough(client)                                            \
	do {                                                                      \
		mmio_write_32(                                                    \
			TEGRA_TSA_BASE + TSA_CONFIG_STATIC0_CSW_##client,         \
...
#define mc_set_tsa_r_passthrough(client)                                          \
	{                                                                         \
		mmio_write_32(                                                    \
			TEGRA_TSA_BASE + TSA_CONFIG_STATIC0_CSR_##client,         \
...
#define mc_set_txn_override(client, normal_axi_id, so_dev_axi_id,                            \
			    normal_override, so_dev_override)                                \
	do {                                                                                 \
		tegra_mc_write_32(                                                           \
			MC_TXN_OVERRIDE_CONFIG_##client,                                     \
