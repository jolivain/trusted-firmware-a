...
# t210 doesn't have enough available RAM to support the default 512KB
# of shared memory descriptor storage in the Trusty SPD
TRUSTY_SHARED_MEMORY_OBJ_SIZE	:= 65536
$(eval $(call add_define,TRUSTY_SHARED_MEMORY_OBJ_SIZE))
