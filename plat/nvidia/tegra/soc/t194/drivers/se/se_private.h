...
#define SE0_CONFIG_ENC_ALG_SHA (((uint32_t)3) << SE0_CONFIG_ENC_ALG_SHIFT)
#define SE0_CONFIG_DEC_ALG_SHIFT U(8)
#define SE0_CONFIG_DEC_ALG_NOP (((uint32_t)0) << SE0_CONFIG_DEC_ALG_SHIFT)
#define SE0_CONFIG_DST_SHIFT U(2)
#define SE0_CONFIG_DST_HASHREG (((uint32_t)1) << SE0_CONFIG_DST_SHIFT)
#define SHA256_HASH_SIZE_BYTES U(256)

#define SE0_CONFIG_ENC_MODE_SHIFT U(24)
#define SE0_CONFIG_ENC_MODE_SHA256 (((uint32_t)5) << SE0_CONFIG_ENC_MODE_SHIFT)
...
#define SE0_OP_START (((uint32_t)0x1) << SE0_OPERATION_SHIFT)
...
#define SE0_INT_OP_DONE_CLEAR (((uint32_t)0U) << SE0_INT_OP_DONE_SHIFT)
#define SE0_INT_OP_DONE(x) ((x) & (((uint32_t)0x1U) << SE0_INT_OP_DONE_SHIFT))
