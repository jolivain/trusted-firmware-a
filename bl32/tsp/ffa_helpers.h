	...
	uint64_t handle, ffa_mtd_flag32_t flags, ffa_endpoint_id16_t sender)
{
	...
	return sizeof(struct ffa_mem_relinquish_descriptor) +
				...
				uint32_t receiver_index)
{
	...
	receivers = (struct ffa_emad_v1_0 *)((uint8_t *)memory_region +
					     memory_region->emad_offset +
					     (memory_region->emad_size *
					      receiver_index));
	...
	return (struct ffa_comp_mrd *)((uint8_t *)memory_region + offset);
}
