...
if(NOT _bl32_defined)
    message(
        FATAL_ERROR
            "${CMAKE_CURRENT_LIST_FILE}: STGT target 'bl32' is not defined.")
endif()
unset(_bl32_defined)
...
include(${HW_PLAT_DIR}/sp_min/sp_min-${TFA_PLATFORM}.cmake)

stgt_link_libraries(NAME bl32 LIBS xlat_tables_bl32 fdt)
stgt_link_build_messages(NAME bl32 LIBS build_message)

target_link_libraries(bl32 PRIVATE c)

tfa_target_linker_script(bl32 "${CMAKE_CURRENT_LIST_DIR}/sp_min.ld.S")
