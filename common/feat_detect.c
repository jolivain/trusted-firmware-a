 ...
 ******************************************************************************/
static void feature_panic(char *feat_name)
{
...
void detect_arch_features(void)
{
	...
	/* v8.4 features */
	read_feat_dit();
	check_feature(ENABLE_FEAT_AMUv1, get_armv8_4_amu_support(), "AMUv1");
	read_feat_mpam();
	read_feat_nv2();
	read_feat_sel2();
	read_feat_trf();
	...
	/* v8.6 features */
	read_feat_amuv1p1();
	check_feature(ENABLE_FEAT_FGT, get_armv8_6_fgt_support(), "FGT");
	read_feat_ecv();
	read_feat_twed();

	/* v8.7 features */
	check_feature(ENABLE_FEAT_HCX, get_feat_hcx_support(), "HCX");
