 ...
 *
 * At the moment, FEAT_STATE_1 is taken into consideration and
 * FEAT_STATE_2 (Todo) will be further handled explicitly.
 *
 ******************************************************************************/
...
/*******************************************************
 * Feature : FEAT_SPE (Statistical Profiling Extension)
 ******************************************************/
...
/*************************************************
 * Feature : FEAT_SVE (Scalable Vector Extension)
 ************************************************/
