...
void detect_arch_features(void)
{
	...
	check_feature(ENABLE_FEAT_BTI, read_feat_bti_id_field(), "BTI", 1, 1);
	check_feature(ENABLE_FEAT_ENG_TRAP, read_feat_rng_trap_id_field(), "RNG_TRAP", 1, 1);
	read_feat_bti();
	read_feat_rng_trap();
	...
	check_feature(ENABLE_FEAT_RME, read_feat_rme_id_field(), "RME", 1, 1);
