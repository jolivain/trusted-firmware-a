				...
				uint64_t base_address)
{
	...
	const struct fdt_property *property = fdt_get_property(dtb, local_bus_node,
					"ranges", &length);
	...
	global_address = fdtw_search_all_xlat_entries(dtb, property, local_bus_node,
					base_address);
