...
static void tf_panic(char* feat_name);
...
/******************************************************************************
 * This file mainly contains the architectural features detection procedure.
 *
 * TF-A supports many arm arch-features starting from arch version (8.0 till 8.7+)
 * These features are mostly enabled through build flags. This mechanism helps
 * in validating these build flags in the early boot phase either in BL1 /BL31
 * depending on the platform and assists in identifying and notifying the features
 * which are enabled but not supported by the processor.
 *
 * It reads all the enabled feature specific ID-registers and ensures the feat
 ...
 * ENABLE_FEAT_xxx = 1 : The feature is enabled and must be present in hardware.There
 *                       will be hard assertions if feature is not present at cold boot.
 * ENABLE_FEAT_xxx = 2 : The feature is enabled but dynamically enabled at runtime
 *                      depending on hardware capability.
 *
 * These three states are wrapped in helper macros for each individual features
 * in tf_feat_detect.h file.
 *
 *****************************************************************************/

void tf_detect_arch_features(void)
{
    DETECT_FEAT_SB;
    DETECT_FEAT_CSV2_2;
    DETECT_FEAT_PAN;
...
/*************************************************************************
 * Function : tf_panic
 * Customised Panic module with error logging support.
 *
 *************************************************************************/
static void tf_panic(char* feat_name)
{
    ERROR("FEAT_%s : not supported by the system\n", feat_name);
    panic();
}
...
static void read_feat_sb(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_armv8_0_feat_sb_present(),"SB");
#endif
...
static void read_feat_csv2_2(void)
{
    ...
    /*
	 * Verify that FEAT_CSV2_2 is supported on this system, without this check
	 * an exception would occur during context save/restore if enabled but
	 * not supported.
	 */
    feat_panic(is_armv8_0_feat_csv2_2_present(),"CSV2_2");
#endif
...
static void read_feat_pan(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_armv8_1_pan_present(),"PAN");
#endif
...
static void read_feat_vhe(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_armv8_1_vhe_present(),"VHE");
#endif
...
static void read_feat_spe(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_armv8_2_feat_spe_present(),"SPE");
#endif
...
static void read_feat_sve(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_armv8_2_feat_spe_present(),"SVE");
#endif
...
static void read_feat_ras(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_armv8_2_feat_ras_present(),"RAS");
#endif
...
static void read_feat_Pauth(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_armv8_3_pauth_present(),"PAUTH");
#endif
...
static void read_feat_dit(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_armv8_4_feat_dit_present(),"DIT");
#endif
...
static void read_feat_amuv1(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_armv8_4_feat_amuv1_present(),"AMUv1");
#endif
...
static void read_feat_mpam(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(get_mpam_version() != 0U,"MPAM");
#endif
...
static void read_feat_nv2(void)
{
    ...
    feat_panic(nv == ID_AA64MMFR2_EL1_NV2_SUPPORTED,"NV2");
#endif
...
static void read_feat_sel2(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_armv8_4_sel2_present(),"SEL2");
#endif
...
static void read_feat_trf(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_arm8_4_feat_trf_present(),"TRF");
#endif
...
static void read_feat_mte(void)
{
	...
	feat_panic( ( (mte == MTE_IMPLEMENTED_EL0) || (mte == MTE_IMPLEMENTED_ELX)
                || (mte == MTE_IMPLEMENTED_ASY) ) ,"MTE");
#endif
...
static void read_feat_rng(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_armv8_5_rng_present(),"RNG");
#endif
...
static void read_feat_bti(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_armv8_5_bti_present(),"RNG");
#endif
...
static void read_feat_fgt(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_armv8_6_fgt_present(),"FGT");
#endif
...
static void read_feat_amuv1p1(void)
{
    ...
    /*
	 * Verify that FEAT_AMUV1p1 is supported on this system, without this check
	 * an exception would occur during context save/restore if enabled but
	 * not supported.
	 */
    feat_panic(is_armv8_6_feat_amuv1p1_present(),"AMUv1p1");
#endif
...
static void read_feat_ecv(void)
{
	...
	feat_panic( ((ecv == ID_AA64MMFR0_EL1_ECV_SUPPORTED) ||
...
static void read_feat_hcx(void)
{
	 ...
	 * not supported.
	 */
    feat_panic(is_feat_hcx_present(),"HCX");
#endif
...
static void read_feat_rme(void)
{
	 ...
	 * not supported.
	 */
    feat_panic( ( get_armv9_2_feat_rme_support() != ID_AA64PFR0_FEAT_RME_NOT_SUPPORTED),"RME");
#endif
