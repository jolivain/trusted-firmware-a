...
ifneq ($(findstring gcc,$(notdir $(LD))),)
        ...
        BL2_LDFLAGS	+=	-Wl,--orphan-handling=error
else ifneq ($(findstring ld,$(notdir $(LD))),)
        BL2_LDFLAGS	+=	--sort-section=alignment
        BL2_LDFLAGS	+=	--orphan-handling=error
endif

BL2_DEFAULT_LINKER_SCRIPT_SOURCE := common/bootloader/bootloader.ld.S
...
BL2_SOURCES		+=      bl2/${ARCH}/bl2_rme_entrypoint.S	\
				...
				${GPT_LIB_SRCS}
BL2_LINKER_SCRIPT_SOURCES += bl2/bl2.ld.S
...
BL2_LINKER_SCRIPT_SOURCES += bl2/bl2_el3.ld.S
endif
